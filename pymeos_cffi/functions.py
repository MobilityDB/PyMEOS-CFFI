...
# -----------------------------------------------------------------------------
def meos_array_create(elem_size: int) -> Annotated[_ffi.CData, 'MeosArray *']:
    result = _lib.meos_array_create(elem_size)
    _check_error()
    return result if result != _ffi.NULL else None


def meos_array_add(array: Annotated[_ffi.CData, 'MeosArray *'], value: Annotated[_ffi.CData, 'void *']) -> Annotated[None, 'void']:
    array_converted = _ffi.cast('MeosArray *', array)
    value_converted = _ffi.cast('void *', value)
    _lib.meos_array_add(array_converted, value_converted)
    _check_error()


def meos_array_get(array: Annotated[_ffi.CData, 'const MeosArray *'], n: int) -> Annotated[_ffi.CData, 'void *']:
    array_converted = _ffi.cast('const MeosArray *', array)
    result = _lib.meos_array_get(array_converted, n)
    _check_error()
    return result if result != _ffi.NULL else None


def meos_array_count(array: Annotated[_ffi.CData, 'const MeosArray *']) -> Annotated[int, 'int']:
    array_converted = _ffi.cast('const MeosArray *', array)
...
def meos_array_reset(array: Annotated[_ffi.CData, 'MeosArray *']) -> Annotated[None, 'void']:
    array_converted = _ffi.cast('MeosArray *', array)
    _lib.meos_array_reset(array_converted)
    _check_error()


def meos_array_reset_free(array: Annotated[_ffi.CData, 'MeosArray *']) -> Annotated[None, 'void']:
    array_converted = _ffi.cast('MeosArray *', array)
    _lib.meos_array_reset_free(array_converted)
    _check_error()


def meos_array_destroy(array: Annotated[_ffi.CData, 'MeosArray *']) -> Annotated[None, 'void']:
    array_converted = _ffi.cast('MeosArray *', array)
    _lib.meos_array_destroy(array_converted)
    _check_error()


def meos_array_destroy_free(array: Annotated[_ffi.CData, 'MeosArray *']) -> Annotated[None, 'void']:
    array_converted = _ffi.cast('MeosArray *', array)
    _lib.meos_array_destroy_free(array_converted)
    _check_error()
...
def rtree_insert(rtree: Annotated[_ffi.CData, 'RTree *'], box: Annotated[_ffi.CData, 'void *'], id: int) -> Annotated[None, 'void']:
    rtree_converted = _ffi.cast('RTree *', rtree)
    box_converted = _ffi.cast('void *', box)
    _lib.rtree_insert(rtree_converted, box_converted, id)
    _check_error()


def rtree_insert_temporal(rtree: Annotated[_ffi.CData, 'RTree *'], temp: Annotated[_ffi.CData, 'const Temporal *'], id: int) -> Annotated[None, 'void']:
    rtree_converted = _ffi.cast('RTree *', rtree)
    temp_converted = _ffi.cast('const Temporal *', temp)
    _lib.rtree_insert_temporal(rtree_converted, temp_converted, id)
    _check_error()


def rtree_search(rtree: Annotated[_ffi.CData, 'const RTree *'], op: Annotated[_ffi.CData, 'RTreeSearchOp'], query: Annotated[_ffi.CData, 'const void *']) -> Annotated[_ffi.CData, 'MeosArray *']:
...
def rtree_search_temporal(rtree: Annotated[_ffi.CData, 'const RTree *'], op: Annotated[_ffi.CData, 'RTreeSearchOp'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'MeosArray *']:
    rtree_converted = _ffi.cast('const RTree *', rtree)
    op_converted = _ffi.cast('RTreeSearchOp', op)
    temp_converted = _ffi.cast('const Temporal *', temp)
    out_result = _ffi.new('MeosArray *')
...
def add_date_int(d: int, days: int) -> Annotated[int, 'int']:
    result = _lib.add_date_int(d, days)
    _check_error()
    return result if result != _ffi.NULL else None


def add_interval_interval(interv1: Annotated[_ffi.CData, 'const int *'], interv2: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    interv1_converted = _ffi.cast('const int *', interv1)
    interv2_converted = _ffi.cast('const int *', interv2)
    result = _lib.add_interval_interval(interv1_converted, interv2_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def add_timestamptz_interval(t: int, interv: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    interv_converted = _ffi.cast('const int *', interv)
    result = _lib.add_timestamptz_interval(t, interv_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def date_to_timestamp(dateVal: int) -> Annotated[int, 'int']:
    result = _lib.date_to_timestamp(dateVal)
    _check_error()
    return result if result != _ffi.NULL else None


def date_to_timestamptz(d: int) -> Annotated[int, 'int']:
    result = _lib.date_to_timestamptz(d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def float8_out(d: float, maxdd: int) -> Annotated[str, 'char *']:
    result = _lib.float8_out(d, maxdd)
    _check_error()
    result = _ffi.string(result).decode('utf-8')
    return result if result != _ffi.NULL else None
...
def int32_cmp(l: int, r: int) -> Annotated[int, 'int']:
    result = _lib.int32_cmp(l, r)
    _check_error()
    return result if result != _ffi.NULL else None


def int64_cmp(l: int, r: int) -> Annotated[int, 'int']:
    result = _lib.int64_cmp(l, r)
    _check_error()
    return result if result != _ffi.NULL else None


def interval_make(years: int, months: int, weeks: int, days: int, hours: int, mins: int, secs: float) -> Annotated[_ffi.CData, 'int *']:
    result = _lib.interval_make(years, months, weeks, days, hours, mins, secs)
    _check_error()
    return result if result != _ffi.NULL else None


def minus_date_date(d1: int, d2: int) -> Annotated[int, 'int']:
    result = _lib.minus_date_date(d1, d2)
    _check_error()
    return result if result != _ffi.NULL else None


def minus_date_int(d: int, days: int) -> Annotated[int, 'int']:
    result = _lib.minus_date_int(d, days)
    _check_error()
    return result if result != _ffi.NULL else None


def minus_timestamptz_interval(t: int, interv: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    interv_converted = _ffi.cast('const int *', interv)
    result = _lib.minus_timestamptz_interval(t, interv_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def minus_timestamptz_timestamptz(t1: int, t2: int) -> Annotated[_ffi.CData, 'int *']:
    result = _lib.minus_timestamptz_timestamptz(t1, t2)
    _check_error()
    return result if result != _ffi.NULL else None


def mul_interval_double(interv: Annotated[_ffi.CData, 'const int *'], factor: float) -> Annotated[_ffi.CData, 'int *']:
    interv_converted = _ffi.cast('const int *', interv)
...
def pg_date_in(string: str) -> Annotated[int, 'int']:
    string_converted = string.encode('utf-8')
...
def pg_date_out(d: int) -> Annotated[str, 'char *']:
    result = _lib.pg_date_out(d)
    _check_error()
    result = _ffi.string(result).decode('utf-8')
    return result if result != _ffi.NULL else None


def pg_interval_cmp(interv1: Annotated[_ffi.CData, 'const int *'], interv2: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    interv1_converted = _ffi.cast('const int *', interv1)
    interv2_converted = _ffi.cast('const int *', interv2)
...
def pg_interval_in(string: str, typmod: int) -> Annotated[_ffi.CData, 'int *']:
    string_converted = string.encode('utf-8')
    result = _lib.pg_interval_in(string_converted, typmod)
    _check_error()
    return result if result != _ffi.NULL else None


def pg_interval_out(interv: Annotated[_ffi.CData, 'const int *']) -> Annotated[str, 'char *']:
    interv_converted = _ffi.cast('const int *', interv)
...
def pg_timestamp_in(string: str, typmod: int) -> Annotated[int, 'int']:
    string_converted = string.encode('utf-8')
    result = _lib.pg_timestamp_in(string_converted, typmod)
    _check_error()
    return result if result != _ffi.NULL else None


def pg_timestamp_out(t: int) -> Annotated[str, 'char *']:
    result = _lib.pg_timestamp_out(t)
    _check_error()
    result = _ffi.string(result).decode('utf-8')
    return result if result != _ffi.NULL else None


def pg_timestamptz_in(string: str, typmod: int) -> Annotated[int, 'int']:
    string_converted = string.encode('utf-8')
    result = _lib.pg_timestamptz_in(string_converted, typmod)
    _check_error()
    return result if result != _ffi.NULL else None


def pg_timestamptz_out(t: int) -> Annotated[str, 'char *']:
    result = _lib.pg_timestamptz_out(t)
    _check_error()
    result = _ffi.string(result).decode('utf-8')
    return result if result != _ffi.NULL else None
...
def text_cmp(txt1: Annotated[_ffi.CData, 'const int *'], txt2: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    txt1_converted = _ffi.cast('const int *', txt1)
    txt2_converted = _ffi.cast('const int *', txt2)
    result = _lib.text_cmp(txt1_converted, txt2_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def text_copy(txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    txt_converted = _ffi.cast('const int *', txt)
    result = _lib.text_copy(txt_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def text_in(string: str) -> Annotated[_ffi.CData, 'int *']:
    string_converted = string.encode('utf-8')
    result = _lib.text_in(string_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def text_initcap(txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    txt_converted = _ffi.cast('const int *', txt)
...
def text_lower(txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    txt_converted = _ffi.cast('const int *', txt)
...
def text_out(txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[str, 'char *']:
    txt_converted = _ffi.cast('const int *', txt)
...
def text_upper(txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    txt_converted = _ffi.cast('const int *', txt)
...
def textcat_text_text(txt1: Annotated[_ffi.CData, 'const int *'], txt2: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    txt1_converted = _ffi.cast('const int *', txt1)
    txt2_converted = _ffi.cast('const int *', txt2)
...
def timestamptz_shift(t: int, interv: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    interv_converted = _ffi.cast('const int *', interv)
    result = _lib.timestamptz_shift(t, interv_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def timestamp_to_date(t: int) -> Annotated[int, 'int']:
    result = _lib.timestamp_to_date(t)
    _check_error()
    return result if result != _ffi.NULL else None


def timestamptz_to_date(t: int) -> Annotated[int, 'int']:
    result = _lib.timestamptz_to_date(t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def bigintspan_expand(s: Annotated[_ffi.CData, 'const Span *'], value: int) -> Annotated[_ffi.CData, 'Span *']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.bigintspan_expand(s_converted, value)
    _check_error()
    return result if result != _ffi.NULL else None
...
def floatspan_expand(s: Annotated[_ffi.CData, 'const Span *'], value: float) -> Annotated[_ffi.CData, 'Span *']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.floatspan_expand(s_converted, value)
    _check_error()
    return result if result != _ffi.NULL else None
...
def intspan_expand(s: Annotated[_ffi.CData, 'const Span *'], value: int) -> Annotated[_ffi.CData, 'Span *']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.intspan_expand(s_converted, value)
    _check_error()
    return result if result != _ffi.NULL else None
...
def set_as_hexwkb(s: Annotated[_ffi.CData, 'const Set *'], variant: int) -> tuple[Annotated[str, 'char *'], Annotated[_ffi.CData, 'size_t *']]:
    s_converted = _ffi.cast('const Set *', s)
...
def set_as_wkb(s: Annotated[_ffi.CData, 'const Set *'], variant: int) -> tuple[Annotated[_ffi.CData, 'uint8_t *'], Annotated[_ffi.CData, 'size_t *']]:
    s_converted = _ffi.cast('const Set *', s)
    variant_converted = _ffi.cast('uint8_t', variant)
    size_out = _ffi.new('size_t *')
...
def span_as_hexwkb(s: Annotated[_ffi.CData, 'const Span *'], variant: int) -> tuple[Annotated[str, 'char *'], Annotated[_ffi.CData, 'size_t *']]:
    s_converted = _ffi.cast('const Span *', s)
    variant_converted = _ffi.cast('uint8_t', variant)
    size_out = _ffi.new('size_t *')
...
def span_as_wkb(s: Annotated[_ffi.CData, 'const Span *'], variant: int) -> tuple[Annotated[_ffi.CData, 'uint8_t *'], Annotated[_ffi.CData, 'size_t *']]:
    s_converted = _ffi.cast('const Span *', s)
    variant_converted = _ffi.cast('uint8_t', variant)
    size_out = _ffi.new('size_t *')
...
def spanset_as_hexwkb(ss: Annotated[_ffi.CData, 'const SpanSet *'], variant: int) -> tuple[Annotated[str, 'char *'], Annotated[_ffi.CData, 'size_t *']]:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    variant_converted = _ffi.cast('uint8_t', variant)
    size_out = _ffi.new('size_t *')
...
def spanset_as_wkb(ss: Annotated[_ffi.CData, 'const SpanSet *'], variant: int) -> tuple[Annotated[_ffi.CData, 'uint8_t *'], Annotated[_ffi.CData, 'size_t *']]:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    variant_converted = _ffi.cast('uint8_t', variant)
    size_out = _ffi.new('size_t *')
...
def bigintset_make(values: 'list[const int]') -> Annotated[_ffi.CData, 'Set *']:
...
def bigintspan_make(lower: int, upper: int, lower_inc: bool, upper_inc: bool) -> Annotated[_ffi.CData, 'Span *']:
    result = _lib.bigintspan_make(lower, upper, lower_inc, upper_inc)
    _check_error()
    return result if result != _ffi.NULL else None


def dateset_make(values: 'list[const int]') -> Annotated[_ffi.CData, 'Set *']:
    values_converted = _ffi.new('const int []', values)
...
def datespan_make(lower: int, upper: int, lower_inc: bool, upper_inc: bool) -> Annotated[_ffi.CData, 'Span *']:
    result = _lib.datespan_make(lower, upper, lower_inc, upper_inc)
    _check_error()
    return result if result != _ffi.NULL else None
...
def textset_make(values: 'list[int]') -> Annotated[_ffi.CData, 'Set *']:
...
def tstzset_make(values: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Set *']:
...
def tstzspan_make(lower: int, upper: int, lower_inc: bool, upper_inc: bool) -> Annotated[_ffi.CData, 'Span *']:
    result = _lib.tstzspan_make(lower, upper, lower_inc, upper_inc)
    _check_error()
    return result if result != _ffi.NULL else None


def bigint_to_set(i: int) -> Annotated[_ffi.CData, 'Set *']:
    result = _lib.bigint_to_set(i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def text_to_set(txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Set *']:
    txt_converted = _ffi.cast('const int *', txt)
...
def bigintset_end_value(s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Set *', s)
...
def bigintset_start_value(s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Set *', s)
...
def bigintset_value_n(s: Annotated[_ffi.CData, 'const Set *'], n: int) -> Annotated[_ffi.CData, 'int']:
    s_converted = _ffi.cast('const Set *', s)
...
def bigintset_values(s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'int *']:
    s_converted = _ffi.cast('const Set *', s)
...
def bigintspan_lower(s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Span *', s)
...
def bigintspan_upper(s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Span *', s)
...
def bigintspan_width(s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Span *', s)
...
def bigintspanset_lower(ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def bigintspanset_upper(ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def bigintspanset_width(ss: Annotated[_ffi.CData, 'const SpanSet *'], boundspan: bool) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def dateset_end_value(s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Set *', s)
...
def dateset_start_value(s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Set *', s)
...
def dateset_value_n(s: Annotated[_ffi.CData, 'const Set *'], n: int) -> Annotated[_ffi.CData, 'int']:
    s_converted = _ffi.cast('const Set *', s)
    out_result = _ffi.new('int *')
...
def dateset_values(s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'int *']:
    s_converted = _ffi.cast('const Set *', s)
...
def datespan_duration(s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'int *']:
    s_converted = _ffi.cast('const Span *', s)
...
def datespan_lower(s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Span *', s)
...
def datespan_upper(s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Span *', s)
...
def datespanset_date_n(ss: Annotated[_ffi.CData, 'const SpanSet *'], n: int) -> Annotated[_ffi.CData, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    out_result = _ffi.new('int *')
...
def datespanset_duration(ss: Annotated[_ffi.CData, 'const SpanSet *'], boundspan: bool) -> Annotated[_ffi.CData, 'int *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def datespanset_end_date(ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def datespanset_start_date(ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def set_hash(s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Set *', s)
...
def set_hash_extended(s: Annotated[_ffi.CData, 'const Set *'], seed: int) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.set_hash_extended(s_converted, seed)
    _check_error()
    return result if result != _ffi.NULL else None
...
def span_hash(s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Span *', s)
...
def span_hash_extended(s: Annotated[_ffi.CData, 'const Span *'], seed: int) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.span_hash_extended(s_converted, seed)
    _check_error()
    return result if result != _ffi.NULL else None
...
def spanset_hash(ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def spanset_hash_extended(ss: Annotated[_ffi.CData, 'const SpanSet *'], seed: int) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.spanset_hash_extended(ss_converted, seed)
    _check_error()
    return result if result != _ffi.NULL else None
...
def textset_end_value(s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'int *']:
    s_converted = _ffi.cast('const Set *', s)
...
def textset_start_value(s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'int *']:
    s_converted = _ffi.cast('const Set *', s)
...
def textset_value_n(s: Annotated[_ffi.CData, 'const Set *'], n: int) -> Annotated[list, 'int *']:
    s_converted = _ffi.cast('const Set *', s)
    out_result = _ffi.new('int **')
...
def textset_values(s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'int **']:
    s_converted = _ffi.cast('const Set *', s)
...
def tstzset_end_value(s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Set *', s)
...
def tstzset_start_value(s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Set *', s)
...
def tstzset_value_n(s: Annotated[_ffi.CData, 'const Set *'], n: int) -> Annotated[_ffi.CData, 'int']:
    s_converted = _ffi.cast('const Set *', s)
    out_result = _ffi.new('int *')
...
def tstzset_values(s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'int *']:
    s_converted = _ffi.cast('const Set *', s)
...
def tstzspan_duration(s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'int *']:
    s_converted = _ffi.cast('const Span *', s)
...
def tstzspan_lower(s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Span *', s)
...
def tstzspan_upper(s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Span *', s)
...
def tstzspanset_duration(ss: Annotated[_ffi.CData, 'const SpanSet *'], boundspan: bool) -> Annotated[_ffi.CData, 'int *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tstzspanset_end_timestamptz(ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tstzspanset_lower(ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tstzspanset_start_timestamptz(ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tstzspanset_timestamptz_n(ss: Annotated[_ffi.CData, 'const SpanSet *'], n: int) -> Annotated[_ffi.CData, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    out_result = _ffi.new('int *')
...
def tstzspanset_upper(ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def bigintset_shift_scale(s: Annotated[_ffi.CData, 'const Set *'], shift: int, width: int, hasshift: bool, haswidth: bool) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.bigintset_shift_scale(s_converted, shift, width, hasshift, haswidth)
    _check_error()
    return result if result != _ffi.NULL else None


def bigintspan_shift_scale(s: Annotated[_ffi.CData, 'const Span *'], shift: int, width: int, hasshift: bool, haswidth: bool) -> Annotated[_ffi.CData, 'Span *']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.bigintspan_shift_scale(s_converted, shift, width, hasshift, haswidth)
    _check_error()
    return result if result != _ffi.NULL else None


def bigintspanset_shift_scale(ss: Annotated[_ffi.CData, 'const SpanSet *'], shift: int, width: int, hasshift: bool, haswidth: bool) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.bigintspanset_shift_scale(ss_converted, shift, width, hasshift, haswidth)
    _check_error()
    return result if result != _ffi.NULL else None


def dateset_shift_scale(s: Annotated[_ffi.CData, 'const Set *'], shift: int, width: int, hasshift: bool, haswidth: bool) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
...
def datespan_shift_scale(s: Annotated[_ffi.CData, 'const Span *'], shift: int, width: int, hasshift: bool, haswidth: bool) -> Annotated[_ffi.CData, 'Span *']:
    s_converted = _ffi.cast('const Span *', s)
...
def datespanset_shift_scale(ss: Annotated[_ffi.CData, 'const SpanSet *'], shift: int, width: int, hasshift: bool, haswidth: bool) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def floatset_shift_scale(s: Annotated[_ffi.CData, 'const Set *'], shift: float, width: float, hasshift: bool, haswidth: bool) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
...
def floatspan_shift_scale(s: Annotated[_ffi.CData, 'const Span *'], shift: float, width: float, hasshift: bool, haswidth: bool) -> Annotated[_ffi.CData, 'Span *']:
    s_converted = _ffi.cast('const Span *', s)
...
def floatspanset_degrees(ss: Annotated[_ffi.CData, 'const SpanSet *'], normalize: bool) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def floatspanset_shift_scale(ss: Annotated[_ffi.CData, 'const SpanSet *'], shift: float, width: float, hasshift: bool, haswidth: bool) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def intset_shift_scale(s: Annotated[_ffi.CData, 'const Set *'], shift: int, width: int, hasshift: bool, haswidth: bool) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
...
def intspan_shift_scale(s: Annotated[_ffi.CData, 'const Span *'], shift: int, width: int, hasshift: bool, haswidth: bool) -> Annotated[_ffi.CData, 'Span *']:
    s_converted = _ffi.cast('const Span *', s)
...
def intspanset_shift_scale(ss: Annotated[_ffi.CData, 'const SpanSet *'], shift: int, width: int, hasshift: bool, haswidth: bool) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tstzspan_expand(s: Annotated[_ffi.CData, 'const Span *'], interv: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Span *']:
    s_converted = _ffi.cast('const Span *', s)
    interv_converted = _ffi.cast('const int *', interv)
...
def textcat_text_textset(txt: Annotated[_ffi.CData, 'const int *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    txt_converted = _ffi.cast('const int *', txt)
    s_converted = _ffi.cast('const Set *', s)
...
def textcat_textset_text(s: Annotated[_ffi.CData, 'const Set *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    txt_converted = _ffi.cast('const int *', txt)
...
def timestamptz_tprecision(t: int, duration: Annotated[_ffi.CData, 'const int *'], torigin: int) -> Annotated[int, 'int']:
    duration_converted = _ffi.cast('const int *', duration)
    result = _lib.timestamptz_tprecision(t, duration_converted, torigin)
    _check_error()
    return result if result != _ffi.NULL else None


def tstzset_shift_scale(s: Annotated[_ffi.CData, 'const Set *'], shift: Annotated[_ffi.CData, 'const int *'] | None, duration: Annotated[_ffi.CData, 'const int *'] | None) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    shift_converted = _ffi.cast('const int *', shift) if shift is not None else _ffi.NULL
    duration_converted = _ffi.cast('const int *', duration) if duration is not None else _ffi.NULL
    result = _lib.tstzset_shift_scale(s_converted, shift_converted, duration_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tstzset_tprecision(s: Annotated[_ffi.CData, 'const Set *'], duration: Annotated[_ffi.CData, 'const int *'], torigin: int) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    duration_converted = _ffi.cast('const int *', duration)
    result = _lib.tstzset_tprecision(s_converted, duration_converted, torigin)
    _check_error()
    return result if result != _ffi.NULL else None


def tstzspan_shift_scale(s: Annotated[_ffi.CData, 'const Span *'], shift: Annotated[_ffi.CData, 'const int *'] | None, duration: Annotated[_ffi.CData, 'const int *'] | None) -> Annotated[_ffi.CData, 'Span *']:
    s_converted = _ffi.cast('const Span *', s)
    shift_converted = _ffi.cast('const int *', shift) if shift is not None else _ffi.NULL
    duration_converted = _ffi.cast('const int *', duration) if duration is not None else _ffi.NULL
...
def tstzspan_tprecision(s: Annotated[_ffi.CData, 'const Span *'], duration: Annotated[_ffi.CData, 'const int *'], torigin: int) -> Annotated[_ffi.CData, 'Span *']:
    s_converted = _ffi.cast('const Span *', s)
    duration_converted = _ffi.cast('const int *', duration)
    result = _lib.tstzspan_tprecision(s_converted, duration_converted, torigin)
    _check_error()
    return result if result != _ffi.NULL else None


def tstzspanset_shift_scale(ss: Annotated[_ffi.CData, 'const SpanSet *'], shift: Annotated[_ffi.CData, 'const int *'] | None, duration: Annotated[_ffi.CData, 'const int *'] | None) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    shift_converted = _ffi.cast('const int *', shift) if shift is not None else _ffi.NULL
    duration_converted = _ffi.cast('const int *', duration) if duration is not None else _ffi.NULL
...
def tstzspanset_tprecision(ss: Annotated[_ffi.CData, 'const SpanSet *'], duration: Annotated[_ffi.CData, 'const int *'], torigin: int) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    duration_converted = _ffi.cast('const int *', duration)
    result = _lib.tstzspanset_tprecision(ss_converted, duration_converted, torigin)
    _check_error()
    return result if result != _ffi.NULL else None


def set_cmp(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[int, 'int']:
...
def set_eq(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Set *', s1)
    s2_converted = _ffi.cast('const Set *', s2)
...
def set_ge(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Set *', s1)
    s2_converted = _ffi.cast('const Set *', s2)
...
def set_gt(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Set *', s1)
    s2_converted = _ffi.cast('const Set *', s2)
...
def set_le(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Set *', s1)
    s2_converted = _ffi.cast('const Set *', s2)
...
def set_lt(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Set *', s1)
    s2_converted = _ffi.cast('const Set *', s2)
...
def set_ne(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Set *', s1)
    s2_converted = _ffi.cast('const Set *', s2)
...
def span_cmp(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[int, 'int']:
...
def span_eq(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def span_ge(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def span_gt(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def span_le(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def span_lt(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def span_ne(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def spanset_cmp(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[int, 'int']:
...
def spanset_eq(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def spanset_ge(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def spanset_gt(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def spanset_le(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def spanset_lt(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def spanset_ne(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def adjacent_span_bigint(s: Annotated[_ffi.CData, 'const Span *'], i: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.adjacent_span_bigint(s_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def adjacent_span_date(s: Annotated[_ffi.CData, 'const Span *'], d: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.adjacent_span_date(s_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def adjacent_span_span(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def adjacent_span_spanset(s: Annotated[_ffi.CData, 'const Span *'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def adjacent_span_timestamptz(s: Annotated[_ffi.CData, 'const Span *'], t: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.adjacent_span_timestamptz(s_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def adjacent_spanset_bigint(ss: Annotated[_ffi.CData, 'const SpanSet *'], i: int) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.adjacent_spanset_bigint(ss_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def adjacent_spanset_date(ss: Annotated[_ffi.CData, 'const SpanSet *'], d: int) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.adjacent_spanset_date(ss_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def adjacent_spanset_timestamptz(ss: Annotated[_ffi.CData, 'const SpanSet *'], t: int) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.adjacent_spanset_timestamptz(ss_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def adjacent_spanset_span(ss: Annotated[_ffi.CData, 'const SpanSet *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def adjacent_spanset_spanset(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def contained_bigint_set(i: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.contained_bigint_set(i, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def contained_bigint_span(i: int, s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.contained_bigint_span(i, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def contained_bigint_spanset(i: int, ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.contained_bigint_spanset(i, ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def contained_date_set(d: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.contained_date_set(d, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def contained_date_span(d: int, s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.contained_date_span(d, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def contained_date_spanset(d: int, ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.contained_date_spanset(d, ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def contained_set_set(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Set *', s1)
    s2_converted = _ffi.cast('const Set *', s2)
...
def contained_span_span(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def contained_span_spanset(s: Annotated[_ffi.CData, 'const Span *'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def contained_spanset_span(ss: Annotated[_ffi.CData, 'const SpanSet *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def contained_spanset_spanset(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def contained_text_set(txt: Annotated[_ffi.CData, 'const int *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    txt_converted = _ffi.cast('const int *', txt)
    s_converted = _ffi.cast('const Set *', s)
...
def contained_timestamptz_set(t: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.contained_timestamptz_set(t, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def contained_timestamptz_span(t: int, s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.contained_timestamptz_span(t, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def contained_timestamptz_spanset(t: int, ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.contained_timestamptz_spanset(t, ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def contains_set_bigint(s: Annotated[_ffi.CData, 'const Set *'], i: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.contains_set_bigint(s_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def contains_set_date(s: Annotated[_ffi.CData, 'const Set *'], d: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.contains_set_date(s_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def contains_set_set(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Set *', s1)
    s2_converted = _ffi.cast('const Set *', s2)
...
def contains_set_text(s: Annotated[_ffi.CData, 'const Set *'], t: Annotated[_ffi.CData, 'int *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    t_converted = _ffi.cast('int *', t)
...
def contains_set_timestamptz(s: Annotated[_ffi.CData, 'const Set *'], t: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.contains_set_timestamptz(s_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def contains_span_bigint(s: Annotated[_ffi.CData, 'const Span *'], i: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.contains_span_bigint(s_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def contains_span_date(s: Annotated[_ffi.CData, 'const Span *'], d: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.contains_span_date(s_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def contains_span_span(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def contains_span_spanset(s: Annotated[_ffi.CData, 'const Span *'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def contains_span_timestamptz(s: Annotated[_ffi.CData, 'const Span *'], t: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.contains_span_timestamptz(s_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def contains_spanset_bigint(ss: Annotated[_ffi.CData, 'const SpanSet *'], i: int) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.contains_spanset_bigint(ss_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def contains_spanset_date(ss: Annotated[_ffi.CData, 'const SpanSet *'], d: int) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.contains_spanset_date(ss_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def contains_spanset_span(ss: Annotated[_ffi.CData, 'const SpanSet *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def contains_spanset_spanset(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def contains_spanset_timestamptz(ss: Annotated[_ffi.CData, 'const SpanSet *'], t: int) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.contains_spanset_timestamptz(ss_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def overlaps_set_set(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Set *', s1)
    s2_converted = _ffi.cast('const Set *', s2)
...
def overlaps_span_span(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def overlaps_span_spanset(s: Annotated[_ffi.CData, 'const Span *'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def overlaps_spanset_span(ss: Annotated[_ffi.CData, 'const SpanSet *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def overlaps_spanset_spanset(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def after_date_set(d: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.after_date_set(d, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def after_date_span(d: int, s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.after_date_span(d, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def after_date_spanset(d: int, ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.after_date_spanset(d, ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def after_set_date(s: Annotated[_ffi.CData, 'const Set *'], d: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.after_set_date(s_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def after_set_timestamptz(s: Annotated[_ffi.CData, 'const Set *'], t: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.after_set_timestamptz(s_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def after_span_date(s: Annotated[_ffi.CData, 'const Span *'], d: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.after_span_date(s_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def after_span_timestamptz(s: Annotated[_ffi.CData, 'const Span *'], t: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.after_span_timestamptz(s_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def after_spanset_date(ss: Annotated[_ffi.CData, 'const SpanSet *'], d: int) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.after_spanset_date(ss_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def after_spanset_timestamptz(ss: Annotated[_ffi.CData, 'const SpanSet *'], t: int) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.after_spanset_timestamptz(ss_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def after_timestamptz_set(t: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.after_timestamptz_set(t, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def after_timestamptz_span(t: int, s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.after_timestamptz_span(t, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def after_timestamptz_spanset(t: int, ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.after_timestamptz_spanset(t, ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def before_date_set(d: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.before_date_set(d, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def before_date_span(d: int, s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.before_date_span(d, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def before_date_spanset(d: int, ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.before_date_spanset(d, ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def before_set_date(s: Annotated[_ffi.CData, 'const Set *'], d: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.before_set_date(s_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def before_set_timestamptz(s: Annotated[_ffi.CData, 'const Set *'], t: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.before_set_timestamptz(s_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def before_span_date(s: Annotated[_ffi.CData, 'const Span *'], d: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.before_span_date(s_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def before_span_timestamptz(s: Annotated[_ffi.CData, 'const Span *'], t: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.before_span_timestamptz(s_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def before_spanset_date(ss: Annotated[_ffi.CData, 'const SpanSet *'], d: int) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.before_spanset_date(ss_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def before_spanset_timestamptz(ss: Annotated[_ffi.CData, 'const SpanSet *'], t: int) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.before_spanset_timestamptz(ss_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def before_timestamptz_set(t: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.before_timestamptz_set(t, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def before_timestamptz_span(t: int, s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.before_timestamptz_span(t, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def before_timestamptz_spanset(t: int, ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.before_timestamptz_spanset(t, ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def left_bigint_set(i: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.left_bigint_set(i, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def left_bigint_span(i: int, s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.left_bigint_span(i, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def left_bigint_spanset(i: int, ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.left_bigint_spanset(i, ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def left_set_bigint(s: Annotated[_ffi.CData, 'const Set *'], i: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.left_set_bigint(s_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def left_set_set(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Set *', s1)
    s2_converted = _ffi.cast('const Set *', s2)
...
def left_set_text(s: Annotated[_ffi.CData, 'const Set *'], txt: Annotated[_ffi.CData, 'int *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    txt_converted = _ffi.cast('int *', txt)
...
def left_span_bigint(s: Annotated[_ffi.CData, 'const Span *'], i: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.left_span_bigint(s_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def left_span_span(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def left_span_spanset(s: Annotated[_ffi.CData, 'const Span *'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def left_spanset_bigint(ss: Annotated[_ffi.CData, 'const SpanSet *'], i: int) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.left_spanset_bigint(ss_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def left_spanset_span(ss: Annotated[_ffi.CData, 'const SpanSet *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def left_spanset_spanset(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def left_text_set(txt: Annotated[_ffi.CData, 'const int *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    txt_converted = _ffi.cast('const int *', txt)
    s_converted = _ffi.cast('const Set *', s)
...
def overafter_date_set(d: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.overafter_date_set(d, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overafter_date_span(d: int, s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.overafter_date_span(d, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overafter_date_spanset(d: int, ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.overafter_date_spanset(d, ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overafter_set_date(s: Annotated[_ffi.CData, 'const Set *'], d: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.overafter_set_date(s_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overafter_set_timestamptz(s: Annotated[_ffi.CData, 'const Set *'], t: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.overafter_set_timestamptz(s_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overafter_span_date(s: Annotated[_ffi.CData, 'const Span *'], d: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.overafter_span_date(s_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overafter_span_timestamptz(s: Annotated[_ffi.CData, 'const Span *'], t: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.overafter_span_timestamptz(s_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overafter_spanset_date(ss: Annotated[_ffi.CData, 'const SpanSet *'], d: int) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.overafter_spanset_date(ss_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overafter_spanset_timestamptz(ss: Annotated[_ffi.CData, 'const SpanSet *'], t: int) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.overafter_spanset_timestamptz(ss_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overafter_timestamptz_set(t: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.overafter_timestamptz_set(t, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overafter_timestamptz_span(t: int, s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.overafter_timestamptz_span(t, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overafter_timestamptz_spanset(t: int, ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.overafter_timestamptz_spanset(t, ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overbefore_date_set(d: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.overbefore_date_set(d, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overbefore_date_span(d: int, s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.overbefore_date_span(d, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overbefore_date_spanset(d: int, ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.overbefore_date_spanset(d, ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overbefore_set_date(s: Annotated[_ffi.CData, 'const Set *'], d: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.overbefore_set_date(s_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overbefore_set_timestamptz(s: Annotated[_ffi.CData, 'const Set *'], t: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.overbefore_set_timestamptz(s_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overbefore_span_date(s: Annotated[_ffi.CData, 'const Span *'], d: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.overbefore_span_date(s_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overbefore_span_timestamptz(s: Annotated[_ffi.CData, 'const Span *'], t: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.overbefore_span_timestamptz(s_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overbefore_spanset_date(ss: Annotated[_ffi.CData, 'const SpanSet *'], d: int) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.overbefore_spanset_date(ss_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overbefore_spanset_timestamptz(ss: Annotated[_ffi.CData, 'const SpanSet *'], t: int) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.overbefore_spanset_timestamptz(ss_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overbefore_timestamptz_set(t: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.overbefore_timestamptz_set(t, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overbefore_timestamptz_span(t: int, s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.overbefore_timestamptz_span(t, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overbefore_timestamptz_spanset(t: int, ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.overbefore_timestamptz_spanset(t, ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overleft_bigint_set(i: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.overleft_bigint_set(i, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overleft_bigint_span(i: int, s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.overleft_bigint_span(i, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overleft_bigint_spanset(i: int, ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.overleft_bigint_spanset(i, ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overleft_set_bigint(s: Annotated[_ffi.CData, 'const Set *'], i: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.overleft_set_bigint(s_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overleft_set_set(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Set *', s1)
    s2_converted = _ffi.cast('const Set *', s2)
...
def overleft_set_text(s: Annotated[_ffi.CData, 'const Set *'], txt: Annotated[_ffi.CData, 'int *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    txt_converted = _ffi.cast('int *', txt)
...
def overleft_span_bigint(s: Annotated[_ffi.CData, 'const Span *'], i: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.overleft_span_bigint(s_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overleft_span_span(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def overleft_span_spanset(s: Annotated[_ffi.CData, 'const Span *'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def overleft_spanset_bigint(ss: Annotated[_ffi.CData, 'const SpanSet *'], i: int) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.overleft_spanset_bigint(ss_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overleft_spanset_span(ss: Annotated[_ffi.CData, 'const SpanSet *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def overleft_spanset_spanset(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def overleft_text_set(txt: Annotated[_ffi.CData, 'const int *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    txt_converted = _ffi.cast('const int *', txt)
    s_converted = _ffi.cast('const Set *', s)
...
def overright_bigint_set(i: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.overright_bigint_set(i, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overright_bigint_span(i: int, s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.overright_bigint_span(i, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overright_bigint_spanset(i: int, ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.overright_bigint_spanset(i, ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overright_set_bigint(s: Annotated[_ffi.CData, 'const Set *'], i: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.overright_set_bigint(s_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overright_set_set(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Set *', s1)
    s2_converted = _ffi.cast('const Set *', s2)
...
def overright_set_text(s: Annotated[_ffi.CData, 'const Set *'], txt: Annotated[_ffi.CData, 'int *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    txt_converted = _ffi.cast('int *', txt)
...
def overright_span_bigint(s: Annotated[_ffi.CData, 'const Span *'], i: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.overright_span_bigint(s_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overright_span_span(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def overright_span_spanset(s: Annotated[_ffi.CData, 'const Span *'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def overright_spanset_bigint(ss: Annotated[_ffi.CData, 'const SpanSet *'], i: int) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.overright_spanset_bigint(ss_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def overright_spanset_span(ss: Annotated[_ffi.CData, 'const SpanSet *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def overright_spanset_spanset(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def overright_text_set(txt: Annotated[_ffi.CData, 'const int *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    txt_converted = _ffi.cast('const int *', txt)
    s_converted = _ffi.cast('const Set *', s)
...
def right_bigint_set(i: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.right_bigint_set(i, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def right_bigint_span(i: int, s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.right_bigint_span(i, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def right_bigint_spanset(i: int, ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.right_bigint_spanset(i, ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def right_set_bigint(s: Annotated[_ffi.CData, 'const Set *'], i: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.right_set_bigint(s_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def right_set_set(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Set *', s1)
    s2_converted = _ffi.cast('const Set *', s2)
...
def right_set_text(s: Annotated[_ffi.CData, 'const Set *'], txt: Annotated[_ffi.CData, 'int *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    txt_converted = _ffi.cast('int *', txt)
...
def right_span_bigint(s: Annotated[_ffi.CData, 'const Span *'], i: int) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.right_span_bigint(s_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def right_span_span(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def right_span_spanset(s: Annotated[_ffi.CData, 'const Span *'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def right_spanset_bigint(ss: Annotated[_ffi.CData, 'const SpanSet *'], i: int) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.right_spanset_bigint(ss_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def right_spanset_span(ss: Annotated[_ffi.CData, 'const SpanSet *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def right_spanset_spanset(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def right_text_set(txt: Annotated[_ffi.CData, 'const int *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    txt_converted = _ffi.cast('const int *', txt)
    s_converted = _ffi.cast('const Set *', s)
...
def intersection_bigint_set(i: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.intersection_bigint_set(i, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def intersection_date_set(d: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.intersection_date_set(d, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def intersection_set_bigint(s: Annotated[_ffi.CData, 'const Set *'], i: int) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.intersection_set_bigint(s_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def intersection_set_date(s: Annotated[_ffi.CData, 'const Set *'], d: int) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.intersection_set_date(s_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def intersection_set_set(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    s1_converted = _ffi.cast('const Set *', s1)
    s2_converted = _ffi.cast('const Set *', s2)
...
def intersection_set_text(s: Annotated[_ffi.CData, 'const Set *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    txt_converted = _ffi.cast('const int *', txt)
...
def intersection_set_timestamptz(s: Annotated[_ffi.CData, 'const Set *'], t: int) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.intersection_set_timestamptz(s_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def intersection_span_bigint(s: Annotated[_ffi.CData, 'const Span *'], i: int) -> Annotated[_ffi.CData, 'Span *']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.intersection_span_bigint(s_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def intersection_span_date(s: Annotated[_ffi.CData, 'const Span *'], d: int) -> Annotated[_ffi.CData, 'Span *']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.intersection_span_date(s_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def intersection_span_span(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'Span *']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def intersection_span_spanset(s: Annotated[_ffi.CData, 'const Span *'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    s_converted = _ffi.cast('const Span *', s)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def intersection_span_timestamptz(s: Annotated[_ffi.CData, 'const Span *'], t: int) -> Annotated[_ffi.CData, 'Span *']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.intersection_span_timestamptz(s_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def intersection_spanset_bigint(ss: Annotated[_ffi.CData, 'const SpanSet *'], i: int) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.intersection_spanset_bigint(ss_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None


def intersection_spanset_date(ss: Annotated[_ffi.CData, 'const SpanSet *'], d: int) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.intersection_spanset_date(ss_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None


def intersection_spanset_float(ss: Annotated[_ffi.CData, 'const SpanSet *'], d: float) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def intersection_spanset_int(ss: Annotated[_ffi.CData, 'const SpanSet *'], i: int) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def intersection_spanset_span(ss: Annotated[_ffi.CData, 'const SpanSet *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def intersection_spanset_spanset(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def intersection_spanset_timestamptz(ss: Annotated[_ffi.CData, 'const SpanSet *'], t: int) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.intersection_spanset_timestamptz(ss_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def intersection_text_set(txt: Annotated[_ffi.CData, 'const int *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    txt_converted = _ffi.cast('const int *', txt)
    s_converted = _ffi.cast('const Set *', s)
...
def intersection_timestamptz_set(t: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.intersection_timestamptz_set(t, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def minus_bigint_set(i: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.minus_bigint_set(i, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def minus_bigint_span(i: int, s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.minus_bigint_span(i, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def minus_bigint_spanset(i: int, ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.minus_bigint_spanset(i, ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def minus_date_set(d: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.minus_date_set(d, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def minus_date_span(d: int, s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.minus_date_span(d, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def minus_date_spanset(d: int, ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.minus_date_spanset(d, ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def minus_set_bigint(s: Annotated[_ffi.CData, 'const Set *'], i: int) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.minus_set_bigint(s_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def minus_set_date(s: Annotated[_ffi.CData, 'const Set *'], d: int) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.minus_set_date(s_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def minus_set_set(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    s1_converted = _ffi.cast('const Set *', s1)
    s2_converted = _ffi.cast('const Set *', s2)
...
def minus_set_text(s: Annotated[_ffi.CData, 'const Set *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    txt_converted = _ffi.cast('const int *', txt)
...
def minus_set_timestamptz(s: Annotated[_ffi.CData, 'const Set *'], t: int) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.minus_set_timestamptz(s_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def minus_span_bigint(s: Annotated[_ffi.CData, 'const Span *'], i: int) -> Annotated[_ffi.CData, 'SpanSet *']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.minus_span_bigint(s_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def minus_span_date(s: Annotated[_ffi.CData, 'const Span *'], d: int) -> Annotated[_ffi.CData, 'SpanSet *']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.minus_span_date(s_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def minus_span_span(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def minus_span_spanset(s: Annotated[_ffi.CData, 'const Span *'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    s_converted = _ffi.cast('const Span *', s)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def minus_span_timestamptz(s: Annotated[_ffi.CData, 'const Span *'], t: int) -> Annotated[_ffi.CData, 'SpanSet *']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.minus_span_timestamptz(s_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def minus_spanset_bigint(ss: Annotated[_ffi.CData, 'const SpanSet *'], i: int) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.minus_spanset_bigint(ss_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def minus_spanset_date(ss: Annotated[_ffi.CData, 'const SpanSet *'], d: int) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.minus_spanset_date(ss_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def minus_spanset_span(ss: Annotated[_ffi.CData, 'const SpanSet *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def minus_spanset_spanset(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def minus_spanset_timestamptz(ss: Annotated[_ffi.CData, 'const SpanSet *'], t: int) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.minus_spanset_timestamptz(ss_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def minus_text_set(txt: Annotated[_ffi.CData, 'const int *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    txt_converted = _ffi.cast('const int *', txt)
    s_converted = _ffi.cast('const Set *', s)
...
def minus_timestamptz_set(t: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.minus_timestamptz_set(t, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def minus_timestamptz_span(t: int, s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.minus_timestamptz_span(t, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def minus_timestamptz_spanset(t: int, ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.minus_timestamptz_spanset(t, ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def union_bigint_set(i: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.union_bigint_set(i, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def union_bigint_span(s: Annotated[_ffi.CData, 'const Span *'], i: int) -> Annotated[_ffi.CData, 'SpanSet *']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.union_bigint_span(s_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def union_bigint_spanset(i: int, ss: Annotated[_ffi.CData, 'SpanSet *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    ...
    result = _lib.union_bigint_spanset(i, ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def union_date_set(d: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.union_date_set(d, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def union_date_span(s: Annotated[_ffi.CData, 'const Span *'], d: int) -> Annotated[_ffi.CData, 'SpanSet *']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.union_date_span(s_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def union_date_spanset(d: int, ss: Annotated[_ffi.CData, 'SpanSet *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('SpanSet *', ss)
    result = _lib.union_date_spanset(d, ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def union_set_bigint(s: Annotated[_ffi.CData, 'const Set *'], i: int) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.union_set_bigint(s_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def union_set_date(s: Annotated[_ffi.CData, 'const Set *'], d: int) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.union_set_date(s_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def union_set_set(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    s1_converted = _ffi.cast('const Set *', s1)
    s2_converted = _ffi.cast('const Set *', s2)
...
def union_set_text(s: Annotated[_ffi.CData, 'const Set *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    txt_converted = _ffi.cast('const int *', txt)
...
def union_set_timestamptz(s: Annotated[_ffi.CData, 'const Set *'], t: int) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.union_set_timestamptz(s_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def union_span_bigint(s: Annotated[_ffi.CData, 'const Span *'], i: int) -> Annotated[_ffi.CData, 'SpanSet *']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.union_span_bigint(s_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def union_span_date(s: Annotated[_ffi.CData, 'const Span *'], d: int) -> Annotated[_ffi.CData, 'SpanSet *']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.union_span_date(s_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def union_span_span(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def union_span_spanset(s: Annotated[_ffi.CData, 'const Span *'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    s_converted = _ffi.cast('const Span *', s)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def union_span_timestamptz(s: Annotated[_ffi.CData, 'const Span *'], t: int) -> Annotated[_ffi.CData, 'SpanSet *']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.union_span_timestamptz(s_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def union_spanset_bigint(ss: Annotated[_ffi.CData, 'const SpanSet *'], i: int) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.union_spanset_bigint(ss_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def union_spanset_date(ss: Annotated[_ffi.CData, 'const SpanSet *'], d: int) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.union_spanset_date(ss_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def union_spanset_span(ss: Annotated[_ffi.CData, 'const SpanSet *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def union_spanset_spanset(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def union_spanset_timestamptz(ss: Annotated[_ffi.CData, 'const SpanSet *'], t: int) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.union_spanset_timestamptz(ss_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def union_text_set(txt: Annotated[_ffi.CData, 'const int *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    txt_converted = _ffi.cast('const int *', txt)
    s_converted = _ffi.cast('const Set *', s)
...
def union_timestamptz_set(t: int, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.union_timestamptz_set(t, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def union_timestamptz_span(t: int, s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.union_timestamptz_span(t, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def union_timestamptz_spanset(t: int, ss: Annotated[_ffi.CData, 'SpanSet *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('SpanSet *', ss)
    result = _lib.union_timestamptz_spanset(t, ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def distance_bigintset_bigintset(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[int, 'int']:
    s1_converted = _ffi.cast('const Set *', s1)
    s2_converted = _ffi.cast('const Set *', s2)
...
def distance_bigintspan_bigintspan(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[int, 'int']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def distance_bigintspanset_bigintspan(ss: Annotated[_ffi.CData, 'const SpanSet *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def distance_bigintspanset_bigintspanset(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[int, 'int']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def distance_dateset_dateset(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[int, 'int']:
    s1_converted = _ffi.cast('const Set *', s1)
    s2_converted = _ffi.cast('const Set *', s2)
...
def distance_datespan_datespan(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[int, 'int']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def distance_datespanset_datespan(ss: Annotated[_ffi.CData, 'const SpanSet *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def distance_datespanset_datespanset(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[int, 'int']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def distance_floatset_floatset(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[float, 'double']:
    s1_converted = _ffi.cast('const Set *', s1)
    s2_converted = _ffi.cast('const Set *', s2)
...
def distance_floatspan_floatspan(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[float, 'double']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def distance_floatspanset_floatspan(ss: Annotated[_ffi.CData, 'const SpanSet *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[float, 'double']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def distance_floatspanset_floatspanset(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[float, 'double']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def distance_intset_intset(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[int, 'int']:
    s1_converted = _ffi.cast('const Set *', s1)
    s2_converted = _ffi.cast('const Set *', s2)
...
def distance_intspan_intspan(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[int, 'int']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def distance_intspanset_intspan(ss: Annotated[_ffi.CData, 'const SpanSet *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def distance_intspanset_intspanset(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[int, 'int']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def distance_set_bigint(s: Annotated[_ffi.CData, 'const Set *'], i: int) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.distance_set_bigint(s_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def distance_set_date(s: Annotated[_ffi.CData, 'const Set *'], d: int) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.distance_set_date(s_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def distance_set_timestamptz(s: Annotated[_ffi.CData, 'const Set *'], t: int) -> Annotated[float, 'double']:
    s_converted = _ffi.cast('const Set *', s)
    result = _lib.distance_set_timestamptz(s_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def distance_span_bigint(s: Annotated[_ffi.CData, 'const Span *'], i: int) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.distance_span_bigint(s_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def distance_span_date(s: Annotated[_ffi.CData, 'const Span *'], d: int) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.distance_span_date(s_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def distance_span_timestamptz(s: Annotated[_ffi.CData, 'const Span *'], t: int) -> Annotated[float, 'double']:
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.distance_span_timestamptz(s_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def distance_spanset_bigint(ss: Annotated[_ffi.CData, 'const SpanSet *'], i: int) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.distance_spanset_bigint(ss_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def distance_spanset_date(ss: Annotated[_ffi.CData, 'const SpanSet *'], d: int) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.distance_spanset_date(ss_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def distance_spanset_timestamptz(ss: Annotated[_ffi.CData, 'const SpanSet *'], t: int) -> Annotated[float, 'double']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    result = _lib.distance_spanset_timestamptz(ss_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def distance_tstzset_tstzset(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[float, 'double']:
    s1_converted = _ffi.cast('const Set *', s1)
    s2_converted = _ffi.cast('const Set *', s2)
...
def distance_tstzspan_tstzspan(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[float, 'double']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def distance_tstzspanset_tstzspan(ss: Annotated[_ffi.CData, 'const SpanSet *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[float, 'double']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def distance_tstzspanset_tstzspanset(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[float, 'double']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def bigint_extent_transfn(state: Annotated[_ffi.CData, 'Span *'], i: int) -> Annotated[_ffi.CData, 'Span *']:
    ...
    result = _lib.bigint_extent_transfn(state_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def bigint_union_transfn(state: Annotated[_ffi.CData, 'Set *'], i: int) -> Annotated[_ffi.CData, 'Set *']:
    ...
    result = _lib.bigint_union_transfn(state_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None
...
def date_extent_transfn(state: Annotated[_ffi.CData, 'Span *'], d: int) -> Annotated[_ffi.CData, 'Span *']:
    state_converted = _ffi.cast('Span *', state)
    result = _lib.date_extent_transfn(state_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def date_union_transfn(state: Annotated[_ffi.CData, 'Set *'], d: int) -> Annotated[_ffi.CData, 'Set *']:
    state_converted = _ffi.cast('Set *', state)
    result = _lib.date_union_transfn(state_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None
...
def set_extent_transfn(state: Annotated[_ffi.CData, 'Span *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Span *']:
    state_converted = _ffi.cast('Span *', state)
    s_converted = _ffi.cast('const Set *', s)
...
def set_union_transfn(state: Annotated[_ffi.CData, 'Set *'], s: Annotated[_ffi.CData, 'Set *']) -> Annotated[_ffi.CData, 'Set *']:
    state_converted = _ffi.cast('Set *', state)
...
def span_extent_transfn(state: Annotated[_ffi.CData, 'Span *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'Span *']:
    state_converted = _ffi.cast('Span *', state)
    s_converted = _ffi.cast('const Span *', s)
...
def span_union_transfn(state: Annotated[_ffi.CData, 'SpanSet *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'SpanSet *']:
...
def spanset_extent_transfn(state: Annotated[_ffi.CData, 'Span *'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'Span *']:
    state_converted = _ffi.cast('Span *', state)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def spanset_union_transfn(state: Annotated[_ffi.CData, 'SpanSet *'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    state_converted = _ffi.cast('SpanSet *', state)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def text_union_transfn(state: Annotated[_ffi.CData, 'Set *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Set *']:
    state_converted = _ffi.cast('Set *', state)
    txt_converted = _ffi.cast('const int *', txt)
...
def timestamptz_extent_transfn(state: Annotated[_ffi.CData, 'Span *'], t: int) -> Annotated[_ffi.CData, 'Span *']:
    state_converted = _ffi.cast('Span *', state)
    result = _lib.timestamptz_extent_transfn(state_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def timestamptz_union_transfn(state: Annotated[_ffi.CData, 'Set *'], t: int) -> Annotated[_ffi.CData, 'Set *']:
    state_converted = _ffi.cast('Set *', state)
    result = _lib.timestamptz_union_transfn(state_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def bigint_get_bin(value: int, vsize: int, vorigin: int) -> Annotated[int, 'int']:
    result = _lib.bigint_get_bin(value, vsize, vorigin)
    _check_error()
    return result if result != _ffi.NULL else None
...
def bigintspan_bins(s: Annotated[_ffi.CData, 'const Span *'], vsize: int, vorigin: int, count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'Span *']:
    s_converted = _ffi.cast('const Span *', s)
    count_converted = _ffi.cast('int *', count)
    result = _lib.bigintspan_bins(s_converted, vsize, vorigin, count_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def bigintspanset_bins(ss: Annotated[_ffi.CData, 'const SpanSet *'], vsize: int, vorigin: int, count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'Span *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    count_converted = _ffi.cast('int *', count)
    result = _lib.bigintspanset_bins(ss_converted, vsize, vorigin, count_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def date_get_bin(d: int, duration: Annotated[_ffi.CData, 'const int *'], torigin: int) -> Annotated[int, 'int']:
    duration_converted = _ffi.cast('const int *', duration)
    result = _lib.date_get_bin(d, duration_converted, torigin)
    _check_error()
    return result if result != _ffi.NULL else None


def datespan_bins(s: Annotated[_ffi.CData, 'const Span *'], duration: Annotated[_ffi.CData, 'const int *'], torigin: int, count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'Span *']:
    s_converted = _ffi.cast('const Span *', s)
    duration_converted = _ffi.cast('const int *', duration)
    count_converted = _ffi.cast('int *', count)
    result = _lib.datespan_bins(s_converted, duration_converted, torigin, count_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def datespanset_bins(ss: Annotated[_ffi.CData, 'const SpanSet *'], duration: Annotated[_ffi.CData, 'const int *'], torigin: int, count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'Span *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    duration_converted = _ffi.cast('const int *', duration)
    count_converted = _ffi.cast('int *', count)
    result = _lib.datespanset_bins(ss_converted, duration_converted, torigin, count_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def timestamptz_get_bin(t: int, duration: Annotated[_ffi.CData, 'const int *'], torigin: int) -> Annotated[int, 'int']:
    duration_converted = _ffi.cast('const int *', duration)
    result = _lib.timestamptz_get_bin(t, duration_converted, torigin)
    _check_error()
    return result if result != _ffi.NULL else None


def tstzspan_bins(s: Annotated[_ffi.CData, 'const Span *'], duration: Annotated[_ffi.CData, 'const int *'], origin: int, count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'Span *']:
    s_converted = _ffi.cast('const Span *', s)
    duration_converted = _ffi.cast('const int *', duration)
    count_converted = _ffi.cast('int *', count)
    result = _lib.tstzspan_bins(s_converted, duration_converted, origin, count_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tstzspanset_bins(ss: Annotated[_ffi.CData, 'const SpanSet *'], duration: Annotated[_ffi.CData, 'const int *'], torigin: int, count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'Span *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    duration_converted = _ffi.cast('const int *', duration)
    count_converted = _ffi.cast('int *', count)
    result = _lib.tstzspanset_bins(ss_converted, duration_converted, torigin, count_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tbox_as_wkb(box: Annotated[_ffi.CData, 'const TBox *'], variant: int) -> tuple[Annotated[_ffi.CData, 'uint8_t *'], Annotated[_ffi.CData, 'size_t *']]:
    box_converted = _ffi.cast('const TBox *', box)
    variant_converted = _ffi.cast('uint8_t', variant)
    size_out = _ffi.new('size_t *')
...
def float_timestamptz_to_tbox(d: float, t: int) -> Annotated[_ffi.CData, 'TBox *']:
    result = _lib.float_timestamptz_to_tbox(d, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def int_timestamptz_to_tbox(i: int, t: int) -> Annotated[_ffi.CData, 'TBox *']:
    result = _lib.int_timestamptz_to_tbox(i, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def numspan_tstzspan_to_tbox(span: Annotated[_ffi.CData, 'const Span *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'TBox *']:
...
def numspan_timestamptz_to_tbox(span: Annotated[_ffi.CData, 'const Span *'], t: int) -> Annotated[_ffi.CData, 'TBox *']:
    span_converted = _ffi.cast('const Span *', span)
    result = _lib.numspan_timestamptz_to_tbox(span_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tbox_make(s: Annotated[_ffi.CData, 'const Span *'] | None, p: Annotated[_ffi.CData, 'const Span *'] | None) -> Annotated[_ffi.CData, 'TBox *']:
...
def timestamptz_to_tbox(t: int) -> Annotated[_ffi.CData, 'TBox *']:
    result = _lib.timestamptz_to_tbox(t)
    _check_error()
    return result if result != _ffi.NULL else None


def tbox_hash(box: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[int, 'int']:
    box_converted = _ffi.cast('const TBox *', box)
    result = _lib.tbox_hash(box_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tbox_hash_extended(box: Annotated[_ffi.CData, 'const TBox *'], seed: int) -> Annotated[int, 'int']:
    box_converted = _ffi.cast('const TBox *', box)
    result = _lib.tbox_hash_extended(box_converted, seed)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tbox_tmax(box: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[_ffi.CData, 'int']:
    box_converted = _ffi.cast('const TBox *', box)
    out_result = _ffi.new('int *')
...
def tbox_tmin(box: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[_ffi.CData, 'int']:
    box_converted = _ffi.cast('const TBox *', box)
    out_result = _ffi.new('int *')
...
def tbox_expand_time(box: Annotated[_ffi.CData, 'const TBox *'], interv: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'TBox *']:
    box_converted = _ffi.cast('const TBox *', box)
    interv_converted = _ffi.cast('const int *', interv)
...
def tbox_shift_scale_time(box: Annotated[_ffi.CData, 'const TBox *'], shift: Annotated[_ffi.CData, 'const int *'] | None, duration: Annotated[_ffi.CData, 'const int *'] | None) -> Annotated[_ffi.CData, 'TBox *']:
    box_converted = _ffi.cast('const TBox *', box)
    shift_converted = _ffi.cast('const int *', shift) if shift is not None else _ffi.NULL
    duration_converted = _ffi.cast('const int *', duration) if duration is not None else _ffi.NULL
...
def tfloatbox_expand(box: Annotated[_ffi.CData, 'const TBox *'], d: float) -> Annotated[_ffi.CData, 'TBox *']:
    box_converted = _ffi.cast('const TBox *', box)
    result = _lib.tfloatbox_expand(box_converted, d)
    _check_error()
    return result if result != _ffi.NULL else None


def tfloatbox_shift_scale(box: Annotated[_ffi.CData, 'const TBox *'], shift: float, width: float, hasshift: bool, haswidth: bool) -> Annotated[_ffi.CData, 'TBox *']:
    box_converted = _ffi.cast('const TBox *', box)
    result = _lib.tfloatbox_shift_scale(box_converted, shift, width, hasshift, haswidth)
    _check_error()
    return result if result != _ffi.NULL else None


def tintbox_expand(box: Annotated[_ffi.CData, 'const TBox *'], i: int) -> Annotated[_ffi.CData, 'TBox *']:
    box_converted = _ffi.cast('const TBox *', box)
    result = _lib.tintbox_expand(box_converted, i)
    _check_error()
    return result if result != _ffi.NULL else None


def tintbox_shift_scale(box: Annotated[_ffi.CData, 'const TBox *'], shift: int, width: int, hasshift: bool, haswidth: bool) -> Annotated[_ffi.CData, 'TBox *']:
    box_converted = _ffi.cast('const TBox *', box)
    result = _lib.tintbox_shift_scale(box_converted, shift, width, hasshift, haswidth)
    _check_error()
    return result if result != _ffi.NULL else None


def union_tbox_tbox(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *'], strict: bool) -> Annotated[_ffi.CData, 'TBox *']:
...
def intersection_tbox_tbox(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[_ffi.CData, 'TBox *']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def adjacent_tbox_tbox(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def contained_tbox_tbox(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def contains_tbox_tbox(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def overlaps_tbox_tbox(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def same_tbox_tbox(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def after_tbox_tbox(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def before_tbox_tbox(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def left_tbox_tbox(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def overafter_tbox_tbox(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def overbefore_tbox_tbox(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def overleft_tbox_tbox(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def overright_tbox_tbox(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def right_tbox_tbox(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def tbox_cmp(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[int, 'int']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def tbox_eq(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def tbox_ge(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def tbox_gt(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def tbox_le(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def tbox_lt(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def tbox_ne(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def temporal_as_hexwkb(temp: Annotated[_ffi.CData, 'const Temporal *'], variant: int) -> tuple[Annotated[str, 'char *'], Annotated[_ffi.CData, 'size_t *']]:
    temp_converted = _ffi.cast('const Temporal *', temp)
    variant_converted = _ffi.cast('uint8_t', variant)
    size_out = _ffi.new('size_t *')
...
def temporal_as_mfjson(temp: Annotated[_ffi.CData, 'const Temporal *'], with_bbox: bool, flags: int, precision: int, srs: str | None) -> Annotated[str, 'char *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_as_wkb(temp: Annotated[_ffi.CData, 'const Temporal *'], variant: int) -> tuple[Annotated[_ffi.CData, 'uint8_t *'], Annotated[_ffi.CData, 'size_t *']]:
    temp_converted = _ffi.cast('const Temporal *', temp)
    variant_converted = _ffi.cast('uint8_t', variant)
    size_out = _ffi.new('size_t *')
...
def tbool_from_base_temp(b: bool, temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tboolinst_make(b: bool, t: int) -> Annotated[_ffi.CData, 'TInstant *']:
    result = _lib.tboolinst_make(b, t)
    _check_error()
    return result if result != _ffi.NULL else None


def tboolseq_from_base_tstzset(b: bool, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'TSequence *']:
    s_converted = _ffi.cast('const Set *', s)
...
def tboolseq_from_base_tstzspan(b: bool, s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'TSequence *']:
    s_converted = _ffi.cast('const Span *', s)
...
def tboolseqset_from_base_tstzspanset(b: bool, ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tfloat_from_base_temp(d: float, temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tfloatinst_make(d: float, t: int) -> Annotated[_ffi.CData, 'TInstant *']:
    result = _lib.tfloatinst_make(d, t)
    _check_error()
    return result if result != _ffi.NULL else None


def tfloatseq_from_base_tstzset(d: float, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'TSequence *']:
    s_converted = _ffi.cast('const Set *', s)
...
def tfloatseq_from_base_tstzspan(d: float, s: Annotated[_ffi.CData, 'const Span *'], interp: InterpolationType) -> Annotated[_ffi.CData, 'TSequence *']:
    s_converted = _ffi.cast('const Span *', s)
...
def tfloatseqset_from_base_tstzspanset(d: float, ss: Annotated[_ffi.CData, 'const SpanSet *'], interp: InterpolationType) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tintseq_from_base_tstzspan(i: int, s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'TSequence *']:
    s_converted = _ffi.cast('const Span *', s)
...
def tintseqset_from_base_tstzspanset(i: int, ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tsequence_make(instants: Annotated[list, 'TInstant **'], count: int, lower_inc: bool, upper_inc: bool, interp: InterpolationType, normalize: bool) -> Annotated[_ffi.CData, 'TSequence *']:
...
def tsequenceset_make(sequences: Annotated[list, 'TSequence **'], count: int, normalize: bool) -> Annotated[_ffi.CData, 'TSequenceSet *']:
...
def tsequenceset_make_gaps(instants: Annotated[list, 'TInstant **'], interp: InterpolationType, maxt: Annotated[_ffi.CData, 'const int *'] | None, maxdist: float) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    instants_converted = [_ffi.cast('TInstant *', x) for x in instants]
    maxt_converted = _ffi.cast('const int *', maxt) if maxt is not None else _ffi.NULL
    result = _lib.tsequenceset_make_gaps(instants_converted, len(instants), interp, maxt_converted, maxdist)
    _check_error()
    return result if result != _ffi.NULL else None


def ttext_from_base_temp(txt: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    txt_converted = _ffi.cast('const int *', txt)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ttextinst_make(txt: Annotated[_ffi.CData, 'const int *'], t: int) -> Annotated[_ffi.CData, 'TInstant *']:
    txt_converted = _ffi.cast('const int *', txt)
    result = _lib.ttextinst_make(txt_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def ttextseq_from_base_tstzset(txt: Annotated[_ffi.CData, 'const int *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'TSequence *']:
    txt_converted = _ffi.cast('const int *', txt)
    s_converted = _ffi.cast('const Set *', s)
...
def ttextseq_from_base_tstzspan(txt: Annotated[_ffi.CData, 'const int *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'TSequence *']:
    txt_converted = _ffi.cast('const int *', txt)
    s_converted = _ffi.cast('const Span *', s)
...
def ttextseqset_from_base_tstzspanset(txt: Annotated[_ffi.CData, 'const int *'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    txt_converted = _ffi.cast('const int *', txt)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tbool_value_at_timestamptz(temp: Annotated[_ffi.CData, 'const Temporal *'], t: int, strict: bool) -> Annotated[_ffi.CData, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    out_result = _ffi.new('bool *')
    result = _lib.tbool_value_at_timestamptz(temp_converted, t, strict, out_result)
    _check_error()
    if result:
        return out_result[0] if out_result[0] != _ffi.NULL else None
    return None
...
def temporal_duration(temp: Annotated[_ffi.CData, 'const Temporal *'], boundspan: bool) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_end_timestamptz(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_hash(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_segm_duration(temp: Annotated[_ffi.CData, 'const Temporal *'], duration: Annotated[_ffi.CData, 'const int *'], atleast: bool, strict: bool) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const int *', duration)
    result = _lib.temporal_segm_duration(temp_converted, duration_converted, atleast, strict)
    _check_error()
    return result if result != _ffi.NULL else None
...
def temporal_start_timestamptz(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_stops(temp: Annotated[_ffi.CData, 'const Temporal *'], maxdist: float, minduration: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    minduration_converted = _ffi.cast('const int *', minduration)
...
def temporal_timestamps(temp: Annotated[_ffi.CData, 'const Temporal *'], count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    count_converted = _ffi.cast('int *', count)
...
def temporal_timestamptz_n(temp: Annotated[_ffi.CData, 'const Temporal *'], n: int) -> Annotated[_ffi.CData, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    out_result = _ffi.new('int *')
...
def tfloat_value_at_timestamptz(temp: Annotated[_ffi.CData, 'const Temporal *'], t: int, strict: bool) -> Annotated[_ffi.CData, 'double']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    out_result = _ffi.new('double *')
    result = _lib.tfloat_value_at_timestamptz(temp_converted, t, strict, out_result)
    _check_error()
    if result:
        return out_result[0] if out_result[0] != _ffi.NULL else None
    return None
...
def tint_value_at_timestamptz(temp: Annotated[_ffi.CData, 'const Temporal *'], t: int, strict: bool) -> Annotated[_ffi.CData, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    out_result = _ffi.new('int *')
    result = _lib.tint_value_at_timestamptz(temp_converted, t, strict, out_result)
    _check_error()
    if result:
        return out_result[0] if out_result[0] != _ffi.NULL else None
    return None
...
def ttext_end_value(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ttext_max_value(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ttext_min_value(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ttext_start_value(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ttext_value_at_timestamptz(temp: Annotated[_ffi.CData, 'const Temporal *'], t: int, strict: bool) -> Annotated[list, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    out_result = _ffi.new('int **')
    result = _lib.ttext_value_at_timestamptz(temp_converted, t, strict, out_result)
    _check_error()
    if result:
        return out_result[0] if out_result[0] != _ffi.NULL else None
    return None
...
def ttext_value_n(temp: Annotated[_ffi.CData, 'const Temporal *'], n: int) -> Annotated[list, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    out_result = _ffi.new('int **')
...
def ttext_values(temp: Annotated[_ffi.CData, 'const Temporal *'], count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'int **']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    count_converted = _ffi.cast('int *', count)
...
def temparr_round(temp: Annotated[list, 'Temporal **'], count: int, maxdd: int) -> Annotated[_ffi.CData, 'Temporal **']:
    temp_converted = [_ffi.cast('Temporal *', x) for x in temp]
...
def temporal_scale_time(temp: Annotated[_ffi.CData, 'const Temporal *'], duration: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const int *', duration)
...
def temporal_set_interp(temp: Annotated[_ffi.CData, 'const Temporal *'], interp: InterpolationType) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_shift_scale_time(temp: Annotated[_ffi.CData, 'const Temporal *'], shift: Annotated[_ffi.CData, 'const int *'] | None, duration: Annotated[_ffi.CData, 'const int *'] | None) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    shift_converted = _ffi.cast('const int *', shift) if shift is not None else _ffi.NULL
    duration_converted = _ffi.cast('const int *', duration) if duration is not None else _ffi.NULL
...
def temporal_shift_time(temp: Annotated[_ffi.CData, 'const Temporal *'], shift: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    shift_converted = _ffi.cast('const int *', shift)
...
def temporal_to_tsequence(temp: Annotated[_ffi.CData, 'const Temporal *'], interp: InterpolationType) -> Annotated[_ffi.CData, 'TSequence *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_to_tsequenceset(temp: Annotated[_ffi.CData, 'const Temporal *'], interp: InterpolationType) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tfloat_degrees(temp: Annotated[_ffi.CData, 'const Temporal *'], normalize: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tfloat_scale_value(temp: Annotated[_ffi.CData, 'const Temporal *'], width: float) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tfloat_shift_scale_value(temp: Annotated[_ffi.CData, 'const Temporal *'], shift: float, width: float) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tfloat_shift_value(temp: Annotated[_ffi.CData, 'const Temporal *'], shift: float) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tint_scale_value(temp: Annotated[_ffi.CData, 'const Temporal *'], width: int) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tint_shift_scale_value(temp: Annotated[_ffi.CData, 'const Temporal *'], shift: int, width: int) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tint_shift_value(temp: Annotated[_ffi.CData, 'const Temporal *'], shift: int) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_append_tinstant(temp: Annotated[_ffi.CData, 'Temporal *'], inst: Annotated[_ffi.CData, 'const TInstant *'], interp: InterpolationType, maxdist: float, maxt: Annotated[_ffi.CData, 'const int *'] | None, expand: bool) -> Annotated[_ffi.CData, 'Temporal *']:
...
def temporal_append_tsequence(temp: Annotated[_ffi.CData, 'Temporal *'], seq: Annotated[_ffi.CData, 'const TSequence *'], expand: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('Temporal *', temp)
...
def temporal_delete_timestamptz(temp: Annotated[_ffi.CData, 'const Temporal *'], t: int, connect: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.temporal_delete_timestamptz(temp_converted, t, connect)
    _check_error()
    return result if result != _ffi.NULL else None


def temporal_delete_tstzset(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Set *'], connect: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Set *', s)
...
def temporal_delete_tstzspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *'], connect: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def temporal_delete_tstzspanset(temp: Annotated[_ffi.CData, 'const Temporal *'], ss: Annotated[_ffi.CData, 'const SpanSet *'], connect: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def temporal_insert(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *'], connect: bool) -> Annotated[_ffi.CData, 'Temporal *']:
...
def temporal_merge(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def temporal_merge_array(temparr: Annotated[list, 'Temporal **'], count: int) -> Annotated[_ffi.CData, 'Temporal *']:
...
def temporal_update(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *'], connect: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def temporal_after_timestamptz(temp: Annotated[_ffi.CData, 'const Temporal *'], t: int, strict: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.temporal_after_timestamptz(temp_converted, t, strict)
    _check_error()
    return result if result != _ffi.NULL else None
...
def temporal_at_timestamptz(temp: Annotated[_ffi.CData, 'const Temporal *'], t: int) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.temporal_at_timestamptz(temp_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def temporal_at_tstzset(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Set *', s)
...
def temporal_at_tstzspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def temporal_at_tstzspanset(temp: Annotated[_ffi.CData, 'const Temporal *'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def temporal_at_values(temp: Annotated[_ffi.CData, 'const Temporal *'], set: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    set_converted = _ffi.cast('const Set *', set)
...
def temporal_before_timestamptz(temp: Annotated[_ffi.CData, 'const Temporal *'], t: int, strict: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.temporal_before_timestamptz(temp_converted, t, strict)
    _check_error()
    return result if result != _ffi.NULL else None
...
def temporal_minus_timestamptz(temp: Annotated[_ffi.CData, 'const Temporal *'], t: int) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.temporal_minus_timestamptz(temp_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def temporal_minus_tstzset(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Set *', s)
...
def temporal_minus_tstzspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def temporal_minus_tstzspanset(temp: Annotated[_ffi.CData, 'const Temporal *'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def temporal_minus_values(temp: Annotated[_ffi.CData, 'const Temporal *'], set: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    set_converted = _ffi.cast('const Set *', set)
...
def tfloat_minus_value(temp: Annotated[_ffi.CData, 'const Temporal *'], d: float) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tnumber_at_span(temp: Annotated[_ffi.CData, 'const Temporal *'], span: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    span_converted = _ffi.cast('const Span *', span)
...
def tnumber_at_spanset(temp: Annotated[_ffi.CData, 'const Temporal *'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tnumber_at_tbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const TBox *', box)
...
def tnumber_minus_span(temp: Annotated[_ffi.CData, 'const Temporal *'], span: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    span_converted = _ffi.cast('const Span *', span)
...
def tnumber_minus_spanset(temp: Annotated[_ffi.CData, 'const Temporal *'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tnumber_minus_tbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const TBox *', box)
...
def ttext_at_value(temp: Annotated[_ffi.CData, 'const Temporal *'], txt: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    txt_converted = _ffi.cast('int *', txt)
...
def ttext_minus_value(temp: Annotated[_ffi.CData, 'const Temporal *'], txt: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    txt_converted = _ffi.cast('int *', txt)
...
def temporal_cmp(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def temporal_eq(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def temporal_ge(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def temporal_gt(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def temporal_le(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def temporal_lt(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def temporal_ne(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_eq_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_eq_text_ttext(txt: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    txt_converted = _ffi.cast('const int *', txt)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_eq_ttext_text(temp: Annotated[_ffi.CData, 'const Temporal *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    txt_converted = _ffi.cast('const int *', txt)
...
def always_ge_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_ge_text_ttext(txt: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    txt_converted = _ffi.cast('const int *', txt)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_ge_ttext_text(temp: Annotated[_ffi.CData, 'const Temporal *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    txt_converted = _ffi.cast('const int *', txt)
...
def always_gt_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_gt_text_ttext(txt: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    txt_converted = _ffi.cast('const int *', txt)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_gt_ttext_text(temp: Annotated[_ffi.CData, 'const Temporal *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    txt_converted = _ffi.cast('const int *', txt)
...
def always_le_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_le_text_ttext(txt: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    txt_converted = _ffi.cast('const int *', txt)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_le_ttext_text(temp: Annotated[_ffi.CData, 'const Temporal *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    txt_converted = _ffi.cast('const int *', txt)
...
def always_lt_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_lt_text_ttext(txt: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    txt_converted = _ffi.cast('const int *', txt)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_lt_ttext_text(temp: Annotated[_ffi.CData, 'const Temporal *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    txt_converted = _ffi.cast('const int *', txt)
...
def always_ne_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_ne_text_ttext(txt: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    txt_converted = _ffi.cast('const int *', txt)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_ne_ttext_text(temp: Annotated[_ffi.CData, 'const Temporal *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    txt_converted = _ffi.cast('const int *', txt)
...
def ever_eq_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_eq_text_ttext(txt: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    txt_converted = _ffi.cast('const int *', txt)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_eq_ttext_text(temp: Annotated[_ffi.CData, 'const Temporal *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    txt_converted = _ffi.cast('const int *', txt)
...
def ever_ge_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_ge_text_ttext(txt: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    txt_converted = _ffi.cast('const int *', txt)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_ge_ttext_text(temp: Annotated[_ffi.CData, 'const Temporal *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    txt_converted = _ffi.cast('const int *', txt)
...
def ever_gt_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_gt_text_ttext(txt: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    txt_converted = _ffi.cast('const int *', txt)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_gt_ttext_text(temp: Annotated[_ffi.CData, 'const Temporal *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    txt_converted = _ffi.cast('const int *', txt)
...
def ever_le_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_le_text_ttext(txt: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    txt_converted = _ffi.cast('const int *', txt)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_le_ttext_text(temp: Annotated[_ffi.CData, 'const Temporal *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    txt_converted = _ffi.cast('const int *', txt)
...
def ever_lt_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_lt_text_ttext(txt: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    txt_converted = _ffi.cast('const int *', txt)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_lt_ttext_text(temp: Annotated[_ffi.CData, 'const Temporal *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    txt_converted = _ffi.cast('const int *', txt)
...
def ever_ne_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_ne_text_ttext(txt: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    txt_converted = _ffi.cast('const int *', txt)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_ne_ttext_text(temp: Annotated[_ffi.CData, 'const Temporal *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    txt_converted = _ffi.cast('const int *', txt)
...
def teq_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def teq_text_ttext(txt: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    txt_converted = _ffi.cast('const int *', txt)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def teq_ttext_text(temp: Annotated[_ffi.CData, 'const Temporal *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    txt_converted = _ffi.cast('const int *', txt)
...
def tge_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tge_text_ttext(txt: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    txt_converted = _ffi.cast('const int *', txt)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tge_ttext_text(temp: Annotated[_ffi.CData, 'const Temporal *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    txt_converted = _ffi.cast('const int *', txt)
...
def tgt_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tgt_text_ttext(txt: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    txt_converted = _ffi.cast('const int *', txt)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tgt_ttext_text(temp: Annotated[_ffi.CData, 'const Temporal *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    txt_converted = _ffi.cast('const int *', txt)
...
def tle_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tle_text_ttext(txt: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    txt_converted = _ffi.cast('const int *', txt)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tle_ttext_text(temp: Annotated[_ffi.CData, 'const Temporal *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    txt_converted = _ffi.cast('const int *', txt)
...
def tlt_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tlt_text_ttext(txt: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    txt_converted = _ffi.cast('const int *', txt)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tlt_ttext_text(temp: Annotated[_ffi.CData, 'const Temporal *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    txt_converted = _ffi.cast('const int *', txt)
...
def tne_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tne_text_ttext(txt: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    txt_converted = _ffi.cast('const int *', txt)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tne_ttext_text(temp: Annotated[_ffi.CData, 'const Temporal *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    txt_converted = _ffi.cast('const int *', txt)
...
def adjacent_tbox_tnumber(box: Annotated[_ffi.CData, 'const TBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const TBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def adjacent_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def adjacent_temporal_tstzspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def adjacent_tnumber_numspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def adjacent_tnumber_tbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const TBox *', box)
...
def adjacent_tnumber_tnumber(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def adjacent_tstzspan_temporal(s: Annotated[_ffi.CData, 'const Span *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def contained_numspan_tnumber(s: Annotated[_ffi.CData, 'const Span *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def contained_tbox_tnumber(box: Annotated[_ffi.CData, 'const TBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const TBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def contained_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def contained_temporal_tstzspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def contained_tnumber_numspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def contained_tnumber_tbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const TBox *', box)
...
def contained_tnumber_tnumber(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def contained_tstzspan_temporal(s: Annotated[_ffi.CData, 'const Span *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def contains_numspan_tnumber(s: Annotated[_ffi.CData, 'const Span *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def contains_tbox_tnumber(box: Annotated[_ffi.CData, 'const TBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const TBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def contains_temporal_tstzspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def contains_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def contains_tnumber_numspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def contains_tnumber_tbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const TBox *', box)
...
def contains_tnumber_tnumber(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def contains_tstzspan_temporal(s: Annotated[_ffi.CData, 'const Span *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overlaps_numspan_tnumber(s: Annotated[_ffi.CData, 'const Span *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overlaps_tbox_tnumber(box: Annotated[_ffi.CData, 'const TBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const TBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overlaps_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overlaps_temporal_tstzspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def overlaps_tnumber_numspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def overlaps_tnumber_tbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const TBox *', box)
...
def overlaps_tnumber_tnumber(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overlaps_tstzspan_temporal(s: Annotated[_ffi.CData, 'const Span *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def same_numspan_tnumber(s: Annotated[_ffi.CData, 'const Span *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def same_tbox_tnumber(box: Annotated[_ffi.CData, 'const TBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const TBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def same_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def same_temporal_tstzspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def same_tnumber_numspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def same_tnumber_tbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const TBox *', box)
...
def same_tnumber_tnumber(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def same_tstzspan_temporal(s: Annotated[_ffi.CData, 'const Span *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def after_tbox_tnumber(box: Annotated[_ffi.CData, 'const TBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const TBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def after_temporal_tstzspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def after_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def after_tnumber_tbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const TBox *', box)
...
def after_tnumber_tnumber(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def after_tstzspan_temporal(s: Annotated[_ffi.CData, 'const Span *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def before_tbox_tnumber(box: Annotated[_ffi.CData, 'const TBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const TBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def before_temporal_tstzspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def before_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def before_tnumber_tbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const TBox *', box)
...
def before_tnumber_tnumber(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def before_tstzspan_temporal(s: Annotated[_ffi.CData, 'const Span *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def left_tbox_tnumber(box: Annotated[_ffi.CData, 'const TBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const TBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def left_numspan_tnumber(s: Annotated[_ffi.CData, 'const Span *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def left_tnumber_numspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def left_tnumber_tbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const TBox *', box)
...
def left_tnumber_tnumber(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overafter_tbox_tnumber(box: Annotated[_ffi.CData, 'const TBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const TBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overafter_temporal_tstzspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def overafter_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overafter_tnumber_tbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const TBox *', box)
...
def overafter_tnumber_tnumber(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overafter_tstzspan_temporal(s: Annotated[_ffi.CData, 'const Span *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overbefore_tbox_tnumber(box: Annotated[_ffi.CData, 'const TBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const TBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overbefore_temporal_tstzspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def overbefore_temporal_temporal(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overbefore_tnumber_tbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const TBox *', box)
...
def overbefore_tnumber_tnumber(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overbefore_tstzspan_temporal(s: Annotated[_ffi.CData, 'const Span *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overleft_numspan_tnumber(s: Annotated[_ffi.CData, 'const Span *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overleft_tbox_tnumber(box: Annotated[_ffi.CData, 'const TBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const TBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overleft_tnumber_numspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def overleft_tnumber_tbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const TBox *', box)
...
def overleft_tnumber_tnumber(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overright_numspan_tnumber(s: Annotated[_ffi.CData, 'const Span *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overright_tbox_tnumber(box: Annotated[_ffi.CData, 'const TBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const TBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overright_tnumber_numspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def overright_tnumber_tbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const TBox *', box)
...
def overright_tnumber_tnumber(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def right_numspan_tnumber(s: Annotated[_ffi.CData, 'const Span *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def right_tbox_tnumber(box: Annotated[_ffi.CData, 'const TBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const TBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def right_tnumber_numspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def right_tnumber_tbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const TBox *', box)
...
def right_tnumber_tnumber(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tand_tbool_tbool(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tor_tbool_tbool(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def add_float_tfloat(d: float, tnumber: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
...
def add_tfloat_float(tnumber: Annotated[_ffi.CData, 'const Temporal *'], d: float) -> Annotated[_ffi.CData, 'Temporal *']:
    tnumber_converted = _ffi.cast('const Temporal *', tnumber)
...
def add_tnumber_tnumber(tnumber1: Annotated[_ffi.CData, 'const Temporal *'], tnumber2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
...
def div_float_tfloat(d: float, tnumber: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    tnumber_converted = _ffi.cast('const Temporal *', tnumber)
...
def div_tfloat_float(tnumber: Annotated[_ffi.CData, 'const Temporal *'], d: float) -> Annotated[_ffi.CData, 'Temporal *']:
    tnumber_converted = _ffi.cast('const Temporal *', tnumber)
...
def div_tnumber_tnumber(tnumber1: Annotated[_ffi.CData, 'const Temporal *'], tnumber2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    tnumber1_converted = _ffi.cast('const Temporal *', tnumber1)
    tnumber2_converted = _ffi.cast('const Temporal *', tnumber2)
...
def mult_float_tfloat(d: float, tnumber: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    tnumber_converted = _ffi.cast('const Temporal *', tnumber)
...
def mult_tfloat_float(tnumber: Annotated[_ffi.CData, 'const Temporal *'], d: float) -> Annotated[_ffi.CData, 'Temporal *']:
    tnumber_converted = _ffi.cast('const Temporal *', tnumber)
...
def mult_tnumber_tnumber(tnumber1: Annotated[_ffi.CData, 'const Temporal *'], tnumber2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    tnumber1_converted = _ffi.cast('const Temporal *', tnumber1)
    tnumber2_converted = _ffi.cast('const Temporal *', tnumber2)
...
def sub_float_tfloat(d: float, tnumber: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    tnumber_converted = _ffi.cast('const Temporal *', tnumber)
...
def sub_tfloat_float(tnumber: Annotated[_ffi.CData, 'const Temporal *'], d: float) -> Annotated[_ffi.CData, 'Temporal *']:
    tnumber_converted = _ffi.cast('const Temporal *', tnumber)
...
def sub_tnumber_tnumber(tnumber1: Annotated[_ffi.CData, 'const Temporal *'], tnumber2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    tnumber1_converted = _ffi.cast('const Temporal *', tnumber1)
    tnumber2_converted = _ffi.cast('const Temporal *', tnumber2)
...
def tnumber_trend(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.tnumber_trend(temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def textcat_text_ttext(txt: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    txt_converted = _ffi.cast('const int *', txt)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def textcat_ttext_text(temp: Annotated[_ffi.CData, 'const Temporal *'], txt: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    txt_converted = _ffi.cast('const int *', txt)
...
def textcat_ttext_ttext(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tdistance_tfloat_float(temp: Annotated[_ffi.CData, 'const Temporal *'], d: float) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tdistance_tnumber_tnumber(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def nad_tboxfloat_tboxfloat(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[float, 'double']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def nad_tboxint_tboxint(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[int, 'int']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def nad_tfloat_tfloat(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[float, 'double']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def nad_tfloat_tbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[float, 'double']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const TBox *', box)
...
def nad_tint_tbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const TBox *', box)
...
def nad_tint_tint(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tbool_tand_transfn(state: Annotated[_ffi.CData, 'SkipList *'] | None, temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'SkipList *']:
...
def tbool_tor_transfn(state: Annotated[_ffi.CData, 'SkipList *'] | None, temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state) if state is not None else _ffi.NULL
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_extent_transfn(s: Annotated[_ffi.CData, 'Span *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Span *']:
...
def temporal_merge_transfn(state: Annotated[_ffi.CData, 'SkipList *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state)
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.temporal_merge_transfn(state_converted, temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def temporal_merge_combinefn(state1: Annotated[_ffi.CData, 'SkipList *'], state2: Annotated[_ffi.CData, 'SkipList *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state1_converted = _ffi.cast('SkipList *', state1)
    state2_converted = _ffi.cast('SkipList *', state2)
    result = _lib.temporal_merge_combinefn(state1_converted, state2_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def temporal_tcount_transfn(state: Annotated[_ffi.CData, 'SkipList *'] | None, temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state) if state is not None else _ffi.NULL
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tfloat_tmax_transfn(state: Annotated[_ffi.CData, 'SkipList *'] | None, temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state) if state is not None else _ffi.NULL
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tfloat_tmin_transfn(state: Annotated[_ffi.CData, 'SkipList *'] | None, temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state) if state is not None else _ffi.NULL
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tfloat_tsum_transfn(state: Annotated[_ffi.CData, 'SkipList *'] | None, temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state) if state is not None else _ffi.NULL
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tfloat_wmax_transfn(state: Annotated[_ffi.CData, 'SkipList *'], temp: Annotated[_ffi.CData, 'const Temporal *'], interv: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state)
    temp_converted = _ffi.cast('const Temporal *', temp)
    interv_converted = _ffi.cast('const int *', interv)
...
def tfloat_wmin_transfn(state: Annotated[_ffi.CData, 'SkipList *'], temp: Annotated[_ffi.CData, 'const Temporal *'], interv: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state)
    temp_converted = _ffi.cast('const Temporal *', temp)
    interv_converted = _ffi.cast('const int *', interv)
...
def tfloat_wsum_transfn(state: Annotated[_ffi.CData, 'SkipList *'], temp: Annotated[_ffi.CData, 'const Temporal *'], interv: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state)
    temp_converted = _ffi.cast('const Temporal *', temp)
    interv_converted = _ffi.cast('const int *', interv)
...
def timestamptz_tcount_transfn(state: Annotated[_ffi.CData, 'SkipList *'] | None, t: int) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state) if state is not None else _ffi.NULL
    result = _lib.timestamptz_tcount_transfn(state_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def tint_tmax_transfn(state: Annotated[_ffi.CData, 'SkipList *'] | None, temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state) if state is not None else _ffi.NULL
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tint_tmin_transfn(state: Annotated[_ffi.CData, 'SkipList *'] | None, temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state) if state is not None else _ffi.NULL
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tint_tsum_transfn(state: Annotated[_ffi.CData, 'SkipList *'] | None, temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state) if state is not None else _ffi.NULL
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tint_wmax_transfn(state: Annotated[_ffi.CData, 'SkipList *'], temp: Annotated[_ffi.CData, 'const Temporal *'], interv: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state)
    temp_converted = _ffi.cast('const Temporal *', temp)
    interv_converted = _ffi.cast('const int *', interv)
...
def tint_wmin_transfn(state: Annotated[_ffi.CData, 'SkipList *'], temp: Annotated[_ffi.CData, 'const Temporal *'], interv: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state)
    temp_converted = _ffi.cast('const Temporal *', temp)
    interv_converted = _ffi.cast('const int *', interv)
...
def tint_wsum_transfn(state: Annotated[_ffi.CData, 'SkipList *'], temp: Annotated[_ffi.CData, 'const Temporal *'], interv: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state)
    temp_converted = _ffi.cast('const Temporal *', temp)
    interv_converted = _ffi.cast('const int *', interv)
...
def tnumber_extent_transfn(box: Annotated[_ffi.CData, 'TBox *'] | None, temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'TBox *']:
...
def tnumber_tavg_transfn(state: Annotated[_ffi.CData, 'SkipList *'] | None, temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state) if state is not None else _ffi.NULL
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tnumber_wavg_transfn(state: Annotated[_ffi.CData, 'SkipList *'], temp: Annotated[_ffi.CData, 'const Temporal *'], interv: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state)
    temp_converted = _ffi.cast('const Temporal *', temp)
    interv_converted = _ffi.cast('const int *', interv)
...
def tstzset_tcount_transfn(state: Annotated[_ffi.CData, 'SkipList *'] | None, s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state) if state is not None else _ffi.NULL
    s_converted = _ffi.cast('const Set *', s)
...
def tstzspan_tcount_transfn(state: Annotated[_ffi.CData, 'SkipList *'] | None, s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state) if state is not None else _ffi.NULL
    s_converted = _ffi.cast('const Span *', s)
...
def tstzspanset_tcount_transfn(state: Annotated[_ffi.CData, 'SkipList *'] | None, ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state) if state is not None else _ffi.NULL
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def ttext_tmax_transfn(state: Annotated[_ffi.CData, 'SkipList *'] | None, temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state) if state is not None else _ffi.NULL
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ttext_tmin_transfn(state: Annotated[_ffi.CData, 'SkipList *'] | None, temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state) if state is not None else _ffi.NULL
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_simplify_dp(temp: Annotated[_ffi.CData, 'const Temporal *'], eps_dist: float, synchronized: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_simplify_max_dist(temp: Annotated[_ffi.CData, 'const Temporal *'], eps_dist: float, synchronized: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_simplify_min_dist(temp: Annotated[_ffi.CData, 'const Temporal *'], dist: float) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_simplify_min_tdelta(temp: Annotated[_ffi.CData, 'const Temporal *'], mint: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    mint_converted = _ffi.cast('const int *', mint)
    result = _lib.temporal_simplify_min_tdelta(temp_converted, mint_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def temporal_tprecision(temp: Annotated[_ffi.CData, 'const Temporal *'], duration: Annotated[_ffi.CData, 'const int *'], origin: int) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const int *', duration)
    result = _lib.temporal_tprecision(temp_converted, duration_converted, origin)
    _check_error()
    return result if result != _ffi.NULL else None


def temporal_tsample(temp: Annotated[_ffi.CData, 'const Temporal *'], duration: Annotated[_ffi.CData, 'const int *'], origin: int, interp: InterpolationType) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const int *', duration)
    result = _lib.temporal_tsample(temp_converted, duration_converted, origin, interp)
    _check_error()
    return result if result != _ffi.NULL else None


def temporal_dyntimewarp_distance(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[float, 'double']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def temporal_time_bins(temp: Annotated[_ffi.CData, 'const Temporal *'], duration: Annotated[_ffi.CData, 'const int *'], origin: int, count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'Span *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const int *', duration)
    count_converted = _ffi.cast('int *', count)
    result = _lib.temporal_time_bins(temp_converted, duration_converted, origin, count_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def temporal_time_split(temp: Annotated[_ffi.CData, 'const Temporal *'], duration: Annotated[_ffi.CData, 'const int *'], torigin: int) -> tuple[Annotated[_ffi.CData, 'Temporal **'], Annotated[list, 'int *'], Annotated[_ffi.CData, 'int']]:
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const int *', duration)
    time_bins = _ffi.new('int **')
    count = _ffi.new('int *')
    result = _lib.temporal_time_split(temp_converted, duration_converted, torigin, time_bins, count)
    _check_error()
    return result if result != _ffi.NULL else None, time_bins[0], count[0]


def tfloat_time_boxes(temp: Annotated[_ffi.CData, 'const Temporal *'], duration: Annotated[_ffi.CData, 'const int *'], torigin: int, count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'TBox *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const int *', duration)
    count_converted = _ffi.cast('int *', count)
    result = _lib.tfloat_time_boxes(temp_converted, duration_converted, torigin, count_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tfloat_value_time_boxes(temp: Annotated[_ffi.CData, 'const Temporal *'], vsize: float, duration: Annotated[_ffi.CData, 'const int *'], vorigin: float, torigin: int, count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'TBox *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const int *', duration)
    count_converted = _ffi.cast('int *', count)
    result = _lib.tfloat_value_time_boxes(temp_converted, vsize, duration_converted, vorigin, torigin, count_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tfloat_value_time_split(temp: Annotated[_ffi.CData, 'const Temporal *'], vsize: float, duration: Annotated[_ffi.CData, 'const int *'], vorigin: float, torigin: int) -> tuple[Annotated[_ffi.CData, 'Temporal **'], Annotated[list, 'double *'], Annotated[list, 'int *'], Annotated[_ffi.CData, 'int']]:
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const int *', duration)
    value_bins = _ffi.new('double **')
    time_bins = _ffi.new('int **')
    count = _ffi.new('int *')
    result = _lib.tfloat_value_time_split(temp_converted, vsize, duration_converted, vorigin, torigin, value_bins, time_bins, count)
    _check_error()
    return result if result != _ffi.NULL else None, value_bins[0], time_bins[0], count[0]


def tfloatbox_time_tiles(box: Annotated[_ffi.CData, 'const TBox *'], duration: Annotated[_ffi.CData, 'const int *'], torigin: int, count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'TBox *']:
    box_converted = _ffi.cast('const TBox *', box)
    duration_converted = _ffi.cast('const int *', duration)
    count_converted = _ffi.cast('int *', count)
    result = _lib.tfloatbox_time_tiles(box_converted, duration_converted, torigin, count_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tfloatbox_value_time_tiles(box: Annotated[_ffi.CData, 'const TBox *'], vsize: float, duration: Annotated[_ffi.CData, 'const int *'], vorigin: float, torigin: int | None) -> tuple[Annotated[_ffi.CData, 'TBox *'], Annotated[_ffi.CData, 'int']]:
    box_converted = _ffi.cast('const TBox *', box)
    duration_converted = _ffi.cast('const int *', duration)
    torigin_converted = torigin if torigin is not None else _ffi.NULL
    count = _ffi.new('int *')
    result = _lib.tfloatbox_value_time_tiles(box_converted, vsize, duration_converted, vorigin, torigin_converted, count)
    _check_error()
    return result if result != _ffi.NULL else None, count[0]


def tint_time_boxes(temp: Annotated[_ffi.CData, 'const Temporal *'], duration: Annotated[_ffi.CData, 'const int *'], torigin: int, count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'TBox *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const int *', duration)
    count_converted = _ffi.cast('int *', count)
    result = _lib.tint_time_boxes(temp_converted, duration_converted, torigin, count_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tint_value_time_boxes(temp: Annotated[_ffi.CData, 'const Temporal *'], vsize: int, duration: Annotated[_ffi.CData, 'const int *'], vorigin: int, torigin: int, count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'TBox *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const int *', duration)
    count_converted = _ffi.cast('int *', count)
    result = _lib.tint_value_time_boxes(temp_converted, vsize, duration_converted, vorigin, torigin, count_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tint_value_time_split(temp: Annotated[_ffi.CData, 'const Temporal *'], size: int, duration: Annotated[_ffi.CData, 'const int *'], vorigin: int, torigin: int) -> tuple[Annotated[_ffi.CData, 'Temporal **'], Annotated[list, 'int *'], Annotated[list, 'int *'], Annotated[_ffi.CData, 'int']]:
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const int *', duration)
    value_bins = _ffi.new('int **')
    time_bins = _ffi.new('int **')
    count = _ffi.new('int *')
    result = _lib.tint_value_time_split(temp_converted, size, duration_converted, vorigin, torigin, value_bins, time_bins, count)
    _check_error()
    return result if result != _ffi.NULL else None, value_bins[0], time_bins[0], count[0]


def tintbox_time_tiles(box: Annotated[_ffi.CData, 'const TBox *'], duration: Annotated[_ffi.CData, 'const int *'], torigin: int, count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'TBox *']:
    box_converted = _ffi.cast('const TBox *', box)
    duration_converted = _ffi.cast('const int *', duration)
    count_converted = _ffi.cast('int *', count)
    result = _lib.tintbox_time_tiles(box_converted, duration_converted, torigin, count_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tintbox_value_time_tiles(box: Annotated[_ffi.CData, 'const TBox *'], xsize: int, duration: Annotated[_ffi.CData, 'const int *'], xorigin: int | None, torigin: int | None) -> tuple[Annotated[_ffi.CData, 'TBox *'], Annotated[_ffi.CData, 'int']]:
    box_converted = _ffi.cast('const TBox *', box)
    duration_converted = _ffi.cast('const int *', duration)
    xorigin_converted = xorigin if xorigin is not None else _ffi.NULL
    torigin_converted = torigin if torigin is not None else _ffi.NULL
    count = _ffi.new('int *')
    result = _lib.tintbox_value_time_tiles(box_converted, xsize, duration_converted, xorigin_converted, torigin_converted, count)
    _check_error()
    return result if result != _ffi.NULL else None, count[0]
...
def temptype_supports_linear(type: Annotated[_ffi.CData, 'MeosType']) -> Annotated[bool, 'bool']:
    type_converted = _ffi.cast('MeosType', type)
    result = _lib.temptype_supports_linear(type_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def meostype_length(type: Annotated[_ffi.CData, 'MeosType']) -> Annotated[int, 'int16']:
    type_converted = _ffi.cast('MeosType', type)
    result = _lib.meostype_length(type_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def geo_as_ewkb(gs: Annotated[_ffi.CData, 'const int *'], endian: str, size: Annotated[_ffi.CData, 'size_t *']) -> Annotated[_ffi.CData, 'uint8_t *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def geo_as_ewkt(gs: Annotated[_ffi.CData, 'const int *'], precision: int) -> Annotated[str, 'char *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def geo_as_geojson(gs: Annotated[_ffi.CData, 'const int *'], option: int, precision: int, srs: str | None) -> Annotated[str, 'char *']:
    gs_converted = _ffi.cast('const int *', gs)
    srs_converted = srs.encode('utf-8') if srs is not None else _ffi.NULL
...
def geo_as_hexewkb(gs: Annotated[_ffi.CData, 'const int *'], endian: str) -> Annotated[str, 'char *']:
    gs_converted = _ffi.cast('const int *', gs)
    endian_converted = endian.encode('utf-8')
...
def geo_as_text(gs: Annotated[_ffi.CData, 'const int *'], precision: int) -> Annotated[str, 'char *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def geo_from_ewkb(wkb: Annotated[_ffi.CData, 'const uint8_t *'], wkb_size: Annotated[_ffi.CData, 'size_t'], srid: int) -> Annotated[_ffi.CData, 'int *']:
    wkb_converted = _ffi.cast('const uint8_t *', wkb)
    wkb_size_converted = _ffi.cast('size_t', wkb_size)
    result = _lib.geo_from_ewkb(wkb_converted, wkb_size_converted, srid)
    _check_error()
    return result if result != _ffi.NULL else None


def geo_from_geojson(geojson: str) -> Annotated[_ffi.CData, 'int *']:
...
def geo_from_text(wkt: str, srid: Annotated[_ffi.CData, 'int32_t']) -> Annotated[_ffi.CData, 'int *']:
...
def geo_out(gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[str, 'char *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def geog_from_binary(wkb_bytea: str) -> Annotated[_ffi.CData, 'int *']:
...
def geog_from_hexewkb(wkt: str) -> Annotated[_ffi.CData, 'int *']:
    wkt_converted = wkt.encode('utf-8')
...
def geog_in(string: str, typmod: int) -> Annotated[_ffi.CData, 'int *']:
    string_converted = string.encode('utf-8')
    result = _lib.geog_in(string_converted, typmod)
    _check_error()
    return result if result != _ffi.NULL else None


def geom_from_hexewkb(wkt: str) -> Annotated[_ffi.CData, 'int *']:
    wkt_converted = wkt.encode('utf-8')
...
def geom_in(string: str, typmod: int) -> Annotated[_ffi.CData, 'int *']:
    string_converted = string.encode('utf-8')
    result = _lib.geom_in(string_converted, typmod)
    _check_error()
    return result if result != _ffi.NULL else None


def box3d_make(xmin: float, xmax: float, ymin: float, ymax: float, zmin: float, zmax: float, srid: Annotated[_ffi.CData, 'int32_t']) -> Annotated[_ffi.CData, 'int *']:
    srid_converted = _ffi.cast('int32_t', srid)
    result = _lib.box3d_make(xmin, xmax, ymin, ymax, zmin, zmax, srid_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def box3d_out(box: Annotated[_ffi.CData, 'const int *'], maxdd: int) -> Annotated[str, 'char *']:
    box_converted = _ffi.cast('const int *', box)
    result = _lib.box3d_out(box_converted, maxdd)
    _check_error()
    result = _ffi.string(result).decode('utf-8')
    return result if result != _ffi.NULL else None


def gbox_make(hasz: bool, xmin: float, xmax: float, ymin: float, ymax: float, zmin: float, zmax: float) -> Annotated[_ffi.CData, 'int *']:
    result = _lib.gbox_make(hasz, xmin, xmax, ymin, ymax, zmin, zmax)
    _check_error()
    return result if result != _ffi.NULL else None


def gbox_out(box: Annotated[_ffi.CData, 'const int *'], maxdd: int) -> Annotated[str, 'char *']:
    box_converted = _ffi.cast('const int *', box)
    result = _lib.gbox_out(box_converted, maxdd)
    _check_error()
    result = _ffi.string(result).decode('utf-8')
    return result if result != _ffi.NULL else None


def geo_copy(g: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    g_converted = _ffi.cast('const int *', g)
    result = _lib.geo_copy(g_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def geogpoint_make2d(srid: Annotated[_ffi.CData, 'int32_t'], x: float, y: float) -> Annotated[_ffi.CData, 'int *']:
    srid_converted = _ffi.cast('int32_t', srid)
...
def geogpoint_make3dz(srid: Annotated[_ffi.CData, 'int32_t'], x: float, y: float, z: float) -> Annotated[_ffi.CData, 'int *']:
    srid_converted = _ffi.cast('int32_t', srid)
...
def geompoint_make2d(srid: Annotated[_ffi.CData, 'int32_t'], x: float, y: float) -> Annotated[_ffi.CData, 'int *']:
    srid_converted = _ffi.cast('int32_t', srid)
...
def geompoint_make3dz(srid: Annotated[_ffi.CData, 'int32_t'], x: float, y: float, z: float) -> Annotated[_ffi.CData, 'int *']:
    srid_converted = _ffi.cast('int32_t', srid)
...
def geom_to_geog(geom: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    geom_converted = _ffi.cast('const int *', geom)
    result = _lib.geom_to_geog(geom_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def geog_to_geom(geog: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    geog_converted = _ffi.cast('const int *', geog)
    result = _lib.geog_to_geom(geog_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def geo_is_empty(g: Annotated[_ffi.CData, 'const int *']) -> Annotated[bool, 'bool']:
    g_converted = _ffi.cast('const int *', g)
...
def geo_is_unitary(gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[bool, 'bool']:
    gs_converted = _ffi.cast('const int *', gs)
...
def geog_area(g: Annotated[_ffi.CData, 'const int *'], use_spheroid: bool) -> Annotated[float, 'double']:
    g_converted = _ffi.cast('const int *', g)
...
def geog_centroid(g: Annotated[_ffi.CData, 'const int *'], use_spheroid: bool) -> Annotated[_ffi.CData, 'int *']:
    g_converted = _ffi.cast('const int *', g)
...
def geog_length(g: Annotated[_ffi.CData, 'const int *'], use_spheroid: bool) -> Annotated[float, 'double']:
    g_converted = _ffi.cast('const int *', g)
...
def geog_perimeter(g: Annotated[_ffi.CData, 'const int *'], use_spheroid: bool) -> Annotated[float, 'double']:
    g_converted = _ffi.cast('const int *', g)
...
def geom_azimuth(gs1: Annotated[_ffi.CData, 'const int *'], gs2: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'double']:
    gs1_converted = _ffi.cast('const int *', gs1)
    gs2_converted = _ffi.cast('const int *', gs2)
    out_result = _ffi.new('double *')
...
def geom_length(gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[float, 'double']:
    gs_converted = _ffi.cast('const int *', gs)
...
def geom_perimeter(gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[float, 'double']:
    gs_converted = _ffi.cast('const int *', gs)
...
def line_numpoints(gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    gs_converted = _ffi.cast('const int *', gs)
...
def line_point_n(geom: Annotated[_ffi.CData, 'const int *'], n: int) -> Annotated[_ffi.CData, 'int *']:
    geom_converted = _ffi.cast('const int *', geom)
...
def geo_reverse(gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def geo_round(gs: Annotated[_ffi.CData, 'const int *'], maxdd: int) -> Annotated[_ffi.CData, 'int *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def geo_set_srid(gs: Annotated[_ffi.CData, 'const int *'], srid: Annotated[_ffi.CData, 'int32_t']) -> Annotated[_ffi.CData, 'int *']:
    gs_converted = _ffi.cast('const int *', gs)
    srid_converted = _ffi.cast('int32_t', srid)
...
def geo_srid(gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int32_t']:
    gs_converted = _ffi.cast('const int *', gs)
...
def geo_transform(geom: Annotated[_ffi.CData, 'const int *'], srid_to: Annotated[_ffi.CData, 'int32_t']) -> Annotated[_ffi.CData, 'int *']:
    geom_converted = _ffi.cast('const int *', geom)
...
def geo_transform_pipeline(gs: Annotated[_ffi.CData, 'const int *'], pipeline: str, srid_to: Annotated[_ffi.CData, 'int32_t'], is_forward: bool) -> Annotated[_ffi.CData, 'int *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def geo_collect_garray(gsarr: Annotated[list, 'int **'], count: int) -> Annotated[_ffi.CData, 'int *']:
    gsarr_converted = [_ffi.cast('int *', x) for x in gsarr]
    result = _lib.geo_collect_garray(gsarr_converted, count)
    _check_error()
    return result if result != _ffi.NULL else None


def geo_makeline_garray(gsarr: Annotated[list, 'int **'], count: int) -> Annotated[_ffi.CData, 'int *']:
    gsarr_converted = [_ffi.cast('int *', x) for x in gsarr]
...
def geo_num_points(gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.geo_num_points(gs_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def geo_num_geos(gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.geo_num_geos(gs_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def geo_geo_n(geom: Annotated[_ffi.CData, 'const int *'], n: int) -> Annotated[_ffi.CData, 'int *']:
    geom_converted = _ffi.cast('const int *', geom)
    result = _lib.geo_geo_n(geom_converted, n)
    _check_error()
    return result if result != _ffi.NULL else None


def geo_pointarr(gs: Annotated[_ffi.CData, 'const int *'], count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'int **']:
    gs_converted = _ffi.cast('const int *', gs)
    count_converted = _ffi.cast('int *', count)
...
def geo_points(gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def geom_array_union(gsarr: Annotated[list, 'int **'], count: int) -> Annotated[_ffi.CData, 'int *']:
    gsarr_converted = [_ffi.cast('int *', x) for x in gsarr]
...
def geom_boundary(gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def geom_buffer(gs: Annotated[_ffi.CData, 'const int *'], size: float, params: str) -> Annotated[_ffi.CData, 'int *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def geom_centroid(gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def geom_convex_hull(gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def geom_difference2d(gs1: Annotated[_ffi.CData, 'const int *'], gs2: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    gs1_converted = _ffi.cast('const int *', gs1)
    gs2_converted = _ffi.cast('const int *', gs2)
...
def geom_intersection2d(gs1: Annotated[_ffi.CData, 'const int *'], gs2: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    gs1_converted = _ffi.cast('const int *', gs1)
    gs2_converted = _ffi.cast('const int *', gs2)
...
def geom_intersection2d_coll(gs1: Annotated[_ffi.CData, 'const int *'], gs2: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    gs1_converted = _ffi.cast('const int *', gs1)
    gs2_converted = _ffi.cast('const int *', gs2)
...
def geom_min_bounding_radius(geom: Annotated[_ffi.CData, 'const int *'], radius: Annotated[_ffi.CData, 'double *']) -> Annotated[_ffi.CData, 'int *']:
    geom_converted = _ffi.cast('const int *', geom)
...
def geom_shortestline2d(gs1: Annotated[_ffi.CData, 'const int *'], s2: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    gs1_converted = _ffi.cast('const int *', gs1)
    s2_converted = _ffi.cast('const int *', s2)
    result = _lib.geom_shortestline2d(gs1_converted, s2_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def geom_shortestline3d(gs1: Annotated[_ffi.CData, 'const int *'], s2: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    gs1_converted = _ffi.cast('const int *', gs1)
    s2_converted = _ffi.cast('const int *', s2)
...
def geom_unary_union(gs: Annotated[_ffi.CData, 'const int *'], prec: float) -> Annotated[_ffi.CData, 'int *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def line_interpolate_point(gs: Annotated[_ffi.CData, 'const int *'], distance_fraction: float, repeat: bool) -> Annotated[_ffi.CData, 'int *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def line_locate_point(gs1: Annotated[_ffi.CData, 'const int *'], gs2: Annotated[_ffi.CData, 'const int *']) -> Annotated[float, 'double']:
    gs1_converted = _ffi.cast('const int *', gs1)
    gs2_converted = _ffi.cast('const int *', gs2)
...
def line_substring(gs: Annotated[_ffi.CData, 'const int *'], from_: float, to: float) -> Annotated[_ffi.CData, 'int *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def geog_dwithin(g1: Annotated[_ffi.CData, 'const int *'], g2: Annotated[_ffi.CData, 'const int *'], tolerance: float, use_spheroid: bool) -> Annotated[bool, 'bool']:
    g1_converted = _ffi.cast('const int *', g1)
    g2_converted = _ffi.cast('const int *', g2)
    result = _lib.geog_dwithin(g1_converted, g2_converted, tolerance, use_spheroid)
    _check_error()
    return result if result != _ffi.NULL else None


def geog_intersects(gs1: Annotated[_ffi.CData, 'const int *'], gs2: Annotated[_ffi.CData, 'const int *'], use_spheroid: bool) -> Annotated[bool, 'bool']:
    gs1_converted = _ffi.cast('const int *', gs1)
    gs2_converted = _ffi.cast('const int *', gs2)
...
def geom_contains(gs1: Annotated[_ffi.CData, 'const int *'], gs2: Annotated[_ffi.CData, 'const int *']) -> Annotated[bool, 'bool']:
    gs1_converted = _ffi.cast('const int *', gs1)
    gs2_converted = _ffi.cast('const int *', gs2)
...
def geom_covers(gs1: Annotated[_ffi.CData, 'const int *'], gs2: Annotated[_ffi.CData, 'const int *']) -> Annotated[bool, 'bool']:
    gs1_converted = _ffi.cast('const int *', gs1)
    gs2_converted = _ffi.cast('const int *', gs2)
...
def geom_disjoint2d(gs1: Annotated[_ffi.CData, 'const int *'], gs2: Annotated[_ffi.CData, 'const int *']) -> Annotated[bool, 'bool']:
    gs1_converted = _ffi.cast('const int *', gs1)
    gs2_converted = _ffi.cast('const int *', gs2)
...
def geom_dwithin2d(gs1: Annotated[_ffi.CData, 'const int *'], gs2: Annotated[_ffi.CData, 'const int *'], tolerance: float) -> Annotated[bool, 'bool']:
    gs1_converted = _ffi.cast('const int *', gs1)
    gs2_converted = _ffi.cast('const int *', gs2)
...
def geom_dwithin3d(gs1: Annotated[_ffi.CData, 'const int *'], gs2: Annotated[_ffi.CData, 'const int *'], tolerance: float) -> Annotated[bool, 'bool']:
    gs1_converted = _ffi.cast('const int *', gs1)
    gs2_converted = _ffi.cast('const int *', gs2)
...
def geom_intersects2d(gs1: Annotated[_ffi.CData, 'const int *'], gs2: Annotated[_ffi.CData, 'const int *']) -> Annotated[bool, 'bool']:
    gs1_converted = _ffi.cast('const int *', gs1)
    gs2_converted = _ffi.cast('const int *', gs2)
...
def geom_intersects3d(gs1: Annotated[_ffi.CData, 'const int *'], gs2: Annotated[_ffi.CData, 'const int *']) -> Annotated[bool, 'bool']:
    gs1_converted = _ffi.cast('const int *', gs1)
    gs2_converted = _ffi.cast('const int *', gs2)
...
def geom_relate_pattern(gs1: Annotated[_ffi.CData, 'const int *'], gs2: Annotated[_ffi.CData, 'const int *'], patt: str) -> Annotated[bool, 'bool']:
    gs1_converted = _ffi.cast('const int *', gs1)
    gs2_converted = _ffi.cast('const int *', gs2)
...
def geom_touches(gs1: Annotated[_ffi.CData, 'const int *'], gs2: Annotated[_ffi.CData, 'const int *']) -> Annotated[bool, 'bool']:
    gs1_converted = _ffi.cast('const int *', gs1)
    gs2_converted = _ffi.cast('const int *', gs2)
...
def geo_stboxes(gs: Annotated[_ffi.CData, 'const int *'], count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'STBox *']:
    gs_converted = _ffi.cast('const int *', gs)
    count_converted = _ffi.cast('int *', count)
...
def geo_split_each_n_stboxes(gs: Annotated[_ffi.CData, 'const int *'], elem_count: int, count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'STBox *']:
    gs_converted = _ffi.cast('const int *', gs)
    count_converted = _ffi.cast('int *', count)
...
def geo_split_n_stboxes(gs: Annotated[_ffi.CData, 'const int *'], box_count: int, count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'STBox *']:
    gs_converted = _ffi.cast('const int *', gs)
    count_converted = _ffi.cast('int *', count)
...
def geog_distance(g1: Annotated[_ffi.CData, 'const int *'], g2: Annotated[_ffi.CData, 'const int *']) -> Annotated[float, 'double']:
    g1_converted = _ffi.cast('const int *', g1)
    g2_converted = _ffi.cast('const int *', g2)
...
def geom_distance2d(gs1: Annotated[_ffi.CData, 'const int *'], gs2: Annotated[_ffi.CData, 'const int *']) -> Annotated[float, 'double']:
    gs1_converted = _ffi.cast('const int *', gs1)
    gs2_converted = _ffi.cast('const int *', gs2)
...
def geom_distance3d(gs1: Annotated[_ffi.CData, 'const int *'], gs2: Annotated[_ffi.CData, 'const int *']) -> Annotated[float, 'double']:
    gs1_converted = _ffi.cast('const int *', gs1)
    gs2_converted = _ffi.cast('const int *', gs2)
...
def geo_equals(gs1: Annotated[_ffi.CData, 'const int *'], gs2: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    gs1_converted = _ffi.cast('const int *', gs1)
    gs2_converted = _ffi.cast('const int *', gs2)
...
def geo_same(gs1: Annotated[_ffi.CData, 'const int *'], gs2: Annotated[_ffi.CData, 'const int *']) -> Annotated[bool, 'bool']:
    gs1_converted = _ffi.cast('const int *', gs1)
    gs2_converted = _ffi.cast('const int *', gs2)
...
def geoset_make(values: Annotated[list, 'int **']) -> Annotated[_ffi.CData, 'Set *']:
    values_converted = [_ffi.cast('int *', x) for x in values]
...
def geo_to_set(gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Set *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def geoset_end_value(s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'int *']:
    s_converted = _ffi.cast('const Set *', s)
...
def geoset_start_value(s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'int *']:
    s_converted = _ffi.cast('const Set *', s)
...
def geoset_value_n(s: Annotated[_ffi.CData, 'const Set *'], n: int) -> Annotated[list, 'int *']:
    s_converted = _ffi.cast('const Set *', s)
    out_result = _ffi.new('int **')
...
def geoset_values(s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'int **']:
    s_converted = _ffi.cast('const Set *', s)
...
def contained_geo_set(gs: Annotated[_ffi.CData, 'const int *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    gs_converted = _ffi.cast('const int *', gs)
    s_converted = _ffi.cast('const Set *', s)
...
def contains_set_geo(s: Annotated[_ffi.CData, 'const Set *'], gs: Annotated[_ffi.CData, 'int *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    gs_converted = _ffi.cast('int *', gs)
    result = _lib.contains_set_geo(s_converted, gs_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def geo_union_transfn(state: Annotated[_ffi.CData, 'Set *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Set *']:
    state_converted = _ffi.cast('Set *', state)
    gs_converted = _ffi.cast('const int *', gs)
...
def intersection_geo_set(gs: Annotated[_ffi.CData, 'const int *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    gs_converted = _ffi.cast('const int *', gs)
    s_converted = _ffi.cast('const Set *', s)
...
def intersection_set_geo(s: Annotated[_ffi.CData, 'const Set *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    gs_converted = _ffi.cast('const int *', gs)
...
def minus_geo_set(gs: Annotated[_ffi.CData, 'const int *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    gs_converted = _ffi.cast('const int *', gs)
    s_converted = _ffi.cast('const Set *', s)
...
def minus_set_geo(s: Annotated[_ffi.CData, 'const Set *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    gs_converted = _ffi.cast('const int *', gs)
...
def union_geo_set(gs: Annotated[_ffi.CData, 'const int *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    gs_converted = _ffi.cast('const int *', gs)
    s_converted = _ffi.cast('const Set *', s)
...
def union_set_geo(s: Annotated[_ffi.CData, 'const Set *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    gs_converted = _ffi.cast('const int *', gs)
...
def spatialset_set_srid(s: Annotated[_ffi.CData, 'const Set *'], srid: Annotated[_ffi.CData, 'int32_t']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    srid_converted = _ffi.cast('int32_t', srid)
...
def spatialset_transform(s: Annotated[_ffi.CData, 'const Set *'], srid: Annotated[_ffi.CData, 'int32_t']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    srid_converted = _ffi.cast('int32_t', srid)
...
def spatialset_transform_pipeline(s: Annotated[_ffi.CData, 'const Set *'], pipelinestr: str, srid: Annotated[_ffi.CData, 'int32_t'], is_forward: bool) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
...
def stbox_as_hexwkb(box: Annotated[_ffi.CData, 'const STBox *'], variant: int) -> tuple[Annotated[str, 'char *'], Annotated[_ffi.CData, 'size_t *']]:
...
def stbox_as_wkb(box: Annotated[_ffi.CData, 'const STBox *'], variant: int) -> tuple[Annotated[_ffi.CData, 'uint8_t *'], Annotated[_ffi.CData, 'size_t *']]:
    box_converted = _ffi.cast('const STBox *', box)
    variant_converted = _ffi.cast('uint8_t', variant)
    size_out = _ffi.new('size_t *')
...
def geo_timestamptz_to_stbox(gs: Annotated[_ffi.CData, 'const int *'], t: int) -> Annotated[_ffi.CData, 'STBox *']:
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.geo_timestamptz_to_stbox(gs_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def geo_tstzspan_to_stbox(gs: Annotated[_ffi.CData, 'const int *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'STBox *']:
    gs_converted = _ffi.cast('const int *', gs)
    s_converted = _ffi.cast('const Span *', s)
...
def stbox_make(hasx: bool, hasz: bool, geodetic: bool, srid: int, xmin: float, xmax: float, ymin: float, ymax: float, zmin: float, zmax: float, s: Annotated[_ffi.CData, 'const Span *'] | None) -> Annotated[_ffi.CData, 'STBox *']:
    s_converted = _ffi.cast('const Span *', s) if s is not None else _ffi.NULL
    result = _lib.stbox_make(hasx, hasz, geodetic, srid, xmin, xmax, ymin, ymax, zmin, zmax, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def geo_to_stbox(gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'STBox *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def stbox_to_box3d(box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[_ffi.CData, 'int *']:
    box_converted = _ffi.cast('const STBox *', box)
...
def stbox_to_gbox(box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[_ffi.CData, 'int *']:
    box_converted = _ffi.cast('const STBox *', box)
...
def stbox_to_geo(box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[_ffi.CData, 'int *']:
    box_converted = _ffi.cast('const STBox *', box)
...
def timestamptz_to_stbox(t: int) -> Annotated[_ffi.CData, 'STBox *']:
    result = _lib.timestamptz_to_stbox(t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def stbox_hash(box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[int, 'int']:
    box_converted = _ffi.cast('const STBox *', box)
    result = _lib.stbox_hash(box_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def stbox_hash_extended(box: Annotated[_ffi.CData, 'const STBox *'], seed: int) -> Annotated[int, 'int']:
    box_converted = _ffi.cast('const STBox *', box)
    result = _lib.stbox_hash_extended(box_converted, seed)
    _check_error()
    return result if result != _ffi.NULL else None
...
def stbox_tmax(box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[_ffi.CData, 'int']:
    box_converted = _ffi.cast('const STBox *', box)
    out_result = _ffi.new('int *')
...
def stbox_tmin(box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[_ffi.CData, 'int']:
    box_converted = _ffi.cast('const STBox *', box)
    out_result = _ffi.new('int *')
...
def stbox_expand_time(box: Annotated[_ffi.CData, 'const STBox *'], interv: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'STBox *']:
    box_converted = _ffi.cast('const STBox *', box)
    interv_converted = _ffi.cast('const int *', interv)
...
def stbox_quad_split(box: Annotated[_ffi.CData, 'const STBox *'], count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'STBox *']:
    box_converted = _ffi.cast('const STBox *', box)
    count_converted = _ffi.cast('int *', count)
...
def stbox_shift_scale_time(box: Annotated[_ffi.CData, 'const STBox *'], shift: Annotated[_ffi.CData, 'const int *'] | None, duration: Annotated[_ffi.CData, 'const int *'] | None) -> Annotated[_ffi.CData, 'STBox *']:
    box_converted = _ffi.cast('const STBox *', box)
    shift_converted = _ffi.cast('const int *', shift) if shift is not None else _ffi.NULL
    duration_converted = _ffi.cast('const int *', duration) if duration is not None else _ffi.NULL
...
def stboxarr_round(boxarr: Annotated[_ffi.CData, 'const STBox *'], count: int, maxdd: int) -> Annotated[_ffi.CData, 'STBox *']:
...
def stbox_set_srid(box: Annotated[_ffi.CData, 'const STBox *'], srid: Annotated[_ffi.CData, 'int32_t']) -> Annotated[_ffi.CData, 'STBox *']:
    box_converted = _ffi.cast('const STBox *', box)
    srid_converted = _ffi.cast('int32_t', srid)
...
def stbox_transform(box: Annotated[_ffi.CData, 'const STBox *'], srid: Annotated[_ffi.CData, 'int32_t']) -> Annotated[_ffi.CData, 'STBox *']:
    box_converted = _ffi.cast('const STBox *', box)
    srid_converted = _ffi.cast('int32_t', srid)
...
def stbox_transform_pipeline(box: Annotated[_ffi.CData, 'const STBox *'], pipelinestr: str, srid: Annotated[_ffi.CData, 'int32_t'], is_forward: bool) -> Annotated[_ffi.CData, 'STBox *']:
    box_converted = _ffi.cast('const STBox *', box)
    pipelinestr_converted = pipelinestr.encode('utf-8')
    srid_converted = _ffi.cast('int32_t', srid)
...
def adjacent_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
...
def contained_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def contains_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def overlaps_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def same_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def above_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def after_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def back_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def before_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def below_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def front_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def left_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def overabove_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def overafter_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def overback_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def overbefore_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def overbelow_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def overfront_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def overleft_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def overright_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def right_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def union_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *'], strict: bool) -> Annotated[_ffi.CData, 'STBox *']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def intersection_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[_ffi.CData, 'STBox *']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def stbox_cmp(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[int, 'int']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def stbox_eq(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def stbox_ge(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def stbox_gt(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def stbox_le(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def stbox_lt(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def stbox_ne(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def tspatial_out(temp: Annotated[_ffi.CData, 'const Temporal *'], maxdd: int) -> Annotated[str, 'char *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.tspatial_out(temp_converted, maxdd)
    _check_error()
    result = _ffi.string(result).decode('utf-8')
    return result if result != _ffi.NULL else None


def tgeo_from_base_temp(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tgeoinst_make(gs: Annotated[_ffi.CData, 'const int *'], t: int) -> Annotated[_ffi.CData, 'TInstant *']:
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.tgeoinst_make(gs_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def tgeoseq_from_base_tstzset(gs: Annotated[_ffi.CData, 'const int *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'TSequence *']:
    gs_converted = _ffi.cast('const int *', gs)
    s_converted = _ffi.cast('const Set *', s)
...
def tgeoseq_from_base_tstzspan(gs: Annotated[_ffi.CData, 'const int *'], s: Annotated[_ffi.CData, 'const Span *'], interp: InterpolationType) -> Annotated[_ffi.CData, 'TSequence *']:
    gs_converted = _ffi.cast('const int *', gs)
    s_converted = _ffi.cast('const Span *', s)
...
def tgeoseqset_from_base_tstzspanset(gs: Annotated[_ffi.CData, 'const int *'], ss: Annotated[_ffi.CData, 'const SpanSet *'], interp: InterpolationType) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    gs_converted = _ffi.cast('const int *', gs)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tpoint_from_base_temp(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tpointinst_make(gs: Annotated[_ffi.CData, 'const int *'], t: int) -> Annotated[_ffi.CData, 'TInstant *']:
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.tpointinst_make(gs_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def tpointseq_from_base_tstzset(gs: Annotated[_ffi.CData, 'const int *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'TSequence *']:
    gs_converted = _ffi.cast('const int *', gs)
    s_converted = _ffi.cast('const Set *', s)
...
def tpointseq_from_base_tstzspan(gs: Annotated[_ffi.CData, 'const int *'], s: Annotated[_ffi.CData, 'const Span *'], interp: InterpolationType) -> Annotated[_ffi.CData, 'TSequence *']:
    gs_converted = _ffi.cast('const int *', gs)
    s_converted = _ffi.cast('const Span *', s)
...
def tpointseq_make_coords(xcoords: Annotated[_ffi.CData, 'const double *'], ycoords: Annotated[_ffi.CData, 'const double *'], zcoords: Annotated[_ffi.CData, 'const double *'], times: Annotated[_ffi.CData, 'const int *'], count: int, srid: int, geodetic: bool, lower_inc: bool, upper_inc: bool, interp: InterpolationType, normalize: bool) -> Annotated[_ffi.CData, 'TSequence *']:
    ...
    times_converted = _ffi.cast('const int *', times)
    result = _lib.tpointseq_make_coords(xcoords_converted, ycoords_converted, zcoords_converted, times_converted, count, srid, geodetic, lower_inc, upper_inc, interp, normalize)
    _check_error()
    return result if result != _ffi.NULL else None


def tpointseqset_from_base_tstzspanset(gs: Annotated[_ffi.CData, 'const int *'], ss: Annotated[_ffi.CData, 'const SpanSet *'], interp: InterpolationType) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    gs_converted = _ffi.cast('const int *', gs)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def box3d_to_stbox(box: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'STBox *']:
    box_converted = _ffi.cast('const int *', box)
...
def gbox_to_stbox(box: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'STBox *']:
    box_converted = _ffi.cast('const int *', box)
...
def geomeas_to_tpoint(gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def tpoint_as_mvtgeom(temp: Annotated[_ffi.CData, 'const Temporal *'], bounds: Annotated[_ffi.CData, 'const STBox *'], extent: Annotated[_ffi.CData, 'int32_t'], buffer: Annotated[_ffi.CData, 'int32_t'], clip_geom: bool, count: Annotated[_ffi.CData, 'int *']) -> tuple[Annotated[bool, 'bool'], Annotated[list, 'int *'], Annotated[list, 'int *']]:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tpoint_tfloat_to_geomeas(tpoint: Annotated[_ffi.CData, 'const Temporal *'], measure: Annotated[_ffi.CData, 'const Temporal *'], segmentize: bool) -> Annotated[list, 'int *']:
...
def bearing_point_point(gs1: Annotated[_ffi.CData, 'const int *'], gs2: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'double']:
    gs1_converted = _ffi.cast('const int *', gs1)
    gs2_converted = _ffi.cast('const int *', gs2)
    out_result = _ffi.new('double *')
...
def bearing_tpoint_point(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *'], invert: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def bearing_tpoint_tpoint(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tgeo_convex_hull(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tgeo_end_value(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tgeo_start_value(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tgeo_traversed_area(temp: Annotated[_ffi.CData, 'const Temporal *'], unary_union: bool) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tgeo_value_at_timestamptz(temp: Annotated[_ffi.CData, 'const Temporal *'], t: int, strict: bool) -> Annotated[list, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    out_result = _ffi.new('int **')
    result = _lib.tgeo_value_at_timestamptz(temp_converted, t, strict, out_result)
    _check_error()
    if result:
        return out_result[0] if out_result[0] != _ffi.NULL else None
    return None
...
def tgeo_value_n(temp: Annotated[_ffi.CData, 'const Temporal *'], n: int) -> Annotated[list, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    out_result = _ffi.new('int **')
...
def tgeo_values(temp: Annotated[_ffi.CData, 'const Temporal *'], count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'int **']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    count_converted = _ffi.cast('int *', count)
...
def tpoint_trajectory(temp: Annotated[_ffi.CData, 'const Temporal *'], unary_union: bool) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tpoint_twcentroid(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tgeo_affine(temp: Annotated[_ffi.CData, 'const Temporal *'], a: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    a_converted = _ffi.cast('const int *', a)
    result = _lib.tgeo_affine(temp_converted, a_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tgeo_scale(temp: Annotated[_ffi.CData, 'const Temporal *'], scale: Annotated[_ffi.CData, 'const int *'], sorigin: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    scale_converted = _ffi.cast('const int *', scale)
    sorigin_converted = _ffi.cast('const int *', sorigin)
...
def tspatial_set_srid(temp: Annotated[_ffi.CData, 'const Temporal *'], srid: Annotated[_ffi.CData, 'int32_t']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    srid_converted = _ffi.cast('int32_t', srid)
...
def tspatial_transform(temp: Annotated[_ffi.CData, 'const Temporal *'], srid: Annotated[_ffi.CData, 'int32_t']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    srid_converted = _ffi.cast('int32_t', srid)
...
def tspatial_transform_pipeline(temp: Annotated[_ffi.CData, 'const Temporal *'], pipelinestr: str, srid: Annotated[_ffi.CData, 'int32_t'], is_forward: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    pipelinestr_converted = pipelinestr.encode('utf-8')
    srid_converted = _ffi.cast('int32_t', srid)
...
def tgeo_at_geom(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def tgeo_at_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *'], border_inc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def tgeo_at_value(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('int *', gs)
...
def tgeo_minus_geom(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def tgeo_minus_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *'], border_inc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def tgeo_minus_value(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('int *', gs)
...
def tpoint_at_elevation(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.tpoint_at_elevation(temp_converted, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tpoint_at_geom(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.tpoint_at_geom(temp_converted, gs_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tpoint_at_value(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('int *', gs)
...
def tpoint_minus_elevation(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.tpoint_minus_elevation(temp_converted, s_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tpoint_minus_geom(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.tpoint_minus_geom(temp_converted, gs_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tpoint_minus_value(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('int *', gs)
...
def always_eq_geo_tgeo(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_eq_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def always_eq_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_ne_geo_tgeo(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_ne_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def always_ne_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_eq_geo_tgeo(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_eq_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def ever_eq_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_ne_geo_tgeo(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_ne_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def ever_ne_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def teq_geo_tgeo(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def teq_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def tne_geo_tgeo(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tne_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def tgeo_space_boxes(temp: Annotated[_ffi.CData, 'const Temporal *'], xsize: float, ysize: float, zsize: float, sorigin: Annotated[_ffi.CData, 'const int *'], bitmatrix: bool, border_inc: bool, count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'STBox *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    sorigin_converted = _ffi.cast('const int *', sorigin)
    count_converted = _ffi.cast('int *', count)
...
def tgeo_space_time_boxes(temp: Annotated[_ffi.CData, 'const Temporal *'], xsize: float, ysize: float, zsize: float, duration: Annotated[_ffi.CData, 'const int *'], sorigin: Annotated[_ffi.CData, 'const int *'], torigin: int, bitmatrix: bool, border_inc: bool, count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'STBox *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const int *', duration)
    sorigin_converted = _ffi.cast('const int *', sorigin)
    count_converted = _ffi.cast('int *', count)
    result = _lib.tgeo_space_time_boxes(temp_converted, xsize, ysize, zsize, duration_converted, sorigin_converted, torigin, bitmatrix, border_inc, count_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def adjacent_tspatial_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def adjacent_tspatial_tspatial(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def contained_stbox_tspatial(box: Annotated[_ffi.CData, 'const STBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def contained_tspatial_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def contained_tspatial_tspatial(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def contains_stbox_tspatial(box: Annotated[_ffi.CData, 'const STBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def contains_tspatial_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def contains_tspatial_tspatial(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overlaps_stbox_tspatial(box: Annotated[_ffi.CData, 'const STBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overlaps_tspatial_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def overlaps_tspatial_tspatial(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def same_stbox_tspatial(box: Annotated[_ffi.CData, 'const STBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def same_tspatial_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def same_tspatial_tspatial(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def above_stbox_tspatial(box: Annotated[_ffi.CData, 'const STBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def above_tspatial_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def above_tspatial_tspatial(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def after_stbox_tspatial(box: Annotated[_ffi.CData, 'const STBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def after_tspatial_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def after_tspatial_tspatial(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def back_stbox_tspatial(box: Annotated[_ffi.CData, 'const STBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def back_tspatial_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def back_tspatial_tspatial(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def before_stbox_tspatial(box: Annotated[_ffi.CData, 'const STBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def before_tspatial_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def before_tspatial_tspatial(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def below_stbox_tspatial(box: Annotated[_ffi.CData, 'const STBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def below_tspatial_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def below_tspatial_tspatial(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def front_stbox_tspatial(box: Annotated[_ffi.CData, 'const STBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def front_tspatial_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def front_tspatial_tspatial(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def left_stbox_tspatial(box: Annotated[_ffi.CData, 'const STBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def left_tspatial_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def left_tspatial_tspatial(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overabove_stbox_tspatial(box: Annotated[_ffi.CData, 'const STBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overabove_tspatial_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def overabove_tspatial_tspatial(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overafter_stbox_tspatial(box: Annotated[_ffi.CData, 'const STBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overafter_tspatial_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def overafter_tspatial_tspatial(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overback_stbox_tspatial(box: Annotated[_ffi.CData, 'const STBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overback_tspatial_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def overback_tspatial_tspatial(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overbefore_stbox_tspatial(box: Annotated[_ffi.CData, 'const STBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overbefore_tspatial_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def overbefore_tspatial_tspatial(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overbelow_stbox_tspatial(box: Annotated[_ffi.CData, 'const STBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overbelow_tspatial_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def overbelow_tspatial_tspatial(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overfront_stbox_tspatial(box: Annotated[_ffi.CData, 'const STBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overfront_tspatial_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def overfront_tspatial_tspatial(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overleft_stbox_tspatial(box: Annotated[_ffi.CData, 'const STBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overleft_tspatial_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def overleft_tspatial_tspatial(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overright_stbox_tspatial(box: Annotated[_ffi.CData, 'const STBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overright_tspatial_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def overright_tspatial_tspatial(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def right_stbox_tspatial(box: Annotated[_ffi.CData, 'const STBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def right_tspatial_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def right_tspatial_tspatial(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[bool, 'bool']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def acontains_geo_tgeo(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def acontains_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def acontains_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def adisjoint_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def adisjoint_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def adwithin_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *'], dist: float) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def adwithin_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *'], dist: float) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def aintersects_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def aintersects_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def atouches_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def atouches_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def atouches_tpoint_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def econtains_geo_tgeo(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def econtains_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def econtains_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ecovers_geo_tgeo(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ecovers_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def ecovers_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def edisjoint_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def edisjoint_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def edwithin_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *'], dist: float) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def edwithin_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *'], dist: float) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def eintersects_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def eintersects_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def etouches_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def etouches_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def etouches_tpoint_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def tcontains_geo_tgeo(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.tcontains_geo_tgeo(gs_converted, temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tcontains_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.tcontains_tgeo_geo(temp_converted, gs_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tcontains_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
    result = _lib.tcontains_tgeo_tgeo(temp1_converted, temp2_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tcovers_geo_tgeo(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.tcovers_geo_tgeo(gs_converted, temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tcovers_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.tcovers_tgeo_geo(temp_converted, gs_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tcovers_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
    result = _lib.tcovers_tgeo_tgeo(temp1_converted, temp2_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tdisjoint_geo_tgeo(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.tdisjoint_geo_tgeo(gs_converted, temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tdisjoint_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.tdisjoint_tgeo_geo(temp_converted, gs_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tdisjoint_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
    result = _lib.tdisjoint_tgeo_tgeo(temp1_converted, temp2_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tdwithin_geo_tgeo(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *'], dist: float) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.tdwithin_geo_tgeo(gs_converted, temp_converted, dist)
    _check_error()
    return result if result != _ffi.NULL else None


def tdwithin_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *'], dist: float) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.tdwithin_tgeo_geo(temp_converted, gs_converted, dist)
    _check_error()
    return result if result != _ffi.NULL else None


def tdwithin_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *'], dist: float) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
    result = _lib.tdwithin_tgeo_tgeo(temp1_converted, temp2_converted, dist)
    _check_error()
    return result if result != _ffi.NULL else None


def tintersects_geo_tgeo(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.tintersects_geo_tgeo(gs_converted, temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tintersects_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.tintersects_tgeo_geo(temp_converted, gs_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tintersects_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
    result = _lib.tintersects_tgeo_tgeo(temp1_converted, temp2_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def ttouches_geo_tgeo(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.ttouches_geo_tgeo(gs_converted, temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def ttouches_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.ttouches_tgeo_geo(temp_converted, gs_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def ttouches_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
    result = _lib.ttouches_tgeo_tgeo(temp1_converted, temp2_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tdistance_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def tdistance_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def nad_stbox_geo(box: Annotated[_ffi.CData, 'const STBox *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[float, 'double']:
    box_converted = _ffi.cast('const STBox *', box)
    gs_converted = _ffi.cast('const int *', gs)
...
def nad_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[float, 'double']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
...
def nad_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[float, 'double']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def nad_tgeo_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[float, 'double']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def nad_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[float, 'double']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def nai_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'TInstant *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def nai_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'TInstant *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def shortestline_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def shortestline_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'int *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tpoint_tcentroid_transfn(state: Annotated[_ffi.CData, 'SkipList *'], temp: Annotated[_ffi.CData, 'Temporal *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state)
    temp_converted = _ffi.cast('Temporal *', temp)
...
def tspatial_extent_transfn(box: Annotated[_ffi.CData, 'STBox *'] | None, temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'STBox *']:
...
def stbox_get_space_tile(point: Annotated[_ffi.CData, 'const int *'], xsize: float, ysize: float, zsize: float, sorigin: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'STBox *']:
    point_converted = _ffi.cast('const int *', point)
    sorigin_converted = _ffi.cast('const int *', sorigin)
...
def stbox_get_space_time_tile(point: Annotated[_ffi.CData, 'const int *'], t: int, xsize: float, ysize: float, zsize: float, duration: Annotated[_ffi.CData, 'const int *'], sorigin: Annotated[_ffi.CData, 'const int *'], torigin: int) -> Annotated[_ffi.CData, 'STBox *']:
    point_converted = _ffi.cast('const int *', point)
    duration_converted = _ffi.cast('const int *', duration)
    sorigin_converted = _ffi.cast('const int *', sorigin)
    result = _lib.stbox_get_space_time_tile(point_converted, t, xsize, ysize, zsize, duration_converted, sorigin_converted, torigin)
    _check_error()
    return result if result != _ffi.NULL else None


def stbox_get_time_tile(t: int, duration: Annotated[_ffi.CData, 'const int *'], torigin: int) -> Annotated[_ffi.CData, 'STBox *']:
    duration_converted = _ffi.cast('const int *', duration)
    result = _lib.stbox_get_time_tile(t, duration_converted, torigin)
    _check_error()
    return result if result != _ffi.NULL else None


def stbox_space_tiles(bounds: Annotated[_ffi.CData, 'const STBox *'], xsize: float, ysize: float, zsize: float, sorigin: Annotated[_ffi.CData, 'const int *'], border_inc: bool, count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'STBox *']:
    bounds_converted = _ffi.cast('const STBox *', bounds)
    sorigin_converted = _ffi.cast('const int *', sorigin)
    count_converted = _ffi.cast('int *', count)
...
def stbox_space_time_tiles(bounds: Annotated[_ffi.CData, 'const STBox *'], xsize: float, ysize: float, zsize: float, duration: Annotated[_ffi.CData, 'const int *'] | None, sorigin: Annotated[_ffi.CData, 'const int *'], torigin: int, border_inc: bool) -> tuple[Annotated[_ffi.CData, 'STBox *'], Annotated[_ffi.CData, 'int']]:
    bounds_converted = _ffi.cast('const STBox *', bounds)
    duration_converted = _ffi.cast('const int *', duration) if duration is not None else _ffi.NULL
    sorigin_converted = _ffi.cast('const int *', sorigin)
    count = _ffi.new('int *')
    result = _lib.stbox_space_time_tiles(bounds_converted, xsize, ysize, zsize, duration_converted, sorigin_converted, torigin, border_inc, count)
    _check_error()
    return result if result != _ffi.NULL else None, count[0]


def stbox_time_tiles(bounds: Annotated[_ffi.CData, 'const STBox *'], duration: Annotated[_ffi.CData, 'const int *'], torigin: int, border_inc: bool, count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'STBox *']:
    bounds_converted = _ffi.cast('const STBox *', bounds)
    duration_converted = _ffi.cast('const int *', duration)
    count_converted = _ffi.cast('int *', count)
    result = _lib.stbox_time_tiles(bounds_converted, duration_converted, torigin, border_inc, count_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tgeo_space_split(temp: Annotated[_ffi.CData, 'const Temporal *'], xsize: float, ysize: float, zsize: float, sorigin: Annotated[_ffi.CData, 'const int *'], bitmatrix: bool, border_inc: bool) -> tuple[Annotated[_ffi.CData, 'Temporal **'], Annotated[list, 'int **'], Annotated[_ffi.CData, 'int']]:
    temp_converted = _ffi.cast('const Temporal *', temp)
    sorigin_converted = _ffi.cast('const int *', sorigin)
    space_bins = _ffi.new('int ***')
    count = _ffi.new('int *')
    result = _lib.tgeo_space_split(temp_converted, xsize, ysize, zsize, sorigin_converted, bitmatrix, border_inc, space_bins, count)
    _check_error()
    return result if result != _ffi.NULL else None, space_bins[0], count[0]


def tgeo_space_time_split(temp: Annotated[_ffi.CData, 'const Temporal *'], xsize: float, ysize: float, zsize: float, duration: Annotated[_ffi.CData, 'const int *'], sorigin: Annotated[_ffi.CData, 'const int *'], torigin: int, bitmatrix: bool, border_inc: bool) -> tuple[Annotated[_ffi.CData, 'Temporal **'], Annotated[list, 'int **'], Annotated[list, 'int *'], Annotated[_ffi.CData, 'int']]:
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const int *', duration)
    sorigin_converted = _ffi.cast('const int *', sorigin)
    space_bins = _ffi.new('int ***')
    time_bins = _ffi.new('int **')
    count = _ffi.new('int *')
    result = _lib.tgeo_space_time_split(temp_converted, xsize, ysize, zsize, duration_converted, sorigin_converted, torigin, bitmatrix, border_inc, space_bins, time_bins, count)
    _check_error()
    return result if result != _ffi.NULL else None, space_bins[0], time_bins[0], count[0]


def geo_cluster_kmeans(geoms: Annotated[list, 'const int **'], ngeoms: Annotated[_ffi.CData, 'uint32_t'], k: Annotated[_ffi.CData, 'uint32_t']) -> Annotated[_ffi.CData, 'int *']:
    geoms_converted = [_ffi.cast('const int *', x) for x in geoms]
...
def geo_cluster_dbscan(geoms: Annotated[list, 'const int **'], ngeoms: Annotated[_ffi.CData, 'uint32_t'], tolerance: float, minpoints: int, count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'uint32_t *']:
    geoms_converted = [_ffi.cast('const int *', x) for x in geoms]
    ngeoms_converted = _ffi.cast('uint32_t', ngeoms)
    count_converted = _ffi.cast('int *', count)
...
def geo_cluster_intersecting(geoms: Annotated[list, 'const int **'], ngeoms: Annotated[_ffi.CData, 'uint32_t'], count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'int **']:
    geoms_converted = [_ffi.cast('const int *', x) for x in geoms]
    ngeoms_converted = _ffi.cast('uint32_t', ngeoms)
    count_converted = _ffi.cast('int *', count)
...
def geo_cluster_within(geoms: Annotated[list, 'const int **'], ngeoms: Annotated[_ffi.CData, 'uint32_t'], tolerance: float, count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'int **']:
    geoms_converted = [_ffi.cast('const int *', x) for x in geoms]
    ngeoms_converted = _ffi.cast('uint32_t', ngeoms)
    count_converted = _ffi.cast('int *', count)
...
def datum_ceil(d: Annotated[_ffi.CData, 'Datum']) -> Annotated[int, 'int']:
...
def datum_degrees(d: Annotated[_ffi.CData, 'Datum'], normalize: Annotated[_ffi.CData, 'Datum']) -> Annotated[int, 'int']:
    d_converted = _ffi.cast('Datum', d)
...
def datum_float_round(value: Annotated[_ffi.CData, 'Datum'], size: Annotated[_ffi.CData, 'Datum']) -> Annotated[int, 'int']:
...
def datum_floor(d: Annotated[_ffi.CData, 'Datum']) -> Annotated[int, 'int']:
    d_converted = _ffi.cast('Datum', d)
...
def datum_hash(d: Annotated[_ffi.CData, 'Datum'], basetype: Annotated[_ffi.CData, 'MeosType']) -> Annotated[int, 'int']:
    d_converted = _ffi.cast('Datum', d)
...
def datum_hash_extended(d: Annotated[_ffi.CData, 'Datum'], basetype: Annotated[_ffi.CData, 'MeosType'], seed: int) -> Annotated[int, 'int']:
    d_converted = _ffi.cast('Datum', d)
    basetype_converted = _ffi.cast('MeosType', basetype)
    result = _lib.datum_hash_extended(d_converted, basetype_converted, seed)
    _check_error()
    return result if result != _ffi.NULL else None


def datum_radians(d: Annotated[_ffi.CData, 'Datum']) -> Annotated[int, 'int']:
    d_converted = _ffi.cast('Datum', d)
...
def set_make(values: Annotated[_ffi.CData, 'Datum *'], count: int, basetype: Annotated[_ffi.CData, 'MeosType'], order: bool) -> Annotated[_ffi.CData, 'Set *']:
...
def set_make_exp(values: Annotated[_ffi.CData, 'Datum *'], count: int, maxcount: int, basetype: Annotated[_ffi.CData, 'MeosType'], order: bool) -> Annotated[_ffi.CData, 'Set *']:
    values_converted = _ffi.cast('Datum *', values)
    basetype_converted = _ffi.cast('MeosType', basetype)
...
def set_make_free(values: Annotated[_ffi.CData, 'Datum *'], count: int, basetype: Annotated[_ffi.CData, 'MeosType'], order: bool) -> Annotated[_ffi.CData, 'Set *']:
    values_converted = _ffi.cast('Datum *', values)
    basetype_converted = _ffi.cast('MeosType', basetype)
...
def span_make(lower: Annotated[_ffi.CData, 'Datum'], upper: Annotated[_ffi.CData, 'Datum'], lower_inc: bool, upper_inc: bool, basetype: Annotated[_ffi.CData, 'MeosType']) -> Annotated[_ffi.CData, 'Span *']:
...
def span_set(lower: Annotated[_ffi.CData, 'Datum'], upper: Annotated[_ffi.CData, 'Datum'], lower_inc: bool, upper_inc: bool, basetype: Annotated[_ffi.CData, 'MeosType'], spantype: Annotated[_ffi.CData, 'MeosType'], s: Annotated[_ffi.CData, 'Span *']) -> Annotated[None, 'void']:
    lower_converted = _ffi.cast('Datum', lower)
    upper_converted = _ffi.cast('Datum', upper)
    basetype_converted = _ffi.cast('MeosType', basetype)
    spantype_converted = _ffi.cast('MeosType', spantype)
    s_converted = _ffi.cast('Span *', s)
    _lib.span_set(lower_converted, upper_converted, lower_inc, upper_inc, basetype_converted, spantype_converted, s_converted)
    _check_error()


def spanset_make_exp(spans: Annotated[_ffi.CData, 'Span *'], count: int, maxcount: int, normalize: bool, order: bool) -> Annotated[_ffi.CData, 'SpanSet *']:
...
def spanset_make_free(spans: Annotated[_ffi.CData, 'Span *'], count: int, normalize: bool, order: bool) -> Annotated[_ffi.CData, 'SpanSet *']:
    spans_converted = _ffi.cast('Span *', spans)
...
def value_set_span(value: Annotated[_ffi.CData, 'Datum'], basetype: Annotated[_ffi.CData, 'MeosType'], s: Annotated[_ffi.CData, 'Span *']) -> Annotated[None, 'void']:
    value_converted = _ffi.cast('Datum', value)
    basetype_converted = _ffi.cast('MeosType', basetype)
    s_converted = _ffi.cast('Span *', s)
...
def value_set(d: Annotated[_ffi.CData, 'Datum'], basetype: Annotated[_ffi.CData, 'MeosType']) -> Annotated[_ffi.CData, 'Set *']:
    d_converted = _ffi.cast('Datum', d)
    basetype_converted = _ffi.cast('MeosType', basetype)
...
def value_span(d: Annotated[_ffi.CData, 'Datum'], basetype: Annotated[_ffi.CData, 'MeosType']) -> Annotated[_ffi.CData, 'Span *']:
    d_converted = _ffi.cast('Datum', d)
    basetype_converted = _ffi.cast('MeosType', basetype)
...
def value_spanset(d: Annotated[_ffi.CData, 'Datum'], basetype: Annotated[_ffi.CData, 'MeosType']) -> Annotated[_ffi.CData, 'SpanSet *']:
    d_converted = _ffi.cast('Datum', d)
    basetype_converted = _ffi.cast('MeosType', basetype)
...
def numspan_width(s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Span *', s)
...
def numspanset_width(ss: Annotated[_ffi.CData, 'const SpanSet *'], boundspan: bool) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def set_end_value(s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Set *', s)
...
def set_set_subspan(s: Annotated[_ffi.CData, 'const Set *'], minidx: int, maxidx: int) -> Annotated[_ffi.CData, 'Span *']:
    s_converted = _ffi.cast('const Set *', s)
    out_result = _ffi.new('Span *')
...
def set_start_value(s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Set *', s)
...
def spanset_lower(ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def spanset_upper(ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def datespan_set_tstzspan(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'Span *']) -> Annotated[None, 'void']:
    s1_converted = _ffi.cast('const Span *', s1)
...
def floatspan_set_intspan(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'Span *']) -> Annotated[None, 'void']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('Span *', s2)
...
def intspan_set_floatspan(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'Span *']) -> Annotated[None, 'void']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('Span *', s2)
...
def numset_shift_scale(s: Annotated[_ffi.CData, 'const Set *'], shift: Annotated[_ffi.CData, 'Datum'], width: Annotated[_ffi.CData, 'Datum'], hasshift: bool, haswidth: bool) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
...
def numspan_expand(s: Annotated[_ffi.CData, 'const Span *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[_ffi.CData, 'Span *']:
    s_converted = _ffi.cast('const Span *', s)
    value_converted = _ffi.cast('Datum', value)
...
def numspan_shift_scale(s: Annotated[_ffi.CData, 'const Span *'], shift: Annotated[_ffi.CData, 'Datum'], width: Annotated[_ffi.CData, 'Datum'], hasshift: bool, haswidth: bool) -> Annotated[_ffi.CData, 'Span *']:
    s_converted = _ffi.cast('const Span *', s)
    shift_converted = _ffi.cast('Datum', shift)
    width_converted = _ffi.cast('Datum', width)
...
def numspanset_shift_scale(ss: Annotated[_ffi.CData, 'const SpanSet *'], shift: Annotated[_ffi.CData, 'Datum'], width: Annotated[_ffi.CData, 'Datum'], hasshift: bool, haswidth: bool) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    shift_converted = _ffi.cast('Datum', shift)
    width_converted = _ffi.cast('Datum', width)
...
def span_expand(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'Span *']) -> Annotated[None, 'void']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('Span *', s2)
...
def tbox_expand_value(box: Annotated[_ffi.CData, 'const TBox *'], value: Annotated[_ffi.CData, 'Datum'], basetyp: Annotated[_ffi.CData, 'MeosType']) -> Annotated[_ffi.CData, 'TBox *']:
    box_converted = _ffi.cast('const TBox *', box)
    value_converted = _ffi.cast('Datum', value)
...
def textcat_textset_text_common(s: Annotated[_ffi.CData, 'const Set *'], txt: Annotated[_ffi.CData, 'const int *'], invert: bool) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    txt_converted = _ffi.cast('const int *', txt)
    result = _lib.textcat_textset_text_common(s_converted, txt_converted, invert)
    _check_error()
    return result if result != _ffi.NULL else None


def tstzspan_set_datespan(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'Span *']) -> Annotated[None, 'void']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('Span *', s2)
...
def adjacent_span_value(s: Annotated[_ffi.CData, 'const Span *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    value_converted = _ffi.cast('Datum', value)
...
def adjacent_spanset_value(ss: Annotated[_ffi.CData, 'const SpanSet *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    value_converted = _ffi.cast('Datum', value)
...
def adjacent_value_spanset(value: Annotated[_ffi.CData, 'Datum'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    value_converted = _ffi.cast('Datum', value)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def contained_value_set(value: Annotated[_ffi.CData, 'Datum'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    value_converted = _ffi.cast('Datum', value)
    s_converted = _ffi.cast('const Set *', s)
...
def contained_value_span(value: Annotated[_ffi.CData, 'Datum'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    value_converted = _ffi.cast('Datum', value)
    s_converted = _ffi.cast('const Span *', s)
...
def contained_value_spanset(value: Annotated[_ffi.CData, 'Datum'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    value_converted = _ffi.cast('Datum', value)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def contains_set_value(s: Annotated[_ffi.CData, 'const Set *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    value_converted = _ffi.cast('Datum', value)
...
def contains_span_value(s: Annotated[_ffi.CData, 'const Span *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    value_converted = _ffi.cast('Datum', value)
...
def contains_spanset_value(ss: Annotated[_ffi.CData, 'const SpanSet *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    value_converted = _ffi.cast('Datum', value)
...
def ovadj_span_span(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def left_set_value(s: Annotated[_ffi.CData, 'const Set *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    value_converted = _ffi.cast('Datum', value)
...
def left_span_value(s: Annotated[_ffi.CData, 'const Span *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    value_converted = _ffi.cast('Datum', value)
...
def left_spanset_value(ss: Annotated[_ffi.CData, 'const SpanSet *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    value_converted = _ffi.cast('Datum', value)
...
def left_value_set(value: Annotated[_ffi.CData, 'Datum'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    value_converted = _ffi.cast('Datum', value)
    s_converted = _ffi.cast('const Set *', s)
...
def left_value_span(value: Annotated[_ffi.CData, 'Datum'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    value_converted = _ffi.cast('Datum', value)
    s_converted = _ffi.cast('const Span *', s)
...
def left_value_spanset(value: Annotated[_ffi.CData, 'Datum'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    value_converted = _ffi.cast('Datum', value)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def lfnadj_span_span(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def overleft_set_value(s: Annotated[_ffi.CData, 'const Set *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    value_converted = _ffi.cast('Datum', value)
...
def overleft_span_value(s: Annotated[_ffi.CData, 'const Span *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    value_converted = _ffi.cast('Datum', value)
...
def overleft_spanset_value(ss: Annotated[_ffi.CData, 'const SpanSet *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    value_converted = _ffi.cast('Datum', value)
...
def overleft_value_set(value: Annotated[_ffi.CData, 'Datum'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    value_converted = _ffi.cast('Datum', value)
    s_converted = _ffi.cast('const Set *', s)
...
def overleft_value_span(value: Annotated[_ffi.CData, 'Datum'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    value_converted = _ffi.cast('Datum', value)
    s_converted = _ffi.cast('const Span *', s)
...
def overleft_value_spanset(value: Annotated[_ffi.CData, 'Datum'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    value_converted = _ffi.cast('Datum', value)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def overright_set_value(s: Annotated[_ffi.CData, 'const Set *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    value_converted = _ffi.cast('Datum', value)
...
def overright_span_value(s: Annotated[_ffi.CData, 'const Span *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    value_converted = _ffi.cast('Datum', value)
...
def overright_spanset_value(ss: Annotated[_ffi.CData, 'const SpanSet *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    value_converted = _ffi.cast('Datum', value)
...
def overright_value_set(value: Annotated[_ffi.CData, 'Datum'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    value_converted = _ffi.cast('Datum', value)
    s_converted = _ffi.cast('const Set *', s)
...
def overright_value_span(value: Annotated[_ffi.CData, 'Datum'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    value_converted = _ffi.cast('Datum', value)
    s_converted = _ffi.cast('const Span *', s)
...
def overright_value_spanset(value: Annotated[_ffi.CData, 'Datum'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    value_converted = _ffi.cast('Datum', value)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def right_value_set(value: Annotated[_ffi.CData, 'Datum'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    value_converted = _ffi.cast('Datum', value)
    s_converted = _ffi.cast('const Set *', s)
...
def right_set_value(s: Annotated[_ffi.CData, 'const Set *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    value_converted = _ffi.cast('Datum', value)
...
def right_value_span(value: Annotated[_ffi.CData, 'Datum'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[bool, 'bool']:
    value_converted = _ffi.cast('Datum', value)
    s_converted = _ffi.cast('const Span *', s)
...
def right_value_spanset(value: Annotated[_ffi.CData, 'Datum'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[bool, 'bool']:
    value_converted = _ffi.cast('Datum', value)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def right_span_value(s: Annotated[_ffi.CData, 'const Span *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Span *', s)
    value_converted = _ffi.cast('Datum', value)
...
def right_spanset_value(ss: Annotated[_ffi.CData, 'const SpanSet *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[bool, 'bool']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    value_converted = _ffi.cast('Datum', value)
...
def temporal_bbox_eq(box1: Annotated[_ffi.CData, 'const void *'], box2: Annotated[_ffi.CData, 'const void *'], temptype: Annotated[_ffi.CData, 'MeosType']) -> Annotated[bool, 'bool']:
...
def temporal_bbox_cmp(box1: Annotated[_ffi.CData, 'const void *'], box2: Annotated[_ffi.CData, 'const void *'], temptype: Annotated[_ffi.CData, 'MeosType']) -> Annotated[int, 'int']:
    box1_converted = _ffi.cast('const void *', box1)
    box2_converted = _ffi.cast('const void *', box2)
    temptype_converted = _ffi.cast('MeosType', temptype)
...
def bbox_union_span_span(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'Span *']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
    out_result = _ffi.new('Span *')
...
def inter_span_span(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'Span *']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
    out_result = _ffi.new('Span *')
...
def intersection_set_value(s: Annotated[_ffi.CData, 'const Set *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    value_converted = _ffi.cast('Datum', value)
...
def intersection_span_value(s: Annotated[_ffi.CData, 'const Span *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[_ffi.CData, 'Span *']:
    s_converted = _ffi.cast('const Span *', s)
    value_converted = _ffi.cast('Datum', value)
...
def intersection_spanset_value(ss: Annotated[_ffi.CData, 'const SpanSet *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    value_converted = _ffi.cast('Datum', value)
...
def intersection_value_set(value: Annotated[_ffi.CData, 'Datum'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    value_converted = _ffi.cast('Datum', value)
    s_converted = _ffi.cast('const Set *', s)
...
def intersection_value_span(value: Annotated[_ffi.CData, 'Datum'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'Span *']:
    value_converted = _ffi.cast('Datum', value)
    s_converted = _ffi.cast('const Span *', s)
...
def intersection_value_spanset(value: Annotated[_ffi.CData, 'Datum'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    value_converted = _ffi.cast('Datum', value)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def mi_span_span(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'Span *']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
    out_result = _ffi.new('Span *')
...
def minus_set_value(s: Annotated[_ffi.CData, 'const Set *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    value_converted = _ffi.cast('Datum', value)
...
def minus_span_value(s: Annotated[_ffi.CData, 'const Span *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[_ffi.CData, 'SpanSet *']:
    s_converted = _ffi.cast('const Span *', s)
    value_converted = _ffi.cast('Datum', value)
...
def minus_spanset_value(ss: Annotated[_ffi.CData, 'const SpanSet *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    value_converted = _ffi.cast('Datum', value)
...
def minus_value_set(value: Annotated[_ffi.CData, 'Datum'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    value_converted = _ffi.cast('Datum', value)
    s_converted = _ffi.cast('const Set *', s)
...
def minus_value_span(value: Annotated[_ffi.CData, 'Datum'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    value_converted = _ffi.cast('Datum', value)
    s_converted = _ffi.cast('const Span *', s)
...
def minus_value_spanset(value: Annotated[_ffi.CData, 'Datum'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    value_converted = _ffi.cast('Datum', value)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def super_union_span_span(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'Span *']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def union_set_value(s: Annotated[_ffi.CData, 'const Set *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    value_converted = _ffi.cast('Datum', value)
...
def union_span_value(s: Annotated[_ffi.CData, 'const Span *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[_ffi.CData, 'SpanSet *']:
    s_converted = _ffi.cast('const Span *', s)
    value_converted = _ffi.cast('Datum', value)
...
def union_spanset_value(ss: Annotated[_ffi.CData, 'const SpanSet *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[_ffi.CData, 'SpanSet *']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    value_converted = _ffi.cast('Datum', value)
...
def union_value_set(value: Annotated[_ffi.CData, 'Datum'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    value_converted = _ffi.cast('Datum', value)
    s_converted = _ffi.cast('const Set *', s)
...
def union_value_span(value: Annotated[_ffi.CData, 'Datum'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    value_converted = _ffi.cast('Datum', value)
    s_converted = _ffi.cast('const Span *', s)
...
def union_value_spanset(value: Annotated[_ffi.CData, 'Datum'], ss: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'SpanSet *']:
    value_converted = _ffi.cast('Datum', value)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def distance_set_set(s1: Annotated[_ffi.CData, 'const Set *'], s2: Annotated[_ffi.CData, 'const Set *']) -> Annotated[int, 'int']:
    s1_converted = _ffi.cast('const Set *', s1)
    s2_converted = _ffi.cast('const Set *', s2)
...
def distance_set_value(s: Annotated[_ffi.CData, 'const Set *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Set *', s)
    value_converted = _ffi.cast('Datum', value)
...
def distance_span_span(s1: Annotated[_ffi.CData, 'const Span *'], s2: Annotated[_ffi.CData, 'const Span *']) -> Annotated[int, 'int']:
    s1_converted = _ffi.cast('const Span *', s1)
    s2_converted = _ffi.cast('const Span *', s2)
...
def distance_span_value(s: Annotated[_ffi.CData, 'const Span *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[int, 'int']:
    s_converted = _ffi.cast('const Span *', s)
    value_converted = _ffi.cast('Datum', value)
...
def distance_spanset_span(ss: Annotated[_ffi.CData, 'const SpanSet *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def distance_spanset_spanset(ss1: Annotated[_ffi.CData, 'const SpanSet *'], ss2: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[int, 'int']:
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def distance_spanset_value(ss: Annotated[_ffi.CData, 'const SpanSet *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const SpanSet *', ss)
    value_converted = _ffi.cast('Datum', value)
...
def distance_value_value(l: Annotated[_ffi.CData, 'Datum'], r: Annotated[_ffi.CData, 'Datum'], basetype: Annotated[_ffi.CData, 'MeosType']) -> Annotated[int, 'int']:
...
def spanbase_extent_transfn(state: Annotated[_ffi.CData, 'Span *'], value: Annotated[_ffi.CData, 'Datum'], basetype: Annotated[_ffi.CData, 'MeosType']) -> Annotated[_ffi.CData, 'Span *']:
    state_converted = _ffi.cast('Span *', state)
    value_converted = _ffi.cast('Datum', value)
    basetype_converted = _ffi.cast('MeosType', basetype)
...
def value_union_transfn(state: Annotated[_ffi.CData, 'Set *'], value: Annotated[_ffi.CData, 'Datum'], basetype: Annotated[_ffi.CData, 'MeosType']) -> Annotated[_ffi.CData, 'Set *']:
    state_converted = _ffi.cast('Set *', state)
    value_converted = _ffi.cast('Datum', value)
    basetype_converted = _ffi.cast('MeosType', basetype)
...
def number_tstzspan_to_tbox(d: Annotated[_ffi.CData, 'Datum'], basetype: Annotated[_ffi.CData, 'MeosType'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'TBox *']:
    d_converted = _ffi.cast('Datum', d)
    basetype_converted = _ffi.cast('MeosType', basetype)
    s_converted = _ffi.cast('const Span *', s)
...
def number_timestamptz_to_tbox(d: Annotated[_ffi.CData, 'Datum'], basetype: Annotated[_ffi.CData, 'MeosType'], t: int) -> Annotated[_ffi.CData, 'TBox *']:
    d_converted = _ffi.cast('Datum', d)
    basetype_converted = _ffi.cast('MeosType', basetype)
    result = _lib.number_timestamptz_to_tbox(d_converted, basetype_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def tbox_set(s: Annotated[_ffi.CData, 'const Span *'], p: Annotated[_ffi.CData, 'const Span *'], box: Annotated[_ffi.CData, 'TBox *']) -> Annotated[None, 'void']:
    s_converted = _ffi.cast('const Span *', s)
...
def number_set_tbox(d: Annotated[_ffi.CData, 'Datum'], basetype: Annotated[_ffi.CData, 'MeosType'], box: Annotated[_ffi.CData, 'TBox *']) -> Annotated[None, 'void']:
    d_converted = _ffi.cast('Datum', d)
    basetype_converted = _ffi.cast('MeosType', basetype)
    box_converted = _ffi.cast('TBox *', box)
...
def number_tbox(value: Annotated[_ffi.CData, 'Datum'], basetype: Annotated[_ffi.CData, 'MeosType']) -> Annotated[_ffi.CData, 'TBox *']:
    value_converted = _ffi.cast('Datum', value)
    basetype_converted = _ffi.cast('MeosType', basetype)
...
def numset_set_tbox(s: Annotated[_ffi.CData, 'const Set *'], box: Annotated[_ffi.CData, 'TBox *']) -> Annotated[None, 'void']:
    s_converted = _ffi.cast('const Set *', s)
    box_converted = _ffi.cast('TBox *', box)
...
def numspan_set_tbox(span: Annotated[_ffi.CData, 'const Span *'], box: Annotated[_ffi.CData, 'TBox *']) -> Annotated[None, 'void']:
    span_converted = _ffi.cast('const Span *', span)
    box_converted = _ffi.cast('TBox *', box)
...
def timestamptz_set_tbox(t: int, box: Annotated[_ffi.CData, 'TBox *']) -> Annotated[None, 'void']:
    box_converted = _ffi.cast('TBox *', box)
    _lib.timestamptz_set_tbox(t, box_converted)
    _check_error()


def tstzset_set_tbox(s: Annotated[_ffi.CData, 'const Set *'], box: Annotated[_ffi.CData, 'TBox *']) -> Annotated[None, 'void']:
    s_converted = _ffi.cast('const Set *', s)
    box_converted = _ffi.cast('TBox *', box)
...
def tstzspan_set_tbox(s: Annotated[_ffi.CData, 'const Span *'], box: Annotated[_ffi.CData, 'TBox *']) -> Annotated[None, 'void']:
    s_converted = _ffi.cast('const Span *', s)
    box_converted = _ffi.cast('TBox *', box)
...
def tbox_shift_scale_value(box: Annotated[_ffi.CData, 'const TBox *'], shift: Annotated[_ffi.CData, 'Datum'], width: Annotated[_ffi.CData, 'Datum'], hasshift: bool, haswidth: bool) -> Annotated[_ffi.CData, 'TBox *']:
    box_converted = _ffi.cast('const TBox *', box)
    shift_converted = _ffi.cast('Datum', shift)
    width_converted = _ffi.cast('Datum', width)
...
def tbox_expand(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'TBox *']) -> Annotated[None, 'void']:
    box1_converted = _ffi.cast('const TBox *', box1)
...
def inter_tbox_tbox(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[_ffi.CData, 'TBox *']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def temparr_out(temparr: Annotated[list, 'Temporal **'], count: int, maxdd: int) -> Annotated[_ffi.CData, 'char **']:
    temparr_converted = [_ffi.cast('Temporal *', x) for x in temparr]
...
def tsequence_in(string: str, temptype: Annotated[_ffi.CData, 'MeosType'], interp: InterpolationType) -> Annotated[_ffi.CData, 'TSequence *']:
    string_converted = string.encode('utf-8')
    temptype_converted = _ffi.cast('MeosType', temptype)
...
def tsequenceset_in(string: str, temptype: Annotated[_ffi.CData, 'MeosType'], interp: InterpolationType) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    string_converted = string.encode('utf-8')
    temptype_converted = _ffi.cast('MeosType', temptype)
...
def temporal_from_mfjson(mfjson: str, temptype: Annotated[_ffi.CData, 'MeosType']) -> Annotated[_ffi.CData, 'Temporal *']:
    mfjson_converted = mfjson.encode('utf-8')
    temptype_converted = _ffi.cast('MeosType', temptype)
...
def temporal_from_base_temp(value: Annotated[_ffi.CData, 'Datum'], temptype: Annotated[_ffi.CData, 'MeosType'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    value_converted = _ffi.cast('Datum', value)
    temptype_converted = _ffi.cast('MeosType', temptype)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tinstant_make(value: Annotated[_ffi.CData, 'Datum'], temptype: Annotated[_ffi.CData, 'MeosType'], t: int) -> Annotated[_ffi.CData, 'TInstant *']:
    value_converted = _ffi.cast('Datum', value)
    temptype_converted = _ffi.cast('MeosType', temptype)
    result = _lib.tinstant_make(value_converted, temptype_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def tinstant_make_free(value: Annotated[_ffi.CData, 'Datum'], temptype: Annotated[_ffi.CData, 'MeosType'], t: int) -> Annotated[_ffi.CData, 'TInstant *']:
    value_converted = _ffi.cast('Datum', value)
    temptype_converted = _ffi.cast('MeosType', temptype)
    result = _lib.tinstant_make_free(value_converted, temptype_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tsequence_from_base_temp(value: Annotated[_ffi.CData, 'Datum'], temptype: Annotated[_ffi.CData, 'MeosType'], seq: Annotated[_ffi.CData, 'const TSequence *']) -> Annotated[_ffi.CData, 'TSequence *']:
    value_converted = _ffi.cast('Datum', value)
    temptype_converted = _ffi.cast('MeosType', temptype)
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tsequence_from_base_tstzset(value: Annotated[_ffi.CData, 'Datum'], temptype: Annotated[_ffi.CData, 'MeosType'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'TSequence *']:
    value_converted = _ffi.cast('Datum', value)
    temptype_converted = _ffi.cast('MeosType', temptype)
    s_converted = _ffi.cast('const Set *', s)
...
def tsequence_from_base_tstzspan(value: Annotated[_ffi.CData, 'Datum'], temptype: Annotated[_ffi.CData, 'MeosType'], s: Annotated[_ffi.CData, 'const Span *'], interp: InterpolationType) -> Annotated[_ffi.CData, 'TSequence *']:
    value_converted = _ffi.cast('Datum', value)
    temptype_converted = _ffi.cast('MeosType', temptype)
    s_converted = _ffi.cast('const Span *', s)
...
def tsequence_make_exp(instants: Annotated[list, 'TInstant **'], count: int, maxcount: int, lower_inc: bool, upper_inc: bool, interp: InterpolationType, normalize: bool) -> Annotated[_ffi.CData, 'TSequence *']:
    instants_converted = [_ffi.cast('TInstant *', x) for x in instants]
...
def tsequence_make_free(instants: Annotated[list, 'TInstant **'], count: int, lower_inc: bool, upper_inc: bool, interp: InterpolationType, normalize: bool) -> Annotated[_ffi.CData, 'TSequence *']:
    instants_converted = [_ffi.cast('TInstant *', x) for x in instants]
...
def tseqsetarr_to_tseqset(seqsets: Annotated[list, 'TSequenceSet **'], count: int, totalseqs: int) -> Annotated[_ffi.CData, 'TSequenceSet *']:
...
def tsequenceset_from_base_temp(value: Annotated[_ffi.CData, 'Datum'], temptype: Annotated[_ffi.CData, 'MeosType'], ss: Annotated[_ffi.CData, 'const TSequenceSet *']) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    value_converted = _ffi.cast('Datum', value)
    temptype_converted = _ffi.cast('MeosType', temptype)
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tsequenceset_from_base_tstzspanset(value: Annotated[_ffi.CData, 'Datum'], temptype: Annotated[_ffi.CData, 'MeosType'], ss: Annotated[_ffi.CData, 'const SpanSet *'], interp: InterpolationType) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    value_converted = _ffi.cast('Datum', value)
    temptype_converted = _ffi.cast('MeosType', temptype)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tsequenceset_make_exp(sequences: Annotated[list, 'TSequence **'], count: int, maxcount: int, normalize: bool) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    sequences_converted = [_ffi.cast('TSequence *', x) for x in sequences]
...
def tsequenceset_make_free(sequences: Annotated[list, 'TSequence **'], count: int, normalize: bool) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    sequences_converted = [_ffi.cast('TSequence *', x) for x in sequences]
...
def temporal_set_tstzspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'Span *']) -> Annotated[None, 'void']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('Span *', s)
...
def tinstant_set_tstzspan(inst: Annotated[_ffi.CData, 'const TInstant *'], s: Annotated[_ffi.CData, 'Span *']) -> Annotated[None, 'void']:
    inst_converted = _ffi.cast('const TInstant *', inst)
    s_converted = _ffi.cast('Span *', s)
...
def tnumber_set_tbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'TBox *']) -> Annotated[None, 'void']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('TBox *', box)
...
def tnumberinst_set_tbox(inst: Annotated[_ffi.CData, 'const TInstant *'], box: Annotated[_ffi.CData, 'TBox *']) -> Annotated[None, 'void']:
    inst_converted = _ffi.cast('const TInstant *', inst)
    box_converted = _ffi.cast('TBox *', box)
...
def tnumberseq_set_tbox(seq: Annotated[_ffi.CData, 'const TSequence *'], box: Annotated[_ffi.CData, 'TBox *']) -> Annotated[None, 'void']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    box_converted = _ffi.cast('TBox *', box)
...
def tnumberseqset_set_tbox(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], box: Annotated[_ffi.CData, 'TBox *']) -> Annotated[None, 'void']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    box_converted = _ffi.cast('TBox *', box)
...
def tsequence_set_tstzspan(seq: Annotated[_ffi.CData, 'const TSequence *'], s: Annotated[_ffi.CData, 'Span *']) -> Annotated[None, 'void']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    s_converted = _ffi.cast('Span *', s)
...
def tsequenceset_set_tstzspan(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], s: Annotated[_ffi.CData, 'Span *']) -> Annotated[None, 'void']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    s_converted = _ffi.cast('Span *', s)
...
def temporal_end_value(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_inst_n(temp: Annotated[_ffi.CData, 'const Temporal *'], n: int) -> Annotated[_ffi.CData, 'const TInstant *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_max_inst_p(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'const TInstant *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.temporal_max_inst_p(temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def temporal_max_value(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_min_inst_p(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'const TInstant *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.temporal_min_inst_p(temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def temporal_min_value(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_start_value(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tinstant_hash(inst: Annotated[_ffi.CData, 'const TInstant *']) -> Annotated[int, 'int']:
    inst_converted = _ffi.cast('const TInstant *', inst)
...
def tinstant_timestamps(inst: Annotated[_ffi.CData, 'const TInstant *'], count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'int *']:
    inst_converted = _ffi.cast('const TInstant *', inst)
    count_converted = _ffi.cast('int *', count)
...
def tinstant_value_p(inst: Annotated[_ffi.CData, 'const TInstant *']) -> Annotated[int, 'int']:
    inst_converted = _ffi.cast('const TInstant *', inst)
...
def tinstant_value(inst: Annotated[_ffi.CData, 'const TInstant *']) -> Annotated[int, 'int']:
    inst_converted = _ffi.cast('const TInstant *', inst)
...
def tinstant_value_at_timestamptz(inst: Annotated[_ffi.CData, 'const TInstant *'], t: int) -> Annotated[_ffi.CData, 'Datum *']:
    inst_converted = _ffi.cast('const TInstant *', inst)
    out_result = _ffi.new('Datum *')
    result = _lib.tinstant_value_at_timestamptz(inst_converted, t, out_result)
    _check_error()
    if result:
        return out_result if out_result != _ffi.NULL else None
    return None
...
def tsequence_duration(seq: Annotated[_ffi.CData, 'const TSequence *']) -> Annotated[_ffi.CData, 'int *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tsequence_end_timestamptz(seq: Annotated[_ffi.CData, 'const TSequence *']) -> Annotated[int, 'int']:
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tsequence_hash(seq: Annotated[_ffi.CData, 'const TSequence *']) -> Annotated[int, 'int']:
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tsequence_max_inst_p(seq: Annotated[_ffi.CData, 'const TSequence *']) -> Annotated[_ffi.CData, 'const TInstant *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    result = _lib.tsequence_max_inst_p(seq_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tsequence_max_val(seq: Annotated[_ffi.CData, 'const TSequence *']) -> Annotated[int, 'int']:
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tsequence_min_inst_p(seq: Annotated[_ffi.CData, 'const TSequence *']) -> Annotated[_ffi.CData, 'const TInstant *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    result = _lib.tsequence_min_inst_p(seq_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tsequence_min_val(seq: Annotated[_ffi.CData, 'const TSequence *']) -> Annotated[int, 'int']:
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tsequence_start_timestamptz(seq: Annotated[_ffi.CData, 'const TSequence *']) -> Annotated[int, 'int']:
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tsequence_timestamps(seq: Annotated[_ffi.CData, 'const TSequence *'], count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'int *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    count_converted = _ffi.cast('int *', count)
...
def tsequence_value_at_timestamptz(seq: Annotated[_ffi.CData, 'const TSequence *'], t: int, strict: bool) -> Annotated[_ffi.CData, 'Datum *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    out_result = _ffi.new('Datum *')
    result = _lib.tsequence_value_at_timestamptz(seq_converted, t, strict, out_result)
    _check_error()
    if result:
        return out_result if out_result != _ffi.NULL else None
    return None
...
def tsequenceset_duration(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], boundspan: bool) -> Annotated[_ffi.CData, 'int *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tsequenceset_end_timestamptz(ss: Annotated[_ffi.CData, 'const TSequenceSet *']) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tsequenceset_hash(ss: Annotated[_ffi.CData, 'const TSequenceSet *']) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tsequenceset_inst_n(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], n: int) -> Annotated[_ffi.CData, 'const TInstant *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tsequenceset_insts_p(ss: Annotated[_ffi.CData, 'const TSequenceSet *']) -> Annotated[_ffi.CData, 'const TInstant **']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tsequenceset_max_inst_p(ss: Annotated[_ffi.CData, 'const TSequenceSet *']) -> Annotated[_ffi.CData, 'const TInstant *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    result = _lib.tsequenceset_max_inst_p(ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tsequenceset_max_val(ss: Annotated[_ffi.CData, 'const TSequenceSet *']) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tsequenceset_min_inst_p(ss: Annotated[_ffi.CData, 'const TSequenceSet *']) -> Annotated[_ffi.CData, 'const TInstant *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    result = _lib.tsequenceset_min_inst_p(ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tsequenceset_min_val(ss: Annotated[_ffi.CData, 'const TSequenceSet *']) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tsequenceset_start_timestamptz(ss: Annotated[_ffi.CData, 'const TSequenceSet *']) -> Annotated[int, 'int']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tsequenceset_timestamptz_n(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], n: int) -> Annotated[_ffi.CData, 'int']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    out_result = _ffi.new('int *')
...
def tsequenceset_timestamps(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'int *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    count_converted = _ffi.cast('int *', count)
...
def tsequenceset_value_at_timestamptz(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], t: int, strict: bool) -> Annotated[_ffi.CData, 'Datum *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    out_result = _ffi.new('Datum *')
    result = _lib.tsequenceset_value_at_timestamptz(ss_converted, t, strict, out_result)
    _check_error()
    if result:
        return out_result if out_result != _ffi.NULL else None
    return None
...
def temporal_tsequence(temp: Annotated[_ffi.CData, 'const Temporal *'], interp: InterpolationType) -> Annotated[_ffi.CData, 'TSequence *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_tsequenceset(temp: Annotated[_ffi.CData, 'const Temporal *'], interp: InterpolationType) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tinstant_shift_time(inst: Annotated[_ffi.CData, 'const TInstant *'], interv: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'TInstant *']:
    inst_converted = _ffi.cast('const TInstant *', inst)
    interv_converted = _ffi.cast('const int *', interv)
...
def tinstant_to_tsequence(inst: Annotated[_ffi.CData, 'const TInstant *'], interp: InterpolationType) -> Annotated[_ffi.CData, 'TSequence *']:
    inst_converted = _ffi.cast('const TInstant *', inst)
...
def tinstant_to_tsequence_free(inst: Annotated[_ffi.CData, 'TInstant *'], interp: InterpolationType) -> Annotated[_ffi.CData, 'TSequence *']:
...
def tinstant_to_tsequenceset(inst: Annotated[_ffi.CData, 'const TInstant *'], interp: InterpolationType) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    inst_converted = _ffi.cast('const TInstant *', inst)
...
def tnumber_shift_scale_value(temp: Annotated[_ffi.CData, 'const Temporal *'], shift: Annotated[_ffi.CData, 'Datum'], width: Annotated[_ffi.CData, 'Datum'], hasshift: bool, haswidth: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    shift_converted = _ffi.cast('Datum', shift)
    width_converted = _ffi.cast('Datum', width)
...
def tnumberinst_shift_value(inst: Annotated[_ffi.CData, 'const TInstant *'], shift: Annotated[_ffi.CData, 'Datum']) -> Annotated[_ffi.CData, 'TInstant *']:
    inst_converted = _ffi.cast('const TInstant *', inst)
    shift_converted = _ffi.cast('Datum', shift)
...
def tnumberseq_shift_scale_value(seq: Annotated[_ffi.CData, 'const TSequence *'], shift: Annotated[_ffi.CData, 'Datum'], width: Annotated[_ffi.CData, 'Datum'], hasshift: bool, haswidth: bool) -> Annotated[_ffi.CData, 'TSequence *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    shift_converted = _ffi.cast('Datum', shift)
    width_converted = _ffi.cast('Datum', width)
...
def tnumberseqset_shift_scale_value(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], start: Annotated[_ffi.CData, 'Datum'], width: Annotated[_ffi.CData, 'Datum'], hasshift: bool, haswidth: bool) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tsequence_set_interp(seq: Annotated[_ffi.CData, 'const TSequence *'], interp: InterpolationType) -> Annotated[_ffi.CData, 'Temporal *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tsequence_shift_scale_time(seq: Annotated[_ffi.CData, 'const TSequence *'], shift: Annotated[_ffi.CData, 'const int *'], duration: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'TSequence *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    shift_converted = _ffi.cast('const int *', shift)
    duration_converted = _ffi.cast('const int *', duration)
...
def tsequence_subseq(seq: Annotated[_ffi.CData, 'const TSequence *'], from_: int, to: int, lower_inc: bool, upper_inc: bool) -> Annotated[_ffi.CData, 'TSequence *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tsequence_to_tsequenceset(seq: Annotated[_ffi.CData, 'const TSequence *']) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tsequence_to_tsequenceset_free(seq: Annotated[_ffi.CData, 'TSequence *']) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    seq_converted = _ffi.cast('TSequence *', seq)
...
def tsequence_to_tsequenceset_interp(seq: Annotated[_ffi.CData, 'const TSequence *'], interp: InterpolationType) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tsequenceset_set_interp(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], interp: InterpolationType) -> Annotated[_ffi.CData, 'Temporal *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tsequenceset_shift_scale_time(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], start: Annotated[_ffi.CData, 'const int *'], duration: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    start_converted = _ffi.cast('const int *', start)
    duration_converted = _ffi.cast('const int *', duration)
...
def tsequenceset_to_linear(ss: Annotated[_ffi.CData, 'const TSequenceSet *']) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tsequenceset_to_tsequence(ss: Annotated[_ffi.CData, 'const TSequenceSet *']) -> Annotated[_ffi.CData, 'TSequence *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tinstant_merge(inst1: Annotated[_ffi.CData, 'const TInstant *'], inst2: Annotated[_ffi.CData, 'const TInstant *']) -> Annotated[_ffi.CData, 'Temporal *']:
...
def tinstant_merge_array(instants: Annotated[list, 'TInstant **'], count: int) -> Annotated[_ffi.CData, 'Temporal *']:
    instants_converted = [_ffi.cast('TInstant *', x) for x in instants]
...
def tsequence_append_tinstant(seq: Annotated[_ffi.CData, 'TSequence *'], inst: Annotated[_ffi.CData, 'const TInstant *'], maxdist: float, maxt: Annotated[_ffi.CData, 'const int *'], expand: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    seq_converted = _ffi.cast('TSequence *', seq)
    inst_converted = _ffi.cast('const TInstant *', inst)
    maxt_converted = _ffi.cast('const int *', maxt)
    result = _lib.tsequence_append_tinstant(seq_converted, inst_converted, maxdist, maxt_converted, expand)
    _check_error()
    return result if result != _ffi.NULL else None


def tsequence_append_tsequence(seq1: Annotated[_ffi.CData, 'const TSequence *'], seq2: Annotated[_ffi.CData, 'const TSequence *'], expand: bool) -> Annotated[_ffi.CData, 'Temporal *']:
...
def tsequence_delete_timestamptz(seq: Annotated[_ffi.CData, 'const TSequence *'], t: int, connect: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    result = _lib.tsequence_delete_timestamptz(seq_converted, t, connect)
    _check_error()
    return result if result != _ffi.NULL else None


def tsequence_delete_tstzset(seq: Annotated[_ffi.CData, 'const TSequence *'], s: Annotated[_ffi.CData, 'const Set *'], connect: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    s_converted = _ffi.cast('const Set *', s)
...
def tsequence_delete_tstzspan(seq: Annotated[_ffi.CData, 'const TSequence *'], s: Annotated[_ffi.CData, 'const Span *'], connect: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    s_converted = _ffi.cast('const Span *', s)
...
def tsequence_delete_tstzspanset(seq: Annotated[_ffi.CData, 'const TSequence *'], ss: Annotated[_ffi.CData, 'const SpanSet *'], connect: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tsequence_insert(seq1: Annotated[_ffi.CData, 'const TSequence *'], seq2: Annotated[_ffi.CData, 'const TSequence *'], connect: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    seq1_converted = _ffi.cast('const TSequence *', seq1)
    seq2_converted = _ffi.cast('const TSequence *', seq2)
...
def tsequence_merge(seq1: Annotated[_ffi.CData, 'const TSequence *'], seq2: Annotated[_ffi.CData, 'const TSequence *']) -> Annotated[_ffi.CData, 'Temporal *']:
    seq1_converted = _ffi.cast('const TSequence *', seq1)
    seq2_converted = _ffi.cast('const TSequence *', seq2)
...
def tsequence_merge_array(sequences: Annotated[list, 'TSequence **'], count: int) -> Annotated[_ffi.CData, 'Temporal *']:
    sequences_converted = [_ffi.cast('TSequence *', x) for x in sequences]
...
def tsequenceset_append_tinstant(ss: Annotated[_ffi.CData, 'TSequenceSet *'], inst: Annotated[_ffi.CData, 'const TInstant *'], maxdist: float, maxt: Annotated[_ffi.CData, 'const int *'], expand: bool) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('TSequenceSet *', ss)
    inst_converted = _ffi.cast('const TInstant *', inst)
    maxt_converted = _ffi.cast('const int *', maxt)
...
def tsequenceset_append_tsequence(ss: Annotated[_ffi.CData, 'TSequenceSet *'], seq: Annotated[_ffi.CData, 'const TSequence *'], expand: bool) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('TSequenceSet *', ss)
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tsequenceset_delete_timestamptz(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], t: int) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    result = _lib.tsequenceset_delete_timestamptz(ss_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def tsequenceset_delete_tstzset(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    s_converted = _ffi.cast('const Set *', s)
...
def tsequenceset_delete_tstzspan(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def tsequenceset_delete_tstzspanset(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], ps: Annotated[_ffi.CData, 'const SpanSet *']) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tsequenceset_insert(ss1: Annotated[_ffi.CData, 'const TSequenceSet *'], ss2: Annotated[_ffi.CData, 'const TSequenceSet *']) -> Annotated[_ffi.CData, 'TSequenceSet *']:
...
def tsequenceset_merge(ss1: Annotated[_ffi.CData, 'const TSequenceSet *'], ss2: Annotated[_ffi.CData, 'const TSequenceSet *']) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss1_converted = _ffi.cast('const TSequenceSet *', ss1)
    ss2_converted = _ffi.cast('const TSequenceSet *', ss2)
...
def tsequenceset_merge_array(seqsets: Annotated[list, 'TSequenceSet **'], count: int) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    seqsets_converted = [_ffi.cast('TSequenceSet *', x) for x in seqsets]
...
def tsequence_expand_bbox(seq: Annotated[_ffi.CData, 'TSequence *'], inst: Annotated[_ffi.CData, 'const TInstant *']) -> Annotated[None, 'void']:
    seq_converted = _ffi.cast('TSequence *', seq)
    inst_converted = _ffi.cast('const TInstant *', inst)
...
def tsequence_set_bbox(seq: Annotated[_ffi.CData, 'const TSequence *'], box: Annotated[_ffi.CData, 'void *']) -> Annotated[None, 'void']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    box_converted = _ffi.cast('void *', box)
...
def tsequenceset_expand_bbox(ss: Annotated[_ffi.CData, 'TSequenceSet *'], seq: Annotated[_ffi.CData, 'const TSequence *']) -> Annotated[None, 'void']:
    ss_converted = _ffi.cast('TSequenceSet *', ss)
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tsequenceset_set_bbox(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], box: Annotated[_ffi.CData, 'void *']) -> Annotated[None, 'void']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    box_converted = _ffi.cast('void *', box)
...
def tcontseq_after_timestamptz(seq: Annotated[_ffi.CData, 'const TSequence *'], t: int, strict: bool) -> Annotated[_ffi.CData, 'TSequence *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    result = _lib.tcontseq_after_timestamptz(seq_converted, t, strict)
    _check_error()
    return result if result != _ffi.NULL else None


def tcontseq_before_timestamptz(seq: Annotated[_ffi.CData, 'const TSequence *'], t: int, strict: bool) -> Annotated[_ffi.CData, 'TSequence *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    result = _lib.tcontseq_before_timestamptz(seq_converted, t, strict)
    _check_error()
    return result if result != _ffi.NULL else None


def tcontseq_restrict_minmax(seq: Annotated[_ffi.CData, 'const TSequence *'], min: bool, atfunc: bool) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tdiscseq_after_timestamptz(seq: Annotated[_ffi.CData, 'const TSequence *'], t: int, strict: bool) -> Annotated[_ffi.CData, 'TSequence *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    result = _lib.tdiscseq_after_timestamptz(seq_converted, t, strict)
    _check_error()
    return result if result != _ffi.NULL else None


def tdiscseq_before_timestamptz(seq: Annotated[_ffi.CData, 'const TSequence *'], t: int, strict: bool) -> Annotated[_ffi.CData, 'TSequence *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    result = _lib.tdiscseq_before_timestamptz(seq_converted, t, strict)
    _check_error()
    return result if result != _ffi.NULL else None


def tdiscseq_restrict_minmax(seq: Annotated[_ffi.CData, 'const TSequence *'], min: bool, atfunc: bool) -> Annotated[_ffi.CData, 'TSequence *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def temporal_bbox_restrict_set(temp: Annotated[_ffi.CData, 'const Temporal *'], set: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    set_converted = _ffi.cast('const Set *', set)
...
def temporal_restrict_minmax(temp: Annotated[_ffi.CData, 'const Temporal *'], min: bool, atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_restrict_timestamptz(temp: Annotated[_ffi.CData, 'const Temporal *'], t: int, atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.temporal_restrict_timestamptz(temp_converted, t, atfunc)
    _check_error()
    return result if result != _ffi.NULL else None


def temporal_restrict_tstzset(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Set *'], atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Set *', s)
...
def temporal_restrict_tstzspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *'], atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def temporal_restrict_tstzspanset(temp: Annotated[_ffi.CData, 'const Temporal *'], ss: Annotated[_ffi.CData, 'const SpanSet *'], atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def temporal_restrict_value(temp: Annotated[_ffi.CData, 'const Temporal *'], value: Annotated[_ffi.CData, 'Datum'], atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    value_converted = _ffi.cast('Datum', value)
...
def temporal_restrict_values(temp: Annotated[_ffi.CData, 'const Temporal *'], set: Annotated[_ffi.CData, 'const Set *'], atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    set_converted = _ffi.cast('const Set *', set)
...
def temporal_value_at_timestamptz(temp: Annotated[_ffi.CData, 'const Temporal *'], t: int, strict: bool) -> Annotated[_ffi.CData, 'Datum *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    out_result = _ffi.new('Datum *')
    result = _lib.temporal_value_at_timestamptz(temp_converted, t, strict, out_result)
    _check_error()
    if result:
        return out_result if out_result != _ffi.NULL else None
    return None
...
def tinstant_after_timestamptz(inst: Annotated[_ffi.CData, 'const TInstant *'], t: int, strict: bool) -> Annotated[_ffi.CData, 'TInstant *']:
    inst_converted = _ffi.cast('const TInstant *', inst)
    result = _lib.tinstant_after_timestamptz(inst_converted, t, strict)
    _check_error()
    return result if result != _ffi.NULL else None


def tinstant_before_timestamptz(inst: Annotated[_ffi.CData, 'const TInstant *'], t: int, strict: bool) -> Annotated[_ffi.CData, 'TInstant *']:
    inst_converted = _ffi.cast('const TInstant *', inst)
    result = _lib.tinstant_before_timestamptz(inst_converted, t, strict)
    _check_error()
    return result if result != _ffi.NULL else None


def tinstant_restrict_tstzspan(inst: Annotated[_ffi.CData, 'const TInstant *'], period: Annotated[_ffi.CData, 'const Span *'], atfunc: bool) -> Annotated[_ffi.CData, 'TInstant *']:
    inst_converted = _ffi.cast('const TInstant *', inst)
...
def tinstant_restrict_tstzspanset(inst: Annotated[_ffi.CData, 'const TInstant *'], ss: Annotated[_ffi.CData, 'const SpanSet *'], atfunc: bool) -> Annotated[_ffi.CData, 'TInstant *']:
    inst_converted = _ffi.cast('const TInstant *', inst)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tinstant_restrict_timestamptz(inst: Annotated[_ffi.CData, 'const TInstant *'], t: int, atfunc: bool) -> Annotated[_ffi.CData, 'TInstant *']:
    inst_converted = _ffi.cast('const TInstant *', inst)
    result = _lib.tinstant_restrict_timestamptz(inst_converted, t, atfunc)
    _check_error()
    return result if result != _ffi.NULL else None


def tinstant_restrict_tstzset(inst: Annotated[_ffi.CData, 'const TInstant *'], s: Annotated[_ffi.CData, 'const Set *'], atfunc: bool) -> Annotated[_ffi.CData, 'TInstant *']:
    inst_converted = _ffi.cast('const TInstant *', inst)
    s_converted = _ffi.cast('const Set *', s)
...
def tinstant_restrict_value(inst: Annotated[_ffi.CData, 'const TInstant *'], value: Annotated[_ffi.CData, 'Datum'], atfunc: bool) -> Annotated[_ffi.CData, 'TInstant *']:
    inst_converted = _ffi.cast('const TInstant *', inst)
    value_converted = _ffi.cast('Datum', value)
...
def tinstant_restrict_values(inst: Annotated[_ffi.CData, 'const TInstant *'], set: Annotated[_ffi.CData, 'const Set *'], atfunc: bool) -> Annotated[_ffi.CData, 'TInstant *']:
    inst_converted = _ffi.cast('const TInstant *', inst)
    set_converted = _ffi.cast('const Set *', set)
...
def tnumber_restrict_span(temp: Annotated[_ffi.CData, 'const Temporal *'], span: Annotated[_ffi.CData, 'const Span *'], atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    span_converted = _ffi.cast('const Span *', span)
...
def tnumber_restrict_spanset(temp: Annotated[_ffi.CData, 'const Temporal *'], ss: Annotated[_ffi.CData, 'const SpanSet *'], atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tnumberinst_restrict_span(inst: Annotated[_ffi.CData, 'const TInstant *'], span: Annotated[_ffi.CData, 'const Span *'], atfunc: bool) -> Annotated[_ffi.CData, 'TInstant *']:
    inst_converted = _ffi.cast('const TInstant *', inst)
    span_converted = _ffi.cast('const Span *', span)
...
def tnumberinst_restrict_spanset(inst: Annotated[_ffi.CData, 'const TInstant *'], ss: Annotated[_ffi.CData, 'const SpanSet *'], atfunc: bool) -> Annotated[_ffi.CData, 'TInstant *']:
    inst_converted = _ffi.cast('const TInstant *', inst)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tnumberseqset_restrict_span(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], span: Annotated[_ffi.CData, 'const Span *'], atfunc: bool) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    span_converted = _ffi.cast('const Span *', span)
...
def tnumberseqset_restrict_spanset(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], spanset: Annotated[_ffi.CData, 'const SpanSet *'], atfunc: bool) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tsequence_at_timestamptz(seq: Annotated[_ffi.CData, 'const TSequence *'], t: int) -> Annotated[_ffi.CData, 'TInstant *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    result = _lib.tsequence_at_timestamptz(seq_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def tsequence_restrict_tstzspan(seq: Annotated[_ffi.CData, 'const TSequence *'], s: Annotated[_ffi.CData, 'const Span *'], atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    s_converted = _ffi.cast('const Span *', s)
...
def tsequence_restrict_tstzspanset(seq: Annotated[_ffi.CData, 'const TSequence *'], ss: Annotated[_ffi.CData, 'const SpanSet *'], atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tsequenceset_after_timestamptz(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], t: int, strict: bool) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    result = _lib.tsequenceset_after_timestamptz(ss_converted, t, strict)
    _check_error()
    return result if result != _ffi.NULL else None


def tsequenceset_before_timestamptz(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], t: int, strict: bool) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    result = _lib.tsequenceset_before_timestamptz(ss_converted, t, strict)
    _check_error()
    return result if result != _ffi.NULL else None


def tsequenceset_restrict_minmax(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], min: bool, atfunc: bool) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tsequenceset_restrict_tstzspan(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], s: Annotated[_ffi.CData, 'const Span *'], atfunc: bool) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def tsequenceset_restrict_tstzspanset(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], ps: Annotated[_ffi.CData, 'const SpanSet *'], atfunc: bool) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    ps_converted = _ffi.cast('const SpanSet *', ps)
...
def tsequenceset_restrict_timestamptz(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], t: int, atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    result = _lib.tsequenceset_restrict_timestamptz(ss_converted, t, atfunc)
    _check_error()
    return result if result != _ffi.NULL else None


def tsequenceset_restrict_tstzset(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], s: Annotated[_ffi.CData, 'const Set *'], atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    s_converted = _ffi.cast('const Set *', s)
...
def tsequenceset_restrict_value(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], value: Annotated[_ffi.CData, 'Datum'], atfunc: bool) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    value_converted = _ffi.cast('Datum', value)
...
def tsequenceset_restrict_values(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], s: Annotated[_ffi.CData, 'const Set *'], atfunc: bool) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    s_converted = _ffi.cast('const Set *', s)
...
def tinstant_cmp(inst1: Annotated[_ffi.CData, 'const TInstant *'], inst2: Annotated[_ffi.CData, 'const TInstant *']) -> Annotated[int, 'int']:
    inst1_converted = _ffi.cast('const TInstant *', inst1)
    inst2_converted = _ffi.cast('const TInstant *', inst2)
...
def tinstant_eq(inst1: Annotated[_ffi.CData, 'const TInstant *'], inst2: Annotated[_ffi.CData, 'const TInstant *']) -> Annotated[bool, 'bool']:
    inst1_converted = _ffi.cast('const TInstant *', inst1)
    inst2_converted = _ffi.cast('const TInstant *', inst2)
...
def tsequence_cmp(seq1: Annotated[_ffi.CData, 'const TSequence *'], seq2: Annotated[_ffi.CData, 'const TSequence *']) -> Annotated[int, 'int']:
    seq1_converted = _ffi.cast('const TSequence *', seq1)
    seq2_converted = _ffi.cast('const TSequence *', seq2)
...
def tsequence_eq(seq1: Annotated[_ffi.CData, 'const TSequence *'], seq2: Annotated[_ffi.CData, 'const TSequence *']) -> Annotated[bool, 'bool']:
    seq1_converted = _ffi.cast('const TSequence *', seq1)
    seq2_converted = _ffi.cast('const TSequence *', seq2)
...
def tsequenceset_cmp(ss1: Annotated[_ffi.CData, 'const TSequenceSet *'], ss2: Annotated[_ffi.CData, 'const TSequenceSet *']) -> Annotated[int, 'int']:
    ss1_converted = _ffi.cast('const TSequenceSet *', ss1)
    ss2_converted = _ffi.cast('const TSequenceSet *', ss2)
...
def tsequenceset_eq(ss1: Annotated[_ffi.CData, 'const TSequenceSet *'], ss2: Annotated[_ffi.CData, 'const TSequenceSet *']) -> Annotated[bool, 'bool']:
    ss1_converted = _ffi.cast('const TSequenceSet *', ss1)
    ss2_converted = _ffi.cast('const TSequenceSet *', ss2)
...
def always_eq_base_temporal(value: Annotated[_ffi.CData, 'Datum'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    value_converted = _ffi.cast('Datum', value)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_eq_temporal_base(temp: Annotated[_ffi.CData, 'const Temporal *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    value_converted = _ffi.cast('Datum', value)
...
def always_ne_base_temporal(value: Annotated[_ffi.CData, 'Datum'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    value_converted = _ffi.cast('Datum', value)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_ne_temporal_base(temp: Annotated[_ffi.CData, 'const Temporal *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    value_converted = _ffi.cast('Datum', value)
...
def always_ge_base_temporal(value: Annotated[_ffi.CData, 'Datum'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    value_converted = _ffi.cast('Datum', value)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_ge_temporal_base(temp: Annotated[_ffi.CData, 'const Temporal *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    value_converted = _ffi.cast('Datum', value)
...
def always_gt_base_temporal(value: Annotated[_ffi.CData, 'Datum'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    value_converted = _ffi.cast('Datum', value)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_gt_temporal_base(temp: Annotated[_ffi.CData, 'const Temporal *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    value_converted = _ffi.cast('Datum', value)
...
def always_le_base_temporal(value: Annotated[_ffi.CData, 'Datum'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    value_converted = _ffi.cast('Datum', value)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_le_temporal_base(temp: Annotated[_ffi.CData, 'const Temporal *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    value_converted = _ffi.cast('Datum', value)
...
def always_lt_base_temporal(value: Annotated[_ffi.CData, 'Datum'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    value_converted = _ffi.cast('Datum', value)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_lt_temporal_base(temp: Annotated[_ffi.CData, 'const Temporal *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    value_converted = _ffi.cast('Datum', value)
...
def ever_eq_base_temporal(value: Annotated[_ffi.CData, 'Datum'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    value_converted = _ffi.cast('Datum', value)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_eq_temporal_base(temp: Annotated[_ffi.CData, 'const Temporal *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    value_converted = _ffi.cast('Datum', value)
...
def ever_ne_base_temporal(value: Annotated[_ffi.CData, 'Datum'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    value_converted = _ffi.cast('Datum', value)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_ne_temporal_base(temp: Annotated[_ffi.CData, 'const Temporal *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    value_converted = _ffi.cast('Datum', value)
...
def ever_ge_base_temporal(value: Annotated[_ffi.CData, 'Datum'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    value_converted = _ffi.cast('Datum', value)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_ge_temporal_base(temp: Annotated[_ffi.CData, 'const Temporal *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    value_converted = _ffi.cast('Datum', value)
...
def ever_gt_base_temporal(value: Annotated[_ffi.CData, 'Datum'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    value_converted = _ffi.cast('Datum', value)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_gt_temporal_base(temp: Annotated[_ffi.CData, 'const Temporal *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    value_converted = _ffi.cast('Datum', value)
...
def ever_le_base_temporal(value: Annotated[_ffi.CData, 'Datum'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    value_converted = _ffi.cast('Datum', value)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_le_temporal_base(temp: Annotated[_ffi.CData, 'const Temporal *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    value_converted = _ffi.cast('Datum', value)
...
def ever_lt_base_temporal(value: Annotated[_ffi.CData, 'Datum'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    value_converted = _ffi.cast('Datum', value)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_lt_temporal_base(temp: Annotated[_ffi.CData, 'const Temporal *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    value_converted = _ffi.cast('Datum', value)
...
def tnumberseq_angular_difference(seq: Annotated[_ffi.CData, 'const TSequence *']) -> Annotated[_ffi.CData, 'TSequence *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tnumberseqset_angular_difference(ss: Annotated[_ffi.CData, 'const TSequenceSet *']) -> Annotated[_ffi.CData, 'TSequence *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tnumberseqset_delta_value(ss: Annotated[_ffi.CData, 'const TSequenceSet *']) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tdistance_tnumber_number(temp: Annotated[_ffi.CData, 'const Temporal *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    value_converted = _ffi.cast('Datum', value)
...
def nad_tbox_tbox(box1: Annotated[_ffi.CData, 'const TBox *'], box2: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[float, 'double']:
    box1_converted = _ffi.cast('const TBox *', box1)
    box2_converted = _ffi.cast('const TBox *', box2)
...
def nad_tnumber_number(temp: Annotated[_ffi.CData, 'const Temporal *'], value: Annotated[_ffi.CData, 'Datum']) -> Annotated[float, 'double']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    value_converted = _ffi.cast('Datum', value)
...
def nad_tnumber_tbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const TBox *']) -> Annotated[float, 'double']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const TBox *', box)
...
def nad_tnumber_tnumber(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[float, 'double']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def skiplist_make(key_size: Annotated[_ffi.CData, 'size_t'], value_size: Annotated[_ffi.CData, 'size_t'], comp_fn: Annotated[_ffi.CData, 'int (*)(void *, void *)'], merge_fn: Annotated[_ffi.CData, 'void *(*)(void *, void *)']) -> Annotated[_ffi.CData, 'SkipList *']:
...
def skiplist_search(list: Annotated[_ffi.CData, 'SkipList *'], key: Annotated[_ffi.CData, 'void *'], value: Annotated[_ffi.CData, 'void *']) -> Annotated[int, 'int']:
...
def skiplist_splice(list: Annotated[_ffi.CData, 'SkipList *'], keys: Annotated[list, 'void **'], values: Annotated[list, 'void **'], count: int, func: Annotated[_ffi.CData, 'datum_func2'], crossings: bool, sktype: Annotated[_ffi.CData, 'SkipListType']) -> Annotated[None, 'void']:
    list_converted = _ffi.cast('SkipList *', list)
    ...
    _lib.skiplist_splice(list_converted, keys_converted, values_converted, count, func_converted, crossings, sktype_converted)
    _check_error()


def temporal_skiplist_splice(list: Annotated[_ffi.CData, 'SkipList *'], values: Annotated[list, 'void **'], count: int, func: Annotated[_ffi.CData, 'datum_func2'], crossings: bool) -> Annotated[None, 'void']:
    list_converted = _ffi.cast('SkipList *', list)
    values_converted = [_ffi.cast('void *', x) for x in values]
    func_converted = _ffi.cast('datum_func2', func)
...
def skiplist_keys_values(list: Annotated[_ffi.CData, 'SkipList *'], values: Annotated[list, 'void **']) -> Annotated[_ffi.CData, 'void **']:
    list_converted = _ffi.cast('SkipList *', list)
    values_converted = [_ffi.cast('void *', x) for x in values]
...
def temporal_app_tinst_transfn(state: Annotated[_ffi.CData, 'Temporal *'], inst: Annotated[_ffi.CData, 'const TInstant *'], interp: InterpolationType, maxdist: float, maxt: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
...
def temporal_app_tseq_transfn(state: Annotated[_ffi.CData, 'Temporal *'], seq: Annotated[_ffi.CData, 'const TSequence *']) -> Annotated[_ffi.CData, 'Temporal *']:
    state_converted = _ffi.cast('Temporal *', state)
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tnumber_value_time_boxes(temp: Annotated[_ffi.CData, 'const Temporal *'], vsize: Annotated[_ffi.CData, 'Datum'], duration: Annotated[_ffi.CData, 'const int *'], vorigin: Annotated[_ffi.CData, 'Datum'], torigin: int, count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'TBox *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    vsize_converted = _ffi.cast('Datum', vsize)
    duration_converted = _ffi.cast('const int *', duration)
    vorigin_converted = _ffi.cast('Datum', vorigin)
    count_converted = _ffi.cast('int *', count)
    result = _lib.tnumber_value_time_boxes(temp_converted, vsize_converted, duration_converted, vorigin_converted, torigin, count_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tbox_get_value_time_tile(value: Annotated[_ffi.CData, 'Datum'], t: int, vsize: Annotated[_ffi.CData, 'Datum'], duration: Annotated[_ffi.CData, 'const int *'], vorigin: Annotated[_ffi.CData, 'Datum'], torigin: int, basetype: Annotated[_ffi.CData, 'MeosType'], spantype: Annotated[_ffi.CData, 'MeosType']) -> Annotated[_ffi.CData, 'TBox *']:
    value_converted = _ffi.cast('Datum', value)
    vsize_converted = _ffi.cast('Datum', vsize)
    duration_converted = _ffi.cast('const int *', duration)
    vorigin_converted = _ffi.cast('Datum', vorigin)
    basetype_converted = _ffi.cast('MeosType', basetype)
    spantype_converted = _ffi.cast('MeosType', spantype)
    result = _lib.tbox_get_value_time_tile(value_converted, t, vsize_converted, duration_converted, vorigin_converted, torigin, basetype_converted, spantype_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tnumber_value_time_split(temp: Annotated[_ffi.CData, 'const Temporal *'], size: Annotated[_ffi.CData, 'Datum'], duration: Annotated[_ffi.CData, 'const int *'], vorigin: Annotated[_ffi.CData, 'Datum'], torigin: int, value_bins: Annotated[list, 'Datum **'], time_bins: Annotated[list, 'int **'], count: Annotated[_ffi.CData, 'int *']) -> Annotated[_ffi.CData, 'Temporal **']:
    ...
    time_bins_converted = [_ffi.cast('int *', x) for x in time_bins]
    count_converted = _ffi.cast('int *', count)
    result = _lib.tnumber_value_time_split(temp_converted, size_converted, duration_converted, vorigin_converted, torigin, value_bins_converted, time_bins_converted, count_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def datum_geo_round(value: Annotated[_ffi.CData, 'Datum'], size: Annotated[_ffi.CData, 'Datum']) -> Annotated[int, 'int']:
    value_converted = _ffi.cast('Datum', value)
    size_converted = _ffi.cast('Datum', size)
...
def point_round(gs: Annotated[_ffi.CData, 'const int *'], maxdd: int) -> Annotated[_ffi.CData, 'int *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def stbox_set(hasx: bool, hasz: bool, geodetic: bool, srid: int, xmin: float, xmax: float, ymin: float, ymax: float, zmin: float, zmax: float, s: Annotated[_ffi.CData, 'const Span *'], box: Annotated[_ffi.CData, 'STBox *']) -> Annotated[None, 'void']:
    s_converted = _ffi.cast('const Span *', s)
    box_converted = _ffi.cast('STBox *', box)
    _lib.stbox_set(hasx, hasz, geodetic, srid, xmin, xmax, ymin, ymax, zmin, zmax, s_converted, box_converted)
    _check_error()


def gbox_set_stbox(box: Annotated[_ffi.CData, 'const int *'], srid: Annotated[_ffi.CData, 'int32_t']) -> Annotated[_ffi.CData, 'STBox *']:
    box_converted = _ffi.cast('const int *', box)
    srid_converted = _ffi.cast('int32_t', srid)
...
def geo_set_stbox(gs: Annotated[_ffi.CData, 'const int *'], box: Annotated[_ffi.CData, 'STBox *']) -> Annotated[bool, 'bool']:
    gs_converted = _ffi.cast('const int *', gs)
    box_converted = _ffi.cast('STBox *', box)
...
def geoarr_set_stbox(values: Annotated[_ffi.CData, 'Datum *'], count: int, box: Annotated[_ffi.CData, 'STBox *']) -> Annotated[None, 'void']:
    values_converted = _ffi.cast('Datum *', values)
    box_converted = _ffi.cast('STBox *', box)
...
def spatial_set_stbox(d: Annotated[_ffi.CData, 'Datum'], basetype: Annotated[_ffi.CData, 'MeosType'], box: Annotated[_ffi.CData, 'STBox *']) -> Annotated[bool, 'bool']:
    d_converted = _ffi.cast('Datum', d)
    basetype_converted = _ffi.cast('MeosType', basetype)
    box_converted = _ffi.cast('STBox *', box)
...
def spatialset_set_stbox(set: Annotated[_ffi.CData, 'const Set *'], box: Annotated[_ffi.CData, 'STBox *']) -> Annotated[None, 'void']:
    set_converted = _ffi.cast('const Set *', set)
    box_converted = _ffi.cast('STBox *', box)
...
def stbox_set_box3d(box: Annotated[_ffi.CData, 'const STBox *'], box3d: Annotated[_ffi.CData, 'int *']) -> Annotated[None, 'void']:
    box_converted = _ffi.cast('const STBox *', box)
    box3d_converted = _ffi.cast('int *', box3d)
    _lib.stbox_set_box3d(box_converted, box3d_converted)
    _check_error()


def stbox_set_gbox(box: Annotated[_ffi.CData, 'const STBox *'], gbox: Annotated[_ffi.CData, 'int *']) -> Annotated[None, 'void']:
    box_converted = _ffi.cast('const STBox *', box)
    gbox_converted = _ffi.cast('int *', gbox)
    _lib.stbox_set_gbox(box_converted, gbox_converted)
    _check_error()


def tstzset_set_stbox(s: Annotated[_ffi.CData, 'const Set *'], box: Annotated[_ffi.CData, 'STBox *']) -> Annotated[None, 'void']:
    s_converted = _ffi.cast('const Set *', s)
    box_converted = _ffi.cast('STBox *', box)
...
def tstzspan_set_stbox(s: Annotated[_ffi.CData, 'const Span *'], box: Annotated[_ffi.CData, 'STBox *']) -> Annotated[None, 'void']:
    s_converted = _ffi.cast('const Span *', s)
    box_converted = _ffi.cast('STBox *', box)
...
def tstzspanset_set_stbox(s: Annotated[_ffi.CData, 'const SpanSet *'], box: Annotated[_ffi.CData, 'STBox *']) -> Annotated[None, 'void']:
...
def stbox_expand(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'STBox *']) -> Annotated[None, 'void']:
    box1_converted = _ffi.cast('const STBox *', box1)
...
def inter_stbox_stbox(box1: Annotated[_ffi.CData, 'const STBox *'], box2: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[_ffi.CData, 'STBox *']:
    box1_converted = _ffi.cast('const STBox *', box1)
    box2_converted = _ffi.cast('const STBox *', box2)
    out_result = _ffi.new('STBox *')
...
def tspatial_set_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'STBox *']) -> Annotated[None, 'void']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('STBox *', box)
...
def tspatialseq_set_stbox(seq: Annotated[_ffi.CData, 'const TSequence *'], box: Annotated[_ffi.CData, 'STBox *']) -> Annotated[None, 'void']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    box_converted = _ffi.cast('STBox *', box)
...
def tspatialseqset_set_stbox(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], box: Annotated[_ffi.CData, 'STBox *']) -> Annotated[None, 'void']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    box_converted = _ffi.cast('STBox *', box)
...
def tgeo_restrict_elevation(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *'], atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
    result = _lib.tgeo_restrict_elevation(temp_converted, s_converted, atfunc)
    _check_error()
    return result if result != _ffi.NULL else None


def tgeo_restrict_geom(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *'], atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.tgeo_restrict_geom(temp_converted, gs_converted, atfunc)
    _check_error()
    return result if result != _ffi.NULL else None


def tgeo_restrict_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *'], border_inc: bool, atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def tgeoinst_restrict_geom(inst: Annotated[_ffi.CData, 'const TInstant *'], gs: Annotated[_ffi.CData, 'const int *'], atfunc: bool) -> Annotated[_ffi.CData, 'TInstant *']:
    inst_converted = _ffi.cast('const TInstant *', inst)
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.tgeoinst_restrict_geom(inst_converted, gs_converted, atfunc)
    _check_error()
    return result if result != _ffi.NULL else None


def tgeoinst_restrict_stbox(inst: Annotated[_ffi.CData, 'const TInstant *'], box: Annotated[_ffi.CData, 'const STBox *'], border_inc: bool, atfunc: bool) -> Annotated[_ffi.CData, 'TInstant *']:
    inst_converted = _ffi.cast('const TInstant *', inst)
    box_converted = _ffi.cast('const STBox *', box)
...
def tgeoseq_restrict_geom(seq: Annotated[_ffi.CData, 'const TSequence *'], gs: Annotated[_ffi.CData, 'const int *'], atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.tgeoseq_restrict_geom(seq_converted, gs_converted, atfunc)
    _check_error()
    return result if result != _ffi.NULL else None


def tgeoseq_restrict_stbox(seq: Annotated[_ffi.CData, 'const TSequence *'], box: Annotated[_ffi.CData, 'const STBox *'], border_inc: bool, atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    box_converted = _ffi.cast('const STBox *', box)
...
def tgeoseqset_restrict_geom(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], gs: Annotated[_ffi.CData, 'const int *'], atfunc: bool) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.tgeoseqset_restrict_geom(ss_converted, gs_converted, atfunc)
    _check_error()
    return result if result != _ffi.NULL else None


def tgeoseqset_restrict_stbox(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], box: Annotated[_ffi.CData, 'const STBox *'], border_inc: bool, atfunc: bool) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    box_converted = _ffi.cast('const STBox *', box)
...
def spatial_srid(d: Annotated[_ffi.CData, 'Datum'], basetype: Annotated[_ffi.CData, 'MeosType']) -> Annotated[_ffi.CData, 'int32_t']:
    d_converted = _ffi.cast('Datum', d)
    basetype_converted = _ffi.cast('MeosType', basetype)
...
def spatial_set_srid(d: Annotated[_ffi.CData, 'Datum'], basetype: Annotated[_ffi.CData, 'MeosType'], srid: Annotated[_ffi.CData, 'int32_t']) -> Annotated[bool, 'bool']:
    d_converted = _ffi.cast('Datum', d)
    basetype_converted = _ffi.cast('MeosType', basetype)
    srid_converted = _ffi.cast('int32_t', srid)
...
def tpointseq_cumulative_length(seq: Annotated[_ffi.CData, 'const TSequence *'], prevlength: float) -> Annotated[_ffi.CData, 'TSequence *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tpointseq_linear_trajectory(seq: Annotated[_ffi.CData, 'const TSequence *'], unary_union: bool) -> Annotated[_ffi.CData, 'int *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tpointseqset_cumulative_length(ss: Annotated[_ffi.CData, 'const TSequenceSet *']) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tgeominst_tgeoginst(inst: Annotated[_ffi.CData, 'const TInstant *'], oper: bool) -> Annotated[_ffi.CData, 'TInstant *']:
    inst_converted = _ffi.cast('const TInstant *', inst)
...
def tgeomseq_tgeogseq(seq: Annotated[_ffi.CData, 'const TSequence *'], oper: bool) -> Annotated[_ffi.CData, 'TSequence *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tgeomseqset_tgeogseqset(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], oper: bool) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tspatialinst_set_srid(inst: Annotated[_ffi.CData, 'TInstant *'], srid: Annotated[_ffi.CData, 'int32_t']) -> Annotated[None, 'void']:
    inst_converted = _ffi.cast('TInstant *', inst)
    srid_converted = _ffi.cast('int32_t', srid)
...
def tpointseq_twcentroid(seq: Annotated[_ffi.CData, 'const TSequence *']) -> Annotated[_ffi.CData, 'int *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tpointseqset_twcentroid(ss: Annotated[_ffi.CData, 'const TSequenceSet *']) -> Annotated[_ffi.CData, 'int *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def npoint_as_hexwkb(np: Annotated[_ffi.CData, 'const Npoint *'], variant: int) -> tuple[Annotated[str, 'char *'], Annotated[_ffi.CData, 'size_t *']]:
    np_converted = _ffi.cast('const Npoint *', np)
    variant_converted = _ffi.cast('uint8_t', variant)
    size_out = _ffi.new('size_t *')
...
def npoint_as_wkb(np: Annotated[_ffi.CData, 'const Npoint *'], variant: int) -> tuple[Annotated[_ffi.CData, 'uint8_t *'], Annotated[_ffi.CData, 'size_t *']]:
    np_converted = _ffi.cast('const Npoint *', np)
    variant_converted = _ffi.cast('uint8_t', variant)
    size_out = _ffi.new('size_t *')
...
def npoint_from_wkb(wkb: Annotated[_ffi.CData, 'const uint8_t *'], size: Annotated[_ffi.CData, 'size_t']) -> Annotated[_ffi.CData, 'Npoint *']:
    wkb_converted = _ffi.cast('const uint8_t *', wkb)
    size_converted = _ffi.cast('size_t', size)
...
def npoint_make(rid: int, pos: float) -> Annotated[_ffi.CData, 'Npoint *']:
    result = _lib.npoint_make(rid, pos)
    _check_error()
    return result if result != _ffi.NULL else None


def nsegment_make(rid: int, pos1: float, pos2: float) -> Annotated[_ffi.CData, 'Nsegment *']:
    result = _lib.nsegment_make(rid, pos1, pos2)
    _check_error()
    return result if result != _ffi.NULL else None


def geompoint_to_npoint(gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Npoint *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def geom_to_nsegment(gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Nsegment *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def npoint_to_geompoint(np: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[_ffi.CData, 'int *']:
    np_converted = _ffi.cast('const Npoint *', np)
...
def nsegment_to_geom(ns: Annotated[_ffi.CData, 'const Nsegment *']) -> Annotated[_ffi.CData, 'int *']:
    ns_converted = _ffi.cast('const Nsegment *', ns)
...
def npoint_hash(np: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[int, 'int']:
    np_converted = _ffi.cast('const Npoint *', np)
...
def npoint_hash_extended(np: Annotated[_ffi.CData, 'const Npoint *'], seed: int) -> Annotated[int, 'int']:
    np_converted = _ffi.cast('const Npoint *', np)
    result = _lib.npoint_hash_extended(np_converted, seed)
    _check_error()
    return result if result != _ffi.NULL else None
...
def npoint_route(np: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[int, 'int']:
    np_converted = _ffi.cast('const Npoint *', np)
...
def nsegment_route(ns: Annotated[_ffi.CData, 'const Nsegment *']) -> Annotated[int, 'int']:
    ns_converted = _ffi.cast('const Nsegment *', ns)
...
def route_exists(rid: int) -> Annotated[bool, 'bool']:
    result = _lib.route_exists(rid)
    _check_error()
    return result if result != _ffi.NULL else None


def route_geom(rid: int) -> Annotated[_ffi.CData, 'const int *']:
    result = _lib.route_geom(rid)
    _check_error()
    return result if result != _ffi.NULL else None


def route_length(rid: int) -> Annotated[float, 'double']:
    result = _lib.route_length(rid)
    _check_error()
    return result if result != _ffi.NULL else None
...
def npoint_timestamptz_to_stbox(np: Annotated[_ffi.CData, 'const Npoint *'], t: int) -> Annotated[_ffi.CData, 'STBox *']:
    np_converted = _ffi.cast('const Npoint *', np)
    result = _lib.npoint_timestamptz_to_stbox(np_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def npoint_tstzspan_to_stbox(np: Annotated[_ffi.CData, 'const Npoint *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'STBox *']:
    np_converted = _ffi.cast('const Npoint *', np)
    s_converted = _ffi.cast('const Span *', s)
...
def npoint_cmp(np1: Annotated[_ffi.CData, 'const Npoint *'], np2: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[int, 'int']:
...
def npoint_eq(np1: Annotated[_ffi.CData, 'const Npoint *'], np2: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[bool, 'bool']:
    np1_converted = _ffi.cast('const Npoint *', np1)
    np2_converted = _ffi.cast('const Npoint *', np2)
...
def npoint_ge(np1: Annotated[_ffi.CData, 'const Npoint *'], np2: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[bool, 'bool']:
    np1_converted = _ffi.cast('const Npoint *', np1)
    np2_converted = _ffi.cast('const Npoint *', np2)
...
def npoint_gt(np1: Annotated[_ffi.CData, 'const Npoint *'], np2: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[bool, 'bool']:
    np1_converted = _ffi.cast('const Npoint *', np1)
    np2_converted = _ffi.cast('const Npoint *', np2)
...
def npoint_le(np1: Annotated[_ffi.CData, 'const Npoint *'], np2: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[bool, 'bool']:
    np1_converted = _ffi.cast('const Npoint *', np1)
    np2_converted = _ffi.cast('const Npoint *', np2)
...
def npoint_lt(np1: Annotated[_ffi.CData, 'const Npoint *'], np2: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[bool, 'bool']:
    np1_converted = _ffi.cast('const Npoint *', np1)
    np2_converted = _ffi.cast('const Npoint *', np2)
...
def npoint_ne(np1: Annotated[_ffi.CData, 'const Npoint *'], np2: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[bool, 'bool']:
    np1_converted = _ffi.cast('const Npoint *', np1)
    np2_converted = _ffi.cast('const Npoint *', np2)
...
def npoint_same(np1: Annotated[_ffi.CData, 'const Npoint *'], np2: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[bool, 'bool']:
    np1_converted = _ffi.cast('const Npoint *', np1)
    np2_converted = _ffi.cast('const Npoint *', np2)
...
def nsegment_cmp(ns1: Annotated[_ffi.CData, 'const Nsegment *'], ns2: Annotated[_ffi.CData, 'const Nsegment *']) -> Annotated[int, 'int']:
...
def nsegment_eq(ns1: Annotated[_ffi.CData, 'const Nsegment *'], ns2: Annotated[_ffi.CData, 'const Nsegment *']) -> Annotated[bool, 'bool']:
    ns1_converted = _ffi.cast('const Nsegment *', ns1)
    ns2_converted = _ffi.cast('const Nsegment *', ns2)
...
def nsegment_ge(ns1: Annotated[_ffi.CData, 'const Nsegment *'], ns2: Annotated[_ffi.CData, 'const Nsegment *']) -> Annotated[bool, 'bool']:
    ns1_converted = _ffi.cast('const Nsegment *', ns1)
    ns2_converted = _ffi.cast('const Nsegment *', ns2)
...
def nsegment_gt(ns1: Annotated[_ffi.CData, 'const Nsegment *'], ns2: Annotated[_ffi.CData, 'const Nsegment *']) -> Annotated[bool, 'bool']:
    ns1_converted = _ffi.cast('const Nsegment *', ns1)
    ns2_converted = _ffi.cast('const Nsegment *', ns2)
...
def nsegment_le(ns1: Annotated[_ffi.CData, 'const Nsegment *'], ns2: Annotated[_ffi.CData, 'const Nsegment *']) -> Annotated[bool, 'bool']:
    ns1_converted = _ffi.cast('const Nsegment *', ns1)
    ns2_converted = _ffi.cast('const Nsegment *', ns2)
...
def nsegment_lt(ns1: Annotated[_ffi.CData, 'const Nsegment *'], ns2: Annotated[_ffi.CData, 'const Nsegment *']) -> Annotated[bool, 'bool']:
    ns1_converted = _ffi.cast('const Nsegment *', ns1)
    ns2_converted = _ffi.cast('const Nsegment *', ns2)
...
def nsegment_ne(ns1: Annotated[_ffi.CData, 'const Nsegment *'], ns2: Annotated[_ffi.CData, 'const Nsegment *']) -> Annotated[bool, 'bool']:
    ns1_converted = _ffi.cast('const Nsegment *', ns1)
    ns2_converted = _ffi.cast('const Nsegment *', ns2)
...
def npointset_make(values: Annotated[list, 'Npoint **'], count: int) -> Annotated[_ffi.CData, 'Set *']:
    values_converted = [_ffi.cast('Npoint *', x) for x in values]
...
def contained_npoint_set(np: Annotated[_ffi.CData, 'const Npoint *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    np_converted = _ffi.cast('const Npoint *', np)
    s_converted = _ffi.cast('const Set *', s)
...
def contains_set_npoint(s: Annotated[_ffi.CData, 'const Set *'], np: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    np_converted = _ffi.cast('const Npoint *', np)
...
def intersection_npoint_set(np: Annotated[_ffi.CData, 'const Npoint *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    np_converted = _ffi.cast('const Npoint *', np)
    s_converted = _ffi.cast('const Set *', s)
...
def intersection_set_npoint(s: Annotated[_ffi.CData, 'const Set *'], np: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    np_converted = _ffi.cast('const Npoint *', np)
...
def minus_npoint_set(np: Annotated[_ffi.CData, 'const Npoint *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    np_converted = _ffi.cast('const Npoint *', np)
    s_converted = _ffi.cast('const Set *', s)
...
def minus_set_npoint(s: Annotated[_ffi.CData, 'const Set *'], np: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    np_converted = _ffi.cast('const Npoint *', np)
...
def npoint_union_transfn(state: Annotated[_ffi.CData, 'Set *'], np: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[_ffi.CData, 'Set *']:
    state_converted = _ffi.cast('Set *', state)
    np_converted = _ffi.cast('const Npoint *', np)
...
def union_npoint_set(np: Annotated[_ffi.CData, 'const Npoint *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    np_converted = _ffi.cast('const Npoint *', np)
    s_converted = _ffi.cast('const Set *', s)
...
def union_set_npoint(s: Annotated[_ffi.CData, 'const Set *'], np: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    np_converted = _ffi.cast('const Npoint *', np)
...
def tnpointinst_make(np: Annotated[_ffi.CData, 'const Npoint *'], t: int) -> Annotated[_ffi.CData, 'TInstant *']:
    np_converted = _ffi.cast('const Npoint *', np)
    result = _lib.tnpointinst_make(np_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tnpoint_route(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tnpoint_trajectory(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tnpoint_twcentroid(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tnpoint_at_geom(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def tnpoint_at_npoint(temp: Annotated[_ffi.CData, 'const Temporal *'], np: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def tnpoint_at_npointset(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Set *', s)
...
def tnpoint_at_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *'], border_inc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def tnpoint_minus_geom(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def tnpoint_minus_npoint(temp: Annotated[_ffi.CData, 'const Temporal *'], np: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def tnpoint_minus_npointset(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Set *', s)
...
def tnpoint_minus_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *'], border_inc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def tdistance_tnpoint_npoint(temp: Annotated[_ffi.CData, 'const Temporal *'], np: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def tdistance_tnpoint_point(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def tdistance_tnpoint_tnpoint(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def nad_tnpoint_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[float, 'double']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def nad_tnpoint_npoint(temp: Annotated[_ffi.CData, 'const Temporal *'], np: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[float, 'double']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def nad_tnpoint_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[float, 'double']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def nad_tnpoint_tnpoint(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[float, 'double']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def nai_tnpoint_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'TInstant *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def nai_tnpoint_npoint(temp: Annotated[_ffi.CData, 'const Temporal *'], np: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[_ffi.CData, 'TInstant *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def nai_tnpoint_tnpoint(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'TInstant *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def shortestline_tnpoint_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def shortestline_tnpoint_npoint(temp: Annotated[_ffi.CData, 'const Temporal *'], np: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def shortestline_tnpoint_tnpoint(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'int *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tnpoint_tcentroid_transfn(state: Annotated[_ffi.CData, 'SkipList *'], temp: Annotated[_ffi.CData, 'Temporal *']) -> Annotated[_ffi.CData, 'SkipList *']:
    state_converted = _ffi.cast('SkipList *', state)
    temp_converted = _ffi.cast('Temporal *', temp)
...
def always_eq_npoint_tnpoint(np: Annotated[_ffi.CData, 'const Npoint *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    np_converted = _ffi.cast('const Npoint *', np)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_eq_tnpoint_npoint(temp: Annotated[_ffi.CData, 'const Temporal *'], np: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def always_eq_tnpoint_tnpoint(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_ne_npoint_tnpoint(np: Annotated[_ffi.CData, 'const Npoint *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    np_converted = _ffi.cast('const Npoint *', np)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_ne_tnpoint_npoint(temp: Annotated[_ffi.CData, 'const Temporal *'], np: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def always_ne_tnpoint_tnpoint(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_eq_npoint_tnpoint(np: Annotated[_ffi.CData, 'const Npoint *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    np_converted = _ffi.cast('const Npoint *', np)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_eq_tnpoint_npoint(temp: Annotated[_ffi.CData, 'const Temporal *'], np: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def ever_eq_tnpoint_tnpoint(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_ne_npoint_tnpoint(np: Annotated[_ffi.CData, 'const Npoint *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    np_converted = _ffi.cast('const Npoint *', np)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_ne_tnpoint_npoint(temp: Annotated[_ffi.CData, 'const Temporal *'], np: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def ever_ne_tnpoint_tnpoint(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def teq_tnpoint_npoint(temp: Annotated[_ffi.CData, 'const Temporal *'], np: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def tne_tnpoint_npoint(temp: Annotated[_ffi.CData, 'const Temporal *'], np: Annotated[_ffi.CData, 'const Npoint *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def cbuffer_as_hexwkb(cb: Annotated[_ffi.CData, 'const Cbuffer *'], variant: int, size: Annotated[_ffi.CData, 'size_t *']) -> Annotated[str, 'char *']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    variant_converted = _ffi.cast('uint8_t', variant)
    size_converted = _ffi.cast('size_t *', size)
...
def cbuffer_as_wkb(cb: Annotated[_ffi.CData, 'const Cbuffer *'], variant: int) -> tuple[Annotated[_ffi.CData, 'uint8_t *'], Annotated[_ffi.CData, 'size_t *']]:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    variant_converted = _ffi.cast('uint8_t', variant)
    size_out = _ffi.new('size_t *')
...
def cbuffer_from_wkb(wkb: Annotated[_ffi.CData, 'const uint8_t *'], size: Annotated[_ffi.CData, 'size_t']) -> Annotated[_ffi.CData, 'Cbuffer *']:
    wkb_converted = _ffi.cast('const uint8_t *', wkb)
    size_converted = _ffi.cast('size_t', size)
...
def cbuffer_make(point: Annotated[_ffi.CData, 'const int *'], radius: float) -> Annotated[_ffi.CData, 'Cbuffer *']:
    point_converted = _ffi.cast('const int *', point)
...
def cbuffer_to_geom(cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[_ffi.CData, 'int *']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def cbufferarr_to_geom(cbarr: Annotated[list, 'const Cbuffer **'], count: int) -> Annotated[_ffi.CData, 'int *']:
...
def geom_to_cbuffer(gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Cbuffer *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def cbuffer_hash(cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[int, 'int']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def cbuffer_hash_extended(cb: Annotated[_ffi.CData, 'const Cbuffer *'], seed: int) -> Annotated[int, 'int']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    result = _lib.cbuffer_hash_extended(cb_converted, seed)
    _check_error()
    return result if result != _ffi.NULL else None


def cbuffer_point(cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[_ffi.CData, 'int *']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def cbufferarr_round(cbarr: Annotated[list, 'const Cbuffer **'], count: int, maxdd: int) -> Annotated[_ffi.CData, 'Cbuffer **']:
    cbarr_converted = [_ffi.cast('const Cbuffer *', x) for x in cbarr]
...
def cbuffer_set_srid(cb: Annotated[_ffi.CData, 'Cbuffer *'], srid: Annotated[_ffi.CData, 'int32_t']) -> Annotated[None, 'void']:
...
def cbuffer_transform(cb: Annotated[_ffi.CData, 'const Cbuffer *'], srid: Annotated[_ffi.CData, 'int32_t']) -> Annotated[_ffi.CData, 'Cbuffer *']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    srid_converted = _ffi.cast('int32_t', srid)
...
def cbuffer_transform_pipeline(cb: Annotated[_ffi.CData, 'const Cbuffer *'], pipelinestr: str, srid: Annotated[_ffi.CData, 'int32_t'], is_forward: bool) -> Annotated[_ffi.CData, 'Cbuffer *']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    pipelinestr_converted = pipelinestr.encode('utf-8')
    srid_converted = _ffi.cast('int32_t', srid)
...
def contains_cbuffer_cbuffer(cb1: Annotated[_ffi.CData, 'const Cbuffer *'], cb2: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[int, 'int']:
...
def covers_cbuffer_cbuffer(cb1: Annotated[_ffi.CData, 'const Cbuffer *'], cb2: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[int, 'int']:
    cb1_converted = _ffi.cast('const Cbuffer *', cb1)
    cb2_converted = _ffi.cast('const Cbuffer *', cb2)
...
def disjoint_cbuffer_cbuffer(cb1: Annotated[_ffi.CData, 'const Cbuffer *'], cb2: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[int, 'int']:
    cb1_converted = _ffi.cast('const Cbuffer *', cb1)
    cb2_converted = _ffi.cast('const Cbuffer *', cb2)
...
def dwithin_cbuffer_cbuffer(cb1: Annotated[_ffi.CData, 'const Cbuffer *'], cb2: Annotated[_ffi.CData, 'const Cbuffer *'], dist: float) -> Annotated[int, 'int']:
    cb1_converted = _ffi.cast('const Cbuffer *', cb1)
    cb2_converted = _ffi.cast('const Cbuffer *', cb2)
...
def intersects_cbuffer_cbuffer(cb1: Annotated[_ffi.CData, 'const Cbuffer *'], cb2: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[int, 'int']:
    cb1_converted = _ffi.cast('const Cbuffer *', cb1)
    cb2_converted = _ffi.cast('const Cbuffer *', cb2)
...
def touches_cbuffer_cbuffer(cb1: Annotated[_ffi.CData, 'const Cbuffer *'], cb2: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[int, 'int']:
    cb1_converted = _ffi.cast('const Cbuffer *', cb1)
    cb2_converted = _ffi.cast('const Cbuffer *', cb2)
...
def cbuffer_tstzspan_to_stbox(cb: Annotated[_ffi.CData, 'const Cbuffer *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'STBox *']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    s_converted = _ffi.cast('const Span *', s)
...
def cbuffer_timestamptz_to_stbox(cb: Annotated[_ffi.CData, 'const Cbuffer *'], t: int) -> Annotated[_ffi.CData, 'STBox *']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    result = _lib.cbuffer_timestamptz_to_stbox(cb_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def distance_cbuffer_cbuffer(cb1: Annotated[_ffi.CData, 'const Cbuffer *'], cb2: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[float, 'double']:
    cb1_converted = _ffi.cast('const Cbuffer *', cb1)
    cb2_converted = _ffi.cast('const Cbuffer *', cb2)
...
def distance_cbuffer_geo(cb: Annotated[_ffi.CData, 'const Cbuffer *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[float, 'double']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    gs_converted = _ffi.cast('const int *', gs)
...
def distance_cbuffer_stbox(cb: Annotated[_ffi.CData, 'const Cbuffer *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[float, 'double']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    box_converted = _ffi.cast('const STBox *', box)
...
def nad_cbuffer_stbox(cb: Annotated[_ffi.CData, 'const Cbuffer *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[float, 'double']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    box_converted = _ffi.cast('const STBox *', box)
...
def cbuffer_cmp(cb1: Annotated[_ffi.CData, 'const Cbuffer *'], cb2: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[int, 'int']:
    cb1_converted = _ffi.cast('const Cbuffer *', cb1)
    cb2_converted = _ffi.cast('const Cbuffer *', cb2)
...
def cbuffer_eq(cb1: Annotated[_ffi.CData, 'const Cbuffer *'], cb2: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[bool, 'bool']:
    cb1_converted = _ffi.cast('const Cbuffer *', cb1)
    cb2_converted = _ffi.cast('const Cbuffer *', cb2)
...
def cbuffer_ge(cb1: Annotated[_ffi.CData, 'const Cbuffer *'], cb2: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[bool, 'bool']:
    cb1_converted = _ffi.cast('const Cbuffer *', cb1)
    cb2_converted = _ffi.cast('const Cbuffer *', cb2)
...
def cbuffer_gt(cb1: Annotated[_ffi.CData, 'const Cbuffer *'], cb2: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[bool, 'bool']:
    cb1_converted = _ffi.cast('const Cbuffer *', cb1)
    cb2_converted = _ffi.cast('const Cbuffer *', cb2)
...
def cbuffer_le(cb1: Annotated[_ffi.CData, 'const Cbuffer *'], cb2: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[bool, 'bool']:
    cb1_converted = _ffi.cast('const Cbuffer *', cb1)
    cb2_converted = _ffi.cast('const Cbuffer *', cb2)
...
def cbuffer_lt(cb1: Annotated[_ffi.CData, 'const Cbuffer *'], cb2: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[bool, 'bool']:
    cb1_converted = _ffi.cast('const Cbuffer *', cb1)
    cb2_converted = _ffi.cast('const Cbuffer *', cb2)
...
def cbuffer_ne(cb1: Annotated[_ffi.CData, 'const Cbuffer *'], cb2: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[bool, 'bool']:
    cb1_converted = _ffi.cast('const Cbuffer *', cb1)
    cb2_converted = _ffi.cast('const Cbuffer *', cb2)
...
def cbuffer_nsame(cb1: Annotated[_ffi.CData, 'const Cbuffer *'], cb2: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[bool, 'bool']:
    cb1_converted = _ffi.cast('const Cbuffer *', cb1)
    cb2_converted = _ffi.cast('const Cbuffer *', cb2)
...
def cbuffer_same(cb1: Annotated[_ffi.CData, 'const Cbuffer *'], cb2: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[bool, 'bool']:
    cb1_converted = _ffi.cast('const Cbuffer *', cb1)
    cb2_converted = _ffi.cast('const Cbuffer *', cb2)
...
def cbufferset_make(values: Annotated[list, 'Cbuffer **'], count: int) -> Annotated[_ffi.CData, 'Set *']:
    values_converted = [_ffi.cast('Cbuffer *', x) for x in values]
...
def cbuffer_union_transfn(state: Annotated[_ffi.CData, 'Set *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[_ffi.CData, 'Set *']:
    state_converted = _ffi.cast('Set *', state)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def contained_cbuffer_set(cb: Annotated[_ffi.CData, 'const Cbuffer *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    s_converted = _ffi.cast('const Set *', s)
...
def contains_set_cbuffer(s: Annotated[_ffi.CData, 'const Set *'], cb: Annotated[_ffi.CData, 'Cbuffer *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    cb_converted = _ffi.cast('Cbuffer *', cb)
...
def intersection_cbuffer_set(cb: Annotated[_ffi.CData, 'const Cbuffer *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    s_converted = _ffi.cast('const Set *', s)
...
def intersection_set_cbuffer(s: Annotated[_ffi.CData, 'const Set *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def minus_cbuffer_set(cb: Annotated[_ffi.CData, 'const Cbuffer *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    s_converted = _ffi.cast('const Set *', s)
...
def minus_set_cbuffer(s: Annotated[_ffi.CData, 'const Set *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def union_cbuffer_set(cb: Annotated[_ffi.CData, 'const Cbuffer *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    s_converted = _ffi.cast('const Set *', s)
...
def union_set_cbuffer(s: Annotated[_ffi.CData, 'const Set *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def tcbuffer_make(tpoint: Annotated[_ffi.CData, 'const Temporal *'], tfloat: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    tpoint_converted = _ffi.cast('const Temporal *', tpoint)
...
def tcbuffer_trav_area(temp: Annotated[_ffi.CData, 'const Temporal *'], merge_union: bool) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tcbuffer_expand(temp: Annotated[_ffi.CData, 'const Temporal *'], dist: float) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tcbuffer_at_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def tcbuffer_at_geom(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def tcbuffer_at_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *'], border_inc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def tcbuffer_minus_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def tcbuffer_minus_geom(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def tcbuffer_minus_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *'], border_inc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def tdistance_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def tdistance_tcbuffer_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def tdistance_tcbuffer_tcbuffer(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def nad_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[float, 'double']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def nad_tcbuffer_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[float, 'double']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def nad_tcbuffer_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[float, 'double']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def nad_tcbuffer_tcbuffer(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[float, 'double']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def nai_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[_ffi.CData, 'TInstant *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def nai_tcbuffer_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'TInstant *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def nai_tcbuffer_tcbuffer(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'TInstant *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def shortestline_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def shortestline_tcbuffer_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def shortestline_tcbuffer_tcbuffer(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'int *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_eq_cbuffer_tcbuffer(cb: Annotated[_ffi.CData, 'const Cbuffer *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_eq_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def always_eq_tcbuffer_tcbuffer(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_ne_cbuffer_tcbuffer(cb: Annotated[_ffi.CData, 'const Cbuffer *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_ne_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def always_ne_tcbuffer_tcbuffer(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_eq_cbuffer_tcbuffer(cb: Annotated[_ffi.CData, 'const Cbuffer *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_eq_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def ever_eq_tcbuffer_tcbuffer(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_ne_cbuffer_tcbuffer(cb: Annotated[_ffi.CData, 'const Cbuffer *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_ne_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def ever_ne_tcbuffer_tcbuffer(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def teq_cbuffer_tcbuffer(cb: Annotated[_ffi.CData, 'const Cbuffer *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def teq_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def tne_cbuffer_tcbuffer(cb: Annotated[_ffi.CData, 'const Cbuffer *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tne_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def acontains_cbuffer_tcbuffer(cb: Annotated[_ffi.CData, 'const Cbuffer *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def acontains_geo_tcbuffer(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def acontains_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def acontains_tcbuffer_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def acovers_cbuffer_tcbuffer(cb: Annotated[_ffi.CData, 'const Cbuffer *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def acovers_geo_tcbuffer(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def acovers_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def acovers_tcbuffer_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def adisjoint_tcbuffer_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def adisjoint_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def adisjoint_tcbuffer_tcbuffer(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def adwithin_tcbuffer_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *'], dist: float) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def adwithin_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *'], dist: float) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def adwithin_tcbuffer_tcbuffer(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *'], dist: float) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def aintersects_tcbuffer_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def aintersects_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def aintersects_tcbuffer_tcbuffer(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def atouches_tcbuffer_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def atouches_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def atouches_tcbuffer_tcbuffer(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def econtains_cbuffer_tcbuffer(cb: Annotated[_ffi.CData, 'const Cbuffer *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def econtains_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def econtains_tcbuffer_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def ecovers_cbuffer_tcbuffer(cb: Annotated[_ffi.CData, 'const Cbuffer *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ecovers_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def ecovers_tcbuffer_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def ecovers_tcbuffer_tcbuffer(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def edisjoint_tcbuffer_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def edisjoint_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def edwithin_tcbuffer_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *'], dist: float) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def edwithin_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *'], dist: float) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def edwithin_tcbuffer_tcbuffer(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *'], dist: float) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def eintersects_tcbuffer_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def eintersects_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def eintersects_tcbuffer_tcbuffer(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def etouches_tcbuffer_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def etouches_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
...
def etouches_tcbuffer_tcbuffer(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tcontains_cbuffer_tcbuffer(cb: Annotated[_ffi.CData, 'const Cbuffer *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.tcontains_cbuffer_tcbuffer(cb_converted, temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tcontains_geo_tcbuffer(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.tcontains_geo_tcbuffer(gs_converted, temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tcontains_tcbuffer_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.tcontains_tcbuffer_geo(temp_converted, gs_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tcontains_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    result = _lib.tcontains_tcbuffer_cbuffer(temp_converted, cb_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tcontains_tcbuffer_tcbuffer(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
    result = _lib.tcontains_tcbuffer_tcbuffer(temp1_converted, temp2_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tcovers_cbuffer_tcbuffer(cb: Annotated[_ffi.CData, 'const Cbuffer *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.tcovers_cbuffer_tcbuffer(cb_converted, temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tcovers_geo_tcbuffer(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.tcovers_geo_tcbuffer(gs_converted, temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tcovers_tcbuffer_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.tcovers_tcbuffer_geo(temp_converted, gs_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tcovers_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    result = _lib.tcovers_tcbuffer_cbuffer(temp_converted, cb_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tcovers_tcbuffer_tcbuffer(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
    result = _lib.tcovers_tcbuffer_tcbuffer(temp1_converted, temp2_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tdwithin_geo_tcbuffer(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *'], dist: float) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.tdwithin_geo_tcbuffer(gs_converted, temp_converted, dist)
    _check_error()
    return result if result != _ffi.NULL else None


def tdwithin_tcbuffer_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *'], dist: float) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.tdwithin_tcbuffer_geo(temp_converted, gs_converted, dist)
    _check_error()
    return result if result != _ffi.NULL else None


def tdwithin_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *'], dist: float) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    result = _lib.tdwithin_tcbuffer_cbuffer(temp_converted, cb_converted, dist)
    _check_error()
    return result if result != _ffi.NULL else None


def tdwithin_tcbuffer_tcbuffer(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *'], dist: float) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
    result = _lib.tdwithin_tcbuffer_tcbuffer(temp1_converted, temp2_converted, dist)
    _check_error()
    return result if result != _ffi.NULL else None


def tdisjoint_cbuffer_tcbuffer(cb: Annotated[_ffi.CData, 'const Cbuffer *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.tdisjoint_cbuffer_tcbuffer(cb_converted, temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tdisjoint_geo_tcbuffer(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.tdisjoint_geo_tcbuffer(gs_converted, temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tdisjoint_tcbuffer_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.tdisjoint_tcbuffer_geo(temp_converted, gs_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tdisjoint_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    result = _lib.tdisjoint_tcbuffer_cbuffer(temp_converted, cb_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tdisjoint_tcbuffer_tcbuffer(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
    result = _lib.tdisjoint_tcbuffer_tcbuffer(temp1_converted, temp2_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tintersects_cbuffer_tcbuffer(cb: Annotated[_ffi.CData, 'const Cbuffer *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.tintersects_cbuffer_tcbuffer(cb_converted, temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tintersects_geo_tcbuffer(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.tintersects_geo_tcbuffer(gs_converted, temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tintersects_tcbuffer_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.tintersects_tcbuffer_geo(temp_converted, gs_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tintersects_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    result = _lib.tintersects_tcbuffer_cbuffer(temp_converted, cb_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tintersects_tcbuffer_tcbuffer(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
    result = _lib.tintersects_tcbuffer_tcbuffer(temp1_converted, temp2_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def ttouches_geo_tcbuffer(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.ttouches_geo_tcbuffer(gs_converted, temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def ttouches_tcbuffer_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.ttouches_tcbuffer_geo(temp_converted, gs_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def ttouches_cbuffer_tcbuffer(cb: Annotated[_ffi.CData, 'const Cbuffer *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.ttouches_cbuffer_tcbuffer(cb_converted, temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def ttouches_tcbuffer_cbuffer(temp: Annotated[_ffi.CData, 'const Temporal *'], cb: Annotated[_ffi.CData, 'const Cbuffer *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    cb_converted = _ffi.cast('const Cbuffer *', cb)
    result = _lib.ttouches_tcbuffer_cbuffer(temp_converted, cb_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def ttouches_tcbuffer_tcbuffer(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
    result = _lib.ttouches_tcbuffer_tcbuffer(temp1_converted, temp2_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def pose_as_hexwkb(pose: Annotated[_ffi.CData, 'const Pose *'], variant: int, size: Annotated[_ffi.CData, 'size_t *']) -> Annotated[str, 'char *']:
    pose_converted = _ffi.cast('const Pose *', pose)
    variant_converted = _ffi.cast('uint8_t', variant)
    size_converted = _ffi.cast('size_t *', size)
...
def pose_as_wkb(pose: Annotated[_ffi.CData, 'const Pose *'], variant: int) -> tuple[Annotated[_ffi.CData, 'uint8_t *'], Annotated[_ffi.CData, 'size_t *']]:
    pose_converted = _ffi.cast('const Pose *', pose)
    variant_converted = _ffi.cast('uint8_t', variant)
    size_out = _ffi.new('size_t *')
...
def pose_from_wkb(wkb: Annotated[_ffi.CData, 'const uint8_t *'], size: Annotated[_ffi.CData, 'size_t']) -> Annotated[_ffi.CData, 'Pose *']:
    wkb_converted = _ffi.cast('const uint8_t *', wkb)
    size_converted = _ffi.cast('size_t', size)
...
def pose_make_2d(x: float, y: float, theta: float, srid: Annotated[_ffi.CData, 'int32_t']) -> Annotated[_ffi.CData, 'Pose *']:
    srid_converted = _ffi.cast('int32_t', srid)
...
def pose_make_3d(x: float, y: float, z: float, W: float, X: float, Y: float, Z: float, srid: Annotated[_ffi.CData, 'int32_t']) -> Annotated[_ffi.CData, 'Pose *']:
    srid_converted = _ffi.cast('int32_t', srid)
...
def pose_make_point2d(gs: Annotated[_ffi.CData, 'const int *'], theta: float) -> Annotated[_ffi.CData, 'Pose *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def pose_make_point3d(gs: Annotated[_ffi.CData, 'const int *'], W: float, X: float, Y: float, Z: float) -> Annotated[_ffi.CData, 'Pose *']:
    gs_converted = _ffi.cast('const int *', gs)
...
def pose_to_point(pose: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[_ffi.CData, 'int *']:
    pose_converted = _ffi.cast('const Pose *', pose)
...
def pose_hash(pose: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[int, 'int']:
    pose_converted = _ffi.cast('const Pose *', pose)
...
def pose_hash_extended(pose: Annotated[_ffi.CData, 'const Pose *'], seed: int) -> Annotated[int, 'int']:
    pose_converted = _ffi.cast('const Pose *', pose)
    result = _lib.pose_hash_extended(pose_converted, seed)
    _check_error()
    return result if result != _ffi.NULL else None
...
def posearr_round(posearr: Annotated[list, 'const Pose **'], count: int, maxdd: int) -> Annotated[_ffi.CData, 'Pose **']:
...
def pose_set_srid(pose: Annotated[_ffi.CData, 'Pose *'], srid: Annotated[_ffi.CData, 'int32_t']) -> Annotated[None, 'void']:
...
def pose_transform(pose: Annotated[_ffi.CData, 'const Pose *'], srid: Annotated[_ffi.CData, 'int32_t']) -> Annotated[_ffi.CData, 'Pose *']:
    pose_converted = _ffi.cast('const Pose *', pose)
    srid_converted = _ffi.cast('int32_t', srid)
...
def pose_transform_pipeline(pose: Annotated[_ffi.CData, 'const Pose *'], pipelinestr: str, srid: Annotated[_ffi.CData, 'int32_t'], is_forward: bool) -> Annotated[_ffi.CData, 'Pose *']:
    pose_converted = _ffi.cast('const Pose *', pose)
    pipelinestr_converted = pipelinestr.encode('utf-8')
    srid_converted = _ffi.cast('int32_t', srid)
...
def pose_tstzspan_to_stbox(pose: Annotated[_ffi.CData, 'const Pose *'], s: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'STBox *']:
    pose_converted = _ffi.cast('const Pose *', pose)
    s_converted = _ffi.cast('const Span *', s)
...
def pose_timestamptz_to_stbox(pose: Annotated[_ffi.CData, 'const Pose *'], t: int) -> Annotated[_ffi.CData, 'STBox *']:
    pose_converted = _ffi.cast('const Pose *', pose)
    result = _lib.pose_timestamptz_to_stbox(pose_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def distance_pose_geo(pose: Annotated[_ffi.CData, 'const Pose *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[float, 'double']:
    pose_converted = _ffi.cast('const Pose *', pose)
    gs_converted = _ffi.cast('const int *', gs)
...
def distance_pose_pose(pose1: Annotated[_ffi.CData, 'const Pose *'], pose2: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[float, 'double']:
...
def distance_pose_stbox(pose: Annotated[_ffi.CData, 'const Pose *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[float, 'double']:
    pose_converted = _ffi.cast('const Pose *', pose)
    box_converted = _ffi.cast('const STBox *', box)
...
def pose_cmp(pose1: Annotated[_ffi.CData, 'const Pose *'], pose2: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[int, 'int']:
    pose1_converted = _ffi.cast('const Pose *', pose1)
    pose2_converted = _ffi.cast('const Pose *', pose2)
...
def pose_eq(pose1: Annotated[_ffi.CData, 'const Pose *'], pose2: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[bool, 'bool']:
    pose1_converted = _ffi.cast('const Pose *', pose1)
    pose2_converted = _ffi.cast('const Pose *', pose2)
...
def pose_ge(pose1: Annotated[_ffi.CData, 'const Pose *'], pose2: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[bool, 'bool']:
    pose1_converted = _ffi.cast('const Pose *', pose1)
    pose2_converted = _ffi.cast('const Pose *', pose2)
...
def pose_gt(pose1: Annotated[_ffi.CData, 'const Pose *'], pose2: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[bool, 'bool']:
    pose1_converted = _ffi.cast('const Pose *', pose1)
    pose2_converted = _ffi.cast('const Pose *', pose2)
...
def pose_le(pose1: Annotated[_ffi.CData, 'const Pose *'], pose2: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[bool, 'bool']:
    pose1_converted = _ffi.cast('const Pose *', pose1)
    pose2_converted = _ffi.cast('const Pose *', pose2)
...
def pose_lt(pose1: Annotated[_ffi.CData, 'const Pose *'], pose2: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[bool, 'bool']:
    pose1_converted = _ffi.cast('const Pose *', pose1)
    pose2_converted = _ffi.cast('const Pose *', pose2)
...
def pose_ne(pose1: Annotated[_ffi.CData, 'const Pose *'], pose2: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[bool, 'bool']:
    pose1_converted = _ffi.cast('const Pose *', pose1)
    pose2_converted = _ffi.cast('const Pose *', pose2)
...
def pose_nsame(pose1: Annotated[_ffi.CData, 'const Pose *'], pose2: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[bool, 'bool']:
    pose1_converted = _ffi.cast('const Pose *', pose1)
    pose2_converted = _ffi.cast('const Pose *', pose2)
...
def pose_same(pose1: Annotated[_ffi.CData, 'const Pose *'], pose2: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[bool, 'bool']:
    pose1_converted = _ffi.cast('const Pose *', pose1)
    pose2_converted = _ffi.cast('const Pose *', pose2)
...
def contained_pose_set(pose: Annotated[_ffi.CData, 'const Pose *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[bool, 'bool']:
    pose_converted = _ffi.cast('const Pose *', pose)
    s_converted = _ffi.cast('const Set *', s)
...
def contains_set_pose(s: Annotated[_ffi.CData, 'const Set *'], pose: Annotated[_ffi.CData, 'Pose *']) -> Annotated[bool, 'bool']:
    s_converted = _ffi.cast('const Set *', s)
    pose_converted = _ffi.cast('Pose *', pose)
...
def intersection_pose_set(pose: Annotated[_ffi.CData, 'const Pose *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    pose_converted = _ffi.cast('const Pose *', pose)
    s_converted = _ffi.cast('const Set *', s)
...
def intersection_set_pose(s: Annotated[_ffi.CData, 'const Set *'], pose: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    pose_converted = _ffi.cast('const Pose *', pose)
...
def minus_pose_set(pose: Annotated[_ffi.CData, 'const Pose *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    pose_converted = _ffi.cast('const Pose *', pose)
    s_converted = _ffi.cast('const Set *', s)
...
def minus_set_pose(s: Annotated[_ffi.CData, 'const Set *'], pose: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    pose_converted = _ffi.cast('const Pose *', pose)
...
def pose_union_transfn(state: Annotated[_ffi.CData, 'Set *'], pose: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[_ffi.CData, 'Set *']:
    state_converted = _ffi.cast('Set *', state)
    pose_converted = _ffi.cast('const Pose *', pose)
...
def union_pose_set(pose: Annotated[_ffi.CData, 'const Pose *'], s: Annotated[_ffi.CData, 'const Set *']) -> Annotated[_ffi.CData, 'Set *']:
    pose_converted = _ffi.cast('const Pose *', pose)
    s_converted = _ffi.cast('const Set *', s)
...
def union_set_pose(s: Annotated[_ffi.CData, 'const Set *'], pose: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[_ffi.CData, 'Set *']:
    s_converted = _ffi.cast('const Set *', s)
    pose_converted = _ffi.cast('const Pose *', pose)
...
def tpose_make(tpoint: Annotated[_ffi.CData, 'const Temporal *'], tradius: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    tpoint_converted = _ffi.cast('const Temporal *', tpoint)
...
def tpose_trajectory(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tpose_value_at_timestamptz(temp: Annotated[_ffi.CData, 'const Temporal *'], t: int, strict: bool, value: Annotated[list, 'Pose **']) -> Annotated[bool, 'bool']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    value_converted = [_ffi.cast('Pose *', x) for x in value]
    result = _lib.tpose_value_at_timestamptz(temp_converted, t, strict, value_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tpose_at_geom(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.tpose_at_geom(temp_converted, gs_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tpose_at_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *'], border_inc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def tpose_at_pose(temp: Annotated[_ffi.CData, 'const Temporal *'], pose: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    pose_converted = _ffi.cast('const Pose *', pose)
...
def tpose_minus_geom(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
    result = _lib.tpose_minus_geom(temp_converted, gs_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tpose_minus_pose(temp: Annotated[_ffi.CData, 'const Temporal *'], pose: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    pose_converted = _ffi.cast('const Pose *', pose)
...
def tpose_minus_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *'], border_inc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def tdistance_tpose_pose(temp: Annotated[_ffi.CData, 'const Temporal *'], pose: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    pose_converted = _ffi.cast('const Pose *', pose)
...
def tdistance_tpose_point(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def tdistance_tpose_tpose(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def nad_tpose_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[float, 'double']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def nad_tpose_pose(temp: Annotated[_ffi.CData, 'const Temporal *'], pose: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[float, 'double']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    pose_converted = _ffi.cast('const Pose *', pose)
...
def nad_tpose_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[float, 'double']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def nad_tpose_tpose(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[float, 'double']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def nai_tpose_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'TInstant *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def nai_tpose_pose(temp: Annotated[_ffi.CData, 'const Temporal *'], pose: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[_ffi.CData, 'TInstant *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    pose_converted = _ffi.cast('const Pose *', pose)
...
def nai_tpose_tpose(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'TInstant *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def shortestline_tpose_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def shortestline_tpose_pose(temp: Annotated[_ffi.CData, 'const Temporal *'], pose: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    pose_converted = _ffi.cast('const Pose *', pose)
...
def shortestline_tpose_tpose(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'int *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_eq_pose_tpose(pose: Annotated[_ffi.CData, 'const Pose *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    pose_converted = _ffi.cast('const Pose *', pose)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_eq_tpose_pose(temp: Annotated[_ffi.CData, 'const Temporal *'], pose: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    pose_converted = _ffi.cast('const Pose *', pose)
...
def always_eq_tpose_tpose(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_ne_pose_tpose(pose: Annotated[_ffi.CData, 'const Pose *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    pose_converted = _ffi.cast('const Pose *', pose)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_ne_tpose_pose(temp: Annotated[_ffi.CData, 'const Temporal *'], pose: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    pose_converted = _ffi.cast('const Pose *', pose)
...
def always_ne_tpose_tpose(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_eq_pose_tpose(pose: Annotated[_ffi.CData, 'const Pose *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    pose_converted = _ffi.cast('const Pose *', pose)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_eq_tpose_pose(temp: Annotated[_ffi.CData, 'const Temporal *'], pose: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    pose_converted = _ffi.cast('const Pose *', pose)
...
def ever_eq_tpose_tpose(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_ne_pose_tpose(pose: Annotated[_ffi.CData, 'const Pose *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    pose_converted = _ffi.cast('const Pose *', pose)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_ne_tpose_pose(temp: Annotated[_ffi.CData, 'const Temporal *'], pose: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    pose_converted = _ffi.cast('const Pose *', pose)
...
def ever_ne_tpose_tpose(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def teq_pose_tpose(pose: Annotated[_ffi.CData, 'const Pose *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    pose_converted = _ffi.cast('const Pose *', pose)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def teq_tpose_pose(temp: Annotated[_ffi.CData, 'const Temporal *'], pose: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    pose_converted = _ffi.cast('const Pose *', pose)
...
def tne_pose_tpose(pose: Annotated[_ffi.CData, 'const Pose *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    pose_converted = _ffi.cast('const Pose *', pose)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tne_tpose_pose(temp: Annotated[_ffi.CData, 'const Temporal *'], pose: Annotated[_ffi.CData, 'const Pose *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    pose_converted = _ffi.cast('const Pose *', pose)
...
def trgeoinst_make(geom: Annotated[_ffi.CData, 'const int *'], pose: Annotated[_ffi.CData, 'const Pose *'], t: int) -> Annotated[_ffi.CData, 'TInstant *']:
    geom_converted = _ffi.cast('const int *', geom)
    pose_converted = _ffi.cast('const Pose *', pose)
    result = _lib.trgeoinst_make(geom_converted, pose_converted, t)
    _check_error()
    return result if result != _ffi.NULL else None


def geo_tpose_to_trgeo(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def trgeo_end_value(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def trgeo_geom(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def trgeo_points(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Set *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.trgeo_points(temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def trgeo_rotation(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.trgeo_rotation(temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def trgeo_start_value(temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def trgeo_value_n(temp: Annotated[_ffi.CData, 'const Temporal *'], n: int) -> Annotated[list, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    out_result = _ffi.new('int **')
...
def trgeo_traversed_area(temp: Annotated[_ffi.CData, 'const Temporal *'], unary_union: bool) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.trgeo_traversed_area(temp_converted, unary_union)
    _check_error()
    return result if result != _ffi.NULL else None


def trgeo_append_tinstant(temp: Annotated[_ffi.CData, 'Temporal *'], inst: Annotated[_ffi.CData, 'const TInstant *'], interp: InterpolationType, maxdist: float, maxt: Annotated[_ffi.CData, 'const int *'], expand: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('Temporal *', temp)
    inst_converted = _ffi.cast('const TInstant *', inst)
    maxt_converted = _ffi.cast('const int *', maxt)
...
def trgeo_append_tsequence(temp: Annotated[_ffi.CData, 'Temporal *'], seq: Annotated[_ffi.CData, 'const TSequence *'], expand: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('Temporal *', temp)
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def trgeo_delete_timestamptz(temp: Annotated[_ffi.CData, 'const Temporal *'], t: int, connect: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.trgeo_delete_timestamptz(temp_converted, t, connect)
    _check_error()
    return result if result != _ffi.NULL else None


def trgeo_delete_tstzset(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Set *'], connect: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Set *', s)
...
def trgeo_delete_tstzspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *'], connect: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def trgeo_delete_tstzspanset(temp: Annotated[_ffi.CData, 'const Temporal *'], ss: Annotated[_ffi.CData, 'const SpanSet *'], connect: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def trgeo_set_interp(temp: Annotated[_ffi.CData, 'const Temporal *'], interp: InterpolationType) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def trgeo_after_timestamptz(temp: Annotated[_ffi.CData, 'const Temporal *'], t: int, strict: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.trgeo_after_timestamptz(temp_converted, t, strict)
    _check_error()
    return result if result != _ffi.NULL else None


def trgeo_before_timestamptz(temp: Annotated[_ffi.CData, 'const Temporal *'], t: int, strict: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.trgeo_before_timestamptz(temp_converted, t, strict)
    _check_error()
    return result if result != _ffi.NULL else None


def trgeo_restrict_value(temp: Annotated[_ffi.CData, 'const Temporal *'], value: Annotated[_ffi.CData, 'Datum'], atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    value_converted = _ffi.cast('Datum', value)
...
def trgeo_restrict_values(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Set *'], atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Set *', s)
...
def trgeo_restrict_timestamptz(temp: Annotated[_ffi.CData, 'const Temporal *'], t: int, atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.trgeo_restrict_timestamptz(temp_converted, t, atfunc)
    _check_error()
    return result if result != _ffi.NULL else None


def trgeo_restrict_tstzset(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Set *'], atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Set *', s)
...
def trgeo_restrict_tstzspan(temp: Annotated[_ffi.CData, 'const Temporal *'], s: Annotated[_ffi.CData, 'const Span *'], atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def trgeo_restrict_tstzspanset(temp: Annotated[_ffi.CData, 'const Temporal *'], ss: Annotated[_ffi.CData, 'const SpanSet *'], atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tdistance_trgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def tdistance_trgeo_tpoint(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tdistance_trgeo_trgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def nad_stbox_trgeo(box: Annotated[_ffi.CData, 'const STBox *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[float, 'double']:
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.nad_stbox_trgeo(box_converted, temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def nad_trgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[float, 'double']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def nad_trgeo_stbox(temp: Annotated[_ffi.CData, 'const Temporal *'], box: Annotated[_ffi.CData, 'const STBox *']) -> Annotated[float, 'double']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def nad_trgeo_tpoint(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[float, 'double']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def nad_trgeo_trgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[float, 'double']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def nai_trgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'TInstant *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def nai_trgeo_tpoint(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'TInstant *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def nai_trgeo_trgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'TInstant *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def shortestline_trgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'int *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def shortestline_trgeo_tpoint(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'int *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def shortestline_trgeo_trgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'int *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_eq_geo_trgeo(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_eq_trgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def always_eq_trgeo_trgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_ne_geo_trgeo(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_ne_trgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def always_ne_trgeo_trgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_eq_geo_trgeo(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_eq_trgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def ever_eq_trgeo_trgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_ne_geo_trgeo(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_ne_trgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[int, 'int']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def ever_ne_trgeo_trgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[int, 'int']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def teq_geo_trgeo(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def teq_trgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
...
def tne_geo_trgeo(gs: Annotated[_ffi.CData, 'const int *'], temp: Annotated[_ffi.CData, 'const Temporal *']) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const int *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tne_trgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const int *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const int *', gs)
