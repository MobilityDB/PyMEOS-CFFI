...
def rtree_search(rtree: Annotated[_ffi.CData, 'const RTree *'], query: Annotated[_ffi.CData, 'const void *']) -> tuple[Annotated[_ffi.CData, 'int *'], Annotated[_ffi.CData, 'int']]:
    rtree_converted = _ffi.cast('const RTree *', rtree)
    query_converted = _ffi.cast('const void *', query)
    count = _ffi.new('int *')
    result = _lib.rtree_search(rtree_converted, query_converted, count)
    _check_error()
...
def tpoint_as_mvtgeom(temp: Annotated[_ffi.CData, 'const Temporal *'], bounds: Annotated[_ffi.CData, 'const STBox *'], extent: Annotated[_ffi.CData, 'int32_t'], buffer: Annotated[_ffi.CData, 'int32_t'], clip_geom: bool, gsarr: Annotated[list, 'GSERIALIZED **'], timesarr: Annotated[list, 'int64 **']) -> tuple[Annotated[bool, 'bool'], Annotated[_ffi.CData, 'int']]:
    ...
    count = _ffi.new('int *')
    result = _lib.tpoint_as_mvtgeom(temp_converted, bounds_converted, extent_converted, buffer_converted, clip_geom, gsarr_converted, timesarr_converted, count)
    _check_error()
    return result if result != _ffi.NULL else None, count[0]
...
def tpoint_at_geom(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const GSERIALIZED *'], zspan: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def tpoint_minus_geom(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const GSERIALIZED *'], zspan: Annotated[_ffi.CData, 'const Span *']) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    zspan_converted = _ffi.cast('const Span *', zspan)
...
def tcontains_geo_tgeo(gs: Annotated[_ffi.CData, 'const GSERIALIZED *'], temp: Annotated[_ffi.CData, 'const Temporal *'], restr: bool, atvalue: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tcontains_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const GSERIALIZED *'], restr: bool, atvalue: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def tcontains_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *'], restr: bool, atvalue: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tcovers_geo_tgeo(gs: Annotated[_ffi.CData, 'const GSERIALIZED *'], temp: Annotated[_ffi.CData, 'const Temporal *'], restr: bool, atvalue: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tcovers_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const GSERIALIZED *'], restr: bool, atvalue: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def tcovers_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *'], restr: bool, atvalue: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tdisjoint_geo_tgeo(gs: Annotated[_ffi.CData, 'const GSERIALIZED *'], temp: Annotated[_ffi.CData, 'const Temporal *'], restr: bool, atvalue: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tdisjoint_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const GSERIALIZED *'], restr: bool, atvalue: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def tdisjoint_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *'], restr: bool, atvalue: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tdwithin_geo_tgeo(gs: Annotated[_ffi.CData, 'const GSERIALIZED *'], temp: Annotated[_ffi.CData, 'const Temporal *'], dist: float, restr: bool, atvalue: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tdwithin_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const GSERIALIZED *'], dist: float, restr: bool, atvalue: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def tdwithin_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *'], dist: float, restr: bool, atvalue: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tintersects_geo_tgeo(gs: Annotated[_ffi.CData, 'const GSERIALIZED *'], temp: Annotated[_ffi.CData, 'const Temporal *'], restr: bool, atvalue: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tintersects_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const GSERIALIZED *'], restr: bool, atvalue: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def tintersects_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *'], restr: bool, atvalue: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ttouches_geo_tgeo(gs: Annotated[_ffi.CData, 'const GSERIALIZED *'], temp: Annotated[_ffi.CData, 'const Temporal *'], restr: bool, atvalue: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ttouches_tgeo_geo(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const GSERIALIZED *'], restr: bool, atvalue: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def ttouches_tgeo_tgeo(temp1: Annotated[_ffi.CData, 'const Temporal *'], temp2: Annotated[_ffi.CData, 'const Temporal *'], restr: bool, atvalue: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tgeo_restrict_geom(temp: Annotated[_ffi.CData, 'const Temporal *'], gs: Annotated[_ffi.CData, 'const GSERIALIZED *'], zspan: Annotated[_ffi.CData, 'const Span *'], atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    zspan_converted = _ffi.cast('const Span *', zspan)
...
def tgeoinst_restrict_geom(inst: Annotated[_ffi.CData, 'const TInstant *'], gs: Annotated[_ffi.CData, 'const GSERIALIZED *'], zspan: Annotated[_ffi.CData, 'const Span *'], atfunc: bool) -> Annotated[_ffi.CData, 'TInstant *']:
    inst_converted = _ffi.cast('const TInstant *', inst)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    zspan_converted = _ffi.cast('const Span *', zspan)
...
def tgeoseq_restrict_geom(seq: Annotated[_ffi.CData, 'const TSequence *'], gs: Annotated[_ffi.CData, 'const GSERIALIZED *'], zspan: Annotated[_ffi.CData, 'const Span *'], atfunc: bool) -> Annotated[_ffi.CData, 'Temporal *']:
    seq_converted = _ffi.cast('const TSequence *', seq)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    zspan_converted = _ffi.cast('const Span *', zspan)
...
def tgeoseqset_restrict_geom(ss: Annotated[_ffi.CData, 'const TSequenceSet *'], gs: Annotated[_ffi.CData, 'const GSERIALIZED *'], zspan: Annotated[_ffi.CData, 'const Span *'], atfunc: bool) -> Annotated[_ffi.CData, 'TSequenceSet *']:
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    zspan_converted = _ffi.cast('const Span *', zspan)
